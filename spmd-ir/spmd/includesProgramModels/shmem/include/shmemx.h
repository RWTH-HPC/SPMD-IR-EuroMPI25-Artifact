...
SHMEM_FUNCTION_ATTRIBUTES void shmemx_heap_create(void *base, size_t size, int device_type, int device_index);
SHMEM_FUNCTION_ATTRIBUTES void shmemx_heap_preinit();
SHMEM_FUNCTION_ATTRIBUTES int shmemx_heap_preinit_thread(int requested, int *provided);
SHMEM_FUNCTION_ATTRIBUTES void shmemx_heap_postinit();
