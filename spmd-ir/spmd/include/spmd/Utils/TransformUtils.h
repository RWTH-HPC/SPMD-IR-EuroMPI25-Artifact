//===- TransformUtils.h - SPMD Transform Utilities -----------------*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains utilities for the SPMD transformation passes.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_DIALECT_SPMD_UTILS_TRANSFORMUTILS_H
#define MLIR_DIALECT_SPMD_UTILS_TRANSFORMUTILS_H
...
#endif // MLIR_DIALECT_SPMD_UTILS_TRANSFORMUTILS_H
