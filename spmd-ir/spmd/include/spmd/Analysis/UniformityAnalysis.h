...
#ifndef MLIR_DIALECT_SPMD_ANALYSIS_UNIFORMITYANALYSIS_H
#define MLIR_DIALECT_SPMD_ANALYSIS_UNIFORMITYANALYSIS_H
...
#endif // MLIR_DIALECT_SPMD_ANALYSIS_UNIFORMITYANALYSIS_H
