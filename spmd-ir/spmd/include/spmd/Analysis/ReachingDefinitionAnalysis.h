...
#ifndef MLIR_DIALECT_SPMD_ANALYSIS_REACHINGDEFINITIONANALYSIS_H
#define MLIR_DIALECT_SPMD_ANALYSIS_REACHINGDEFINITIONANALYSIS_H

#include "mlir/Analysis/DataFlow/ConstantPropagationAnalysis.h"
#include "mlir/Analysis/DataFlow/DeadCodeAnalysis.h"
#include "mlir/Analysis/DataFlow/DenseAnalysis.h"
#include "mlir/Analysis/DataFlow/SparseAnalysis.h"
#include "spmd/Analysis/DataFlowSolverWrapper.h"
#include "spmd/Utils/AliasUtils.h"
#include <set>
#include <variant>
...
public:
  ...
  // LogicalResult processOperation(Operation *op) override;
  ...
  LogicalResult visitOperation(Operation *op, const ReachingDefinition &before,
...
#endif // MLIR_DIALECT_SPMD_ANALYSIS_REACHINGDEFINITIONANALYSIS_H
