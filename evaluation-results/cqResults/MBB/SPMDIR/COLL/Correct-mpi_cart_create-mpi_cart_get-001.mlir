...
#di_file = #llvm.di_file<"cq-results-20250731-154348/MBB/SPMDIR/COLL/Correct-mpi_cart_create-mpi_cart_get-001.c" in "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
module attributes {dlti.dl_spec = #dlti.dl_spec<f80 = dense<128> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = [["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %c4294967297_i64 = arith.constant {spmd.executionKind = "All"} 4294967297 : i64
    ...
    %c67108864_i32 = arith.constant {spmd.executionKind = "All"} 67108864 : i32
    ...
    %8 = llvm.alloca %c1_i32 x !llvm.array<2 x i32> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %9 = llvm.alloca %c1_i32 x !llvm.array<2 x i32> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    %10 = llvm.alloca %c1_i32 x !llvm.array<2 x i32> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    ...
    llvm.store %c-1_i32, %5 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    ...
    llvm.store %c67108864_i32, %7 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    ...
    llvm.store %c4294967297_i64, %8 {alignment = 8 : i64, spmd.executionKind = "All"} : i64, !llvm.ptr
    llvm.intr.lifetime.start 8, %9 {spmd.executionKind = "All"} : !llvm.ptr
    llvm.store %c0_i64, %9 {alignment = 8 : i64, spmd.executionKind = "All"} : i64, !llvm.ptr
    llvm.intr.lifetime.start 8, %10 {spmd.executionKind = "All"} : !llvm.ptr
    llvm.store %c0_i64, %10 {alignment = 8 : i64, spmd.executionKind = "All"} : i64, !llvm.ptr
    %13 = "spmd.dimsCreate"(%size, %c2_i32, %9) <{usedModel = 0 : i32}> {spmd.executionKind = "All"} : (i32, i32, !llvm.ptr) -> !spmd.error
    %14 = llvm.load %7 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
    %15 = llvm.call @MPI_Cart_get(%14, %c2_i32, %9, %8, %10) {no_unwind, spmd.executionKind = "All"} : (i32, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
  ...
  llvm.func local_unnamed_addr @MPI_Cart_get(i32 {llvm.noundef}, i32 {llvm.noundef}, !llvm.ptr {llvm.noundef}, !llvm.ptr {llvm.noundef}, !llvm.ptr {llvm.noundef}) -> i32 attributes {passthrough = [["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"}
