; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-get_accumulate_compare_and_swap-001.c'
...
24:                                               ; preds = %22, %2
  ...
  %27 = call i32 @MPI_Win_create(ptr noundef %26, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %11), !dbg !78
...
30:                                               ; preds = %24
  ...
  %32 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %31), !dbg !85
  ...
  %47 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %46), !dbg !108
  br label %48, !dbg !109

48:                                               ; preds = %30, %24
  %49 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !110
