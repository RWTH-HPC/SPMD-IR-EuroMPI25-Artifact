; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@13 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
@14 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c\00", align 1
...
28:                                               ; preds = %22
  ...
  %30 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %29, i32 42, ptr @1), !dbg !85
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 44, ptr @2), !dbg !87
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 46, ptr @3), !dbg !90
  ...
  call void @parcoach_rma_store(ptr %14, i64 64, i32 48, ptr @4), !dbg !93
  store ptr %33, ptr %14, align 8, !dbg !93
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @5), !dbg !95
  %34 = load ptr, ptr %12, align 8, !dbg !95
  call void @parcoach_rma_load(ptr %14, i64 64, i32 50, ptr @6), !dbg !96
  %35 = load ptr, ptr %14, align 8, !dbg !96
  call void @parcoach_rma_load(ptr %13, i64 64, i32 50, ptr @7), !dbg !97
  %36 = load ptr, ptr %13, align 8, !dbg !97
  call void @parcoach_rma_load(ptr %10, i64 64, i32 50, ptr @8), !dbg !98
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 51, ptr @9), !dbg !100
  %39 = load ptr, ptr %12, align 8, !dbg !100
  %40 = getelementptr inbounds i32, ptr %39, i64 0, !dbg !100
  call void @parcoach_rma_load(ptr %40, i64 32, i32 51, ptr @10), !dbg !100
  %41 = load i32, ptr %40, align 4, !dbg !100
  %42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %41), !dbg !101
  call void @parcoach_rma_load(ptr %10, i64 64, i32 52, ptr @11), !dbg !102
  %43 = load ptr, ptr %10, align 8, !dbg !102
  %44 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %43, i32 52, ptr @12), !dbg !103
  br label %45, !dbg !104

45:                                               ; preds = %28, %22
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 54, ptr @13), !dbg !105
  %47 = call i32 @MPI_Finalize(), !dbg !106
  call void @parcoach_rma_load(ptr %7, i64 32, i32 57, ptr @14), !dbg !107
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-compare_and_swap_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "3d09521da3a74d9617b20816b4b9e999")
...
!89 = !DILocalVariable(name: "int_0", scope: !84, file: !2, line: 46, type: !25)
!90 = !DILocation(line: 46, column: 10, scope: !84)
!91 = !DILocation(line: 46, column: 25, scope: !84)
!92 = !DILocalVariable(name: "int_1", scope: !84, file: !2, line: 48, type: !25)
!93 = !DILocation(line: 48, column: 10, scope: !84)
!94 = !DILocation(line: 48, column: 25, scope: !84)
!95 = !DILocation(line: 50, column: 26, scope: !84)
!96 = !DILocation(line: 50, column: 31, scope: !84)
!97 = !DILocation(line: 50, column: 38, scope: !84)
!98 = !DILocation(line: 50, column: 60, scope: !84)
!99 = !DILocation(line: 50, column: 5, scope: !84)
!100 = !DILocation(line: 51, column: 27, scope: !84)
!101 = !DILocation(line: 51, column: 5, scope: !84)
!102 = !DILocation(line: 52, column: 23, scope: !84)
!103 = !DILocation(line: 52, column: 5, scope: !84)
!104 = !DILocation(line: 53, column: 3, scope: !84)
