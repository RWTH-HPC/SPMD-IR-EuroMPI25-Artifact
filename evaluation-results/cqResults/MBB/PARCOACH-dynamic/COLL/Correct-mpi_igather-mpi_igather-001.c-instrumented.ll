; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %19 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #5, !dbg !76
  store ptr %19, ptr %9, align 8, !dbg !75
  call void @llvm.dbg.declare(metadata ptr %10, metadata !77, metadata !DIExpression()), !dbg !78
  %20 = load i32, ptr %6, align 4, !dbg !79
  %21 = mul nsw i32 10, %20, !dbg !80
  %22 = sext i32 %21 to i64, !dbg !81
  %23 = call noalias ptr @calloc(i64 noundef %22, i64 noundef 4) #5, !dbg !82
  store ptr %23, ptr %10, align 8, !dbg !78
  %24 = load i32, ptr %7, align 4, !dbg !83
  %25 = icmp eq i32 %24, 0, !dbg !85
  br i1 %25, label %26, label %30, !dbg !86

26:                                               ; preds = %18
  %27 = load ptr, ptr %9, align 8, !dbg !87
  %28 = load ptr, ptr %10, align 8, !dbg !89
  %29 = call i32 @MPI_Igather(ptr noundef %27, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %28, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !90
  br label %30, !dbg !91

30:                                               ; preds = %26, %18
  %31 = load i32, ptr %7, align 4, !dbg !92
  %32 = icmp ne i32 %31, 0, !dbg !94
  br i1 %32, label %33, label %37, !dbg !95

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !96
  %35 = load ptr, ptr %10, align 8, !dbg !98
  %36 = call i32 @MPI_Igather(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %35, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !99
  br label %37, !dbg !100

37:                                               ; preds = %33, %30
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !101
  %39 = load ptr, ptr %9, align 8, !dbg !102
  call void @free(ptr noundef %39) #6, !dbg !103
  %40 = load ptr, ptr %10, align 8, !dbg !104
  call void @free(ptr noundef %40) #6, !dbg !105
  %41 = call i32 @MPI_Finalize(), !dbg !106
  %42 = load i32, ptr %7, align 4, !dbg !107
  %43 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %42), !dbg !108
  ret i32 0, !dbg !109
}
...
declare i32 @MPI_Igather(ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7ce6a0063c7a62fa4dd914a5b5b41124")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7ce6a0063c7a62fa4dd914a5b5b41124")
...
!77 = !DILocalVariable(name: "recv_buf", scope: !50, file: !2, line: 36, type: !23)
!78 = !DILocation(line: 36, column: 8, scope: !50)
!79 = !DILocation(line: 36, column: 38, scope: !50)
!80 = !DILocation(line: 36, column: 36, scope: !50)
!81 = !DILocation(line: 36, column: 33, scope: !50)
!82 = !DILocation(line: 36, column: 26, scope: !50)
!83 = !DILocation(line: 38, column: 7, scope: !84)
!84 = distinct !DILexicalBlock(scope: !50, file: !2, line: 38, column: 7)
!85 = !DILocation(line: 38, column: 12, scope: !84)
!86 = !DILocation(line: 38, column: 7, scope: !50)
!87 = !DILocation(line: 39, column: 17, scope: !88)
!88 = distinct !DILexicalBlock(scope: !84, file: !2, line: 38, column: 18)
!89 = !DILocation(line: 39, column: 35, scope: !88)
!90 = !DILocation(line: 39, column: 5, scope: !88)
!91 = !DILocation(line: 41, column: 3, scope: !88)
!92 = !DILocation(line: 42, column: 7, scope: !93)
!93 = distinct !DILexicalBlock(scope: !50, file: !2, line: 42, column: 7)
!94 = !DILocation(line: 42, column: 12, scope: !93)
!95 = !DILocation(line: 42, column: 7, scope: !50)
!96 = !DILocation(line: 43, column: 17, scope: !97)
!97 = distinct !DILexicalBlock(scope: !93, file: !2, line: 42, column: 18)
!98 = !DILocation(line: 43, column: 35, scope: !97)
!99 = !DILocation(line: 43, column: 5, scope: !97)
!100 = !DILocation(line: 45, column: 3, scope: !97)
!101 = !DILocation(line: 46, column: 3, scope: !50)
!102 = !DILocation(line: 47, column: 8, scope: !50)
!103 = !DILocation(line: 47, column: 3, scope: !50)
!104 = !DILocation(line: 48, column: 8, scope: !50)
!105 = !DILocation(line: 48, column: 3, scope: !50)
!106 = !DILocation(line: 50, column: 3, scope: !50)
!107 = !DILocation(line: 51, column: 41, scope: !50)
!108 = !DILocation(line: 51, column: 3, scope: !50)
!109 = !DILocation(line: 52, column: 3, scope: !50)
