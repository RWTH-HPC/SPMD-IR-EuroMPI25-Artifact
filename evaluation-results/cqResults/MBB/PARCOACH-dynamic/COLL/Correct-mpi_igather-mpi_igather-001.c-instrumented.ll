; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c"
...
18:                                               ; preds = %16, %2
  ...
  br i1 %25, label %26, label %30, !dbg !76

26:                                               ; preds = %18
  %27 = load ptr, ptr %9, align 8, !dbg !77
  %28 = load ptr, ptr %10, align 8, !dbg !79
  %29 = call i32 @MPI_Igather(ptr noundef %27, i32 noundef 10, i32 noundef 1275069445, ptr noundef %28, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !80
  br label %30, !dbg !81

30:                                               ; preds = %26, %18
  %31 = load i32, ptr %7, align 4, !dbg !82
  %32 = icmp ne i32 %31, 0, !dbg !84
  br i1 %32, label %33, label %37, !dbg !85

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !86
  %35 = load ptr, ptr %10, align 8, !dbg !88
  %36 = call i32 @MPI_Igather(ptr noundef %34, i32 noundef 10, i32 noundef 1275069445, ptr noundef %35, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !89
  br label %37, !dbg !90

37:                                               ; preds = %33, %30
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !91
  %39 = load ptr, ptr %9, align 8, !dbg !92
  call void @free(ptr noundef %39) #6, !dbg !93
  %40 = load ptr, ptr %10, align 8, !dbg !94
  call void @free(ptr noundef %40) #6, !dbg !95
...
declare i32 @MPI_Igather(ptr noundef, i32 noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7ce6a0063c7a62fa4dd914a5b5b41124")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_igather-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7ce6a0063c7a62fa4dd914a5b5b41124")
!14 = !{!15, !18, !19, !20, !21}
...
!77 = !DILocation(line: 39, column: 17, scope: !78)
!78 = distinct !DILexicalBlock(scope: !74, file: !2, line: 38, column: 18)
!79 = !DILocation(line: 39, column: 35, scope: !78)
!80 = !DILocation(line: 39, column: 5, scope: !78)
!81 = !DILocation(line: 41, column: 3, scope: !78)
!82 = !DILocation(line: 42, column: 7, scope: !83)
!83 = distinct !DILexicalBlock(scope: !40, file: !2, line: 42, column: 7)
!84 = !DILocation(line: 42, column: 12, scope: !83)
!85 = !DILocation(line: 42, column: 7, scope: !40)
!86 = !DILocation(line: 43, column: 17, scope: !87)
!87 = distinct !DILexicalBlock(scope: !83, file: !2, line: 42, column: 18)
!88 = !DILocation(line: 43, column: 35, scope: !87)
!89 = !DILocation(line: 43, column: 5, scope: !87)
!90 = !DILocation(line: 45, column: 3, scope: !87)
!91 = !DILocation(line: 46, column: 3, scope: !40)
!92 = !DILocation(line: 47, column: 8, scope: !40)
!93 = !DILocation(line: 47, column: 3, scope: !40)
!94 = !DILocation(line: 48, column: 8, scope: !40)
!95 = !DILocation(line: 48, column: 3, scope: !40)
!96 = !DILocation(line: 50, column: 3, scope: !40)
!97 = !DILocation(line: 51, column: 41, scope: !40)
!98 = !DILocation(line: 51, column: 3, scope: !40)
!99 = !DILocation(line: 52, column: 3, scope: !40)
