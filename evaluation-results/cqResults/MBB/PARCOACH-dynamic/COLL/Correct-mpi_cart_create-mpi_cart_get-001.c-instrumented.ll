; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_cart_create-mpi_cart_get-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_cart_create-mpi_cart_get-001.c"
...
19:                                               ; preds = %17, %2
  ...
  %26 = load i32, ptr %8, align 4, !dbg !67
  %27 = getelementptr inbounds [2 x i32], ptr %10, i64 0, i64 0, !dbg !68
  %28 = getelementptr inbounds [2 x i32], ptr %9, i64 0, i64 0, !dbg !69
  %29 = getelementptr inbounds [2 x i32], ptr %11, i64 0, i64 0, !dbg !70
  %30 = call i32 @MPI_Cart_get(i32 noundef %26, i32 noundef 2, ptr noundef %27, ptr noundef %28, ptr noundef %29), !dbg !71
  %31 = call i32 @MPI_Comm_free(ptr noundef %8), !dbg !72
  %32 = call i32 @MPI_Finalize(), !dbg !73
  %33 = load i32, ptr %7, align 4, !dbg !74
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !75
  ret i32 0, !dbg !76
}
...
declare i32 @MPI_Cart_get(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_cart_create-mpi_cart_get-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7b5819a22bba92165a915ffef096d850")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_cart_create-mpi_cart_get-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7b5819a22bba92165a915ffef096d850")
!14 = !{!15}
...
!67 = !DILocation(line: 39, column: 16, scope: !28)
!68 = !DILocation(line: 39, column: 31, scope: !28)
!69 = !DILocation(line: 39, column: 37, scope: !28)
!70 = !DILocation(line: 39, column: 46, scope: !28)
!71 = !DILocation(line: 39, column: 3, scope: !28)
!72 = !DILocation(line: 40, column: 3, scope: !28)
!73 = !DILocation(line: 42, column: 3, scope: !28)
!74 = !DILocation(line: 43, column: 41, scope: !28)
!75 = !DILocation(line: 43, column: 3, scope: !28)
!76 = !DILocation(line: 44, column: 3, scope: !28)
