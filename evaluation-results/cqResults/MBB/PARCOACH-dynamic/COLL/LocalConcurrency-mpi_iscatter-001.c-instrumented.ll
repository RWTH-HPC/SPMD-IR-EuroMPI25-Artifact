; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %29 = call i32 @MPI_Iscatter(ptr noundef %27, i32 noundef 10, i32 noundef 1275069445, ptr noundef %28, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !77
  %30 = load ptr, ptr %9, align 8, !dbg !78
  %31 = getelementptr inbounds i32, ptr %30, i64 2, !dbg !78
  store i32 1, ptr %31, align 4, !dbg !79
  %32 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !80
  %33 = load ptr, ptr %9, align 8, !dbg !81
  call void @free(ptr noundef %33) #6, !dbg !82
  %34 = load ptr, ptr %10, align 8, !dbg !83
  call void @free(ptr noundef %34) #6, !dbg !84
  %35 = call i32 @MPI_Finalize(), !dbg !85
  %36 = load i32, ptr %7, align 4, !dbg !86
  %37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %36), !dbg !87
  ret i32 0, !dbg !88
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5ffc36739aadad1d6a61be7271f6dd26")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5ffc36739aadad1d6a61be7271f6dd26")
!14 = !{!15, !18, !19, !20, !21}
...
!75 = !DILocation(line: 38, column: 35, scope: !40)
!76 = !DILocation(line: 38, column: 53, scope: !40)
!77 = !DILocation(line: 38, column: 22, scope: !40)
!78 = !DILocation(line: 40, column: 22, scope: !40)
!79 = !DILocation(line: 40, column: 29, scope: !40)
!80 = !DILocation(line: 41, column: 3, scope: !40)
!81 = !DILocation(line: 42, column: 8, scope: !40)
!82 = !DILocation(line: 42, column: 3, scope: !40)
!83 = !DILocation(line: 43, column: 8, scope: !40)
!84 = !DILocation(line: 43, column: 3, scope: !40)
!85 = !DILocation(line: 45, column: 3, scope: !40)
!86 = !DILocation(line: 46, column: 41, scope: !40)
!87 = !DILocation(line: 46, column: 3, scope: !40)
!88 = !DILocation(line: 47, column: 3, scope: !40)
