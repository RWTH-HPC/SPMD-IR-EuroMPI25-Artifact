; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ibcast-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ibcast-001.c"
...
17:                                               ; preds = %15, %2
  ...
  %19 = load ptr, ptr %9, align 8, !dbg !67
  %20 = call i32 @MPI_Ibcast(ptr noundef %19, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !68
  %21 = load ptr, ptr %9, align 8, !dbg !69
  %22 = getelementptr inbounds i32, ptr %21, i64 2, !dbg !69
  store i32 1, ptr %22, align 4, !dbg !70
  %23 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !71
  %24 = load ptr, ptr %9, align 8, !dbg !72
  call void @free(ptr noundef %24) #6, !dbg !73
  %25 = call i32 @MPI_Finalize(), !dbg !74
  %26 = load i32, ptr %7, align 4, !dbg !75
  %27 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %26), !dbg !76
  ret i32 0, !dbg !77
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ibcast-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "a7b26925bee1dd2f93dcbe1078f962c7")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ibcast-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "a7b26925bee1dd2f93dcbe1078f962c7")
!14 = !{!15, !18, !19, !20, !21}
...
!67 = !DILocation(line: 36, column: 33, scope: !40)
!68 = !DILocation(line: 36, column: 22, scope: !40)
!69 = !DILocation(line: 37, column: 22, scope: !40)
!70 = !DILocation(line: 37, column: 29, scope: !40)
!71 = !DILocation(line: 38, column: 3, scope: !40)
!72 = !DILocation(line: 39, column: 8, scope: !40)
!73 = !DILocation(line: 39, column: 3, scope: !40)
!74 = !DILocation(line: 41, column: 3, scope: !40)
!75 = !DILocation(line: 42, column: 41, scope: !40)
!76 = !DILocation(line: 42, column: 3, scope: !40)
!77 = !DILocation(line: 43, column: 3, scope: !40)
