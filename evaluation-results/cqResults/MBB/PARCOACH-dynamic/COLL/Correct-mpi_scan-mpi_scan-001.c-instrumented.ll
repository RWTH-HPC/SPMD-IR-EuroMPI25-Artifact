; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_scan-mpi_scan-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_scan-mpi_scan-001.c"
...
17:                                               ; preds = %15, %2
  ...
  br i1 %24, label %25, label %29, !dbg !65

25:                                               ; preds = %17
  %26 = load ptr, ptr %8, align 8, !dbg !66
  %27 = load ptr, ptr %9, align 8, !dbg !68
  %28 = call i32 @MPI_Scan(ptr noundef %26, ptr noundef %27, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef 1140850688), !dbg !69
  br label %29, !dbg !70

29:                                               ; preds = %25, %17
  %30 = load i32, ptr %7, align 4, !dbg !71
  %31 = icmp ne i32 %30, 0, !dbg !73
  br i1 %31, label %32, label %36, !dbg !74

32:                                               ; preds = %29
  %33 = load ptr, ptr %8, align 8, !dbg !75
  %34 = load ptr, ptr %9, align 8, !dbg !77
  %35 = call i32 @MPI_Scan(ptr noundef %33, ptr noundef %34, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef 1140850688), !dbg !78
  br label %36, !dbg !79

36:                                               ; preds = %32, %29
  %37 = load ptr, ptr %8, align 8, !dbg !80
  call void @free(ptr noundef %37) #6, !dbg !81
  %38 = load ptr, ptr %9, align 8, !dbg !82
  call void @free(ptr noundef %38) #6, !dbg !83
  %39 = call i32 @MPI_Finalize(), !dbg !84
  %40 = load i32, ptr %7, align 4, !dbg !85
  %41 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40), !dbg !86
  ret i32 0, !dbg !87
}
...
declare i32 @MPI_Scan(ptr noundef, ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_scan-mpi_scan-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e8122a2804e9e14b1c40f99c41c3490")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_scan-mpi_scan-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e8122a2804e9e14b1c40f99c41c3490")
!14 = !{!15, !18, !19, !20}
...
!62 = !DILocation(line: 37, column: 7, scope: !63)
!63 = distinct !DILexicalBlock(scope: !31, file: !2, line: 37, column: 7)
!64 = !DILocation(line: 37, column: 12, scope: !63)
!65 = !DILocation(line: 37, column: 7, scope: !31)
!66 = !DILocation(line: 38, column: 14, scope: !67)
!67 = distinct !DILexicalBlock(scope: !63, file: !2, line: 37, column: 18)
!68 = !DILocation(line: 38, column: 19, scope: !67)
!69 = !DILocation(line: 38, column: 5, scope: !67)
!70 = !DILocation(line: 39, column: 3, scope: !67)
!71 = !DILocation(line: 40, column: 7, scope: !72)
!72 = distinct !DILexicalBlock(scope: !31, file: !2, line: 40, column: 7)
!73 = !DILocation(line: 40, column: 12, scope: !72)
!74 = !DILocation(line: 40, column: 7, scope: !31)
!75 = !DILocation(line: 41, column: 14, scope: !76)
!76 = distinct !DILexicalBlock(scope: !72, file: !2, line: 40, column: 18)
!77 = !DILocation(line: 41, column: 19, scope: !76)
!78 = !DILocation(line: 41, column: 5, scope: !76)
!79 = !DILocation(line: 42, column: 3, scope: !76)
!80 = !DILocation(line: 43, column: 8, scope: !31)
!81 = !DILocation(line: 43, column: 3, scope: !31)
!82 = !DILocation(line: 44, column: 8, scope: !31)
!83 = !DILocation(line: 44, column: 3, scope: !31)
!84 = !DILocation(line: 46, column: 3, scope: !31)
!85 = !DILocation(line: 47, column: 41, scope: !31)
!86 = !DILocation(line: 47, column: 3, scope: !31)
!87 = !DILocation(line: 48, column: 3, scope: !31)
