; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscan-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscan-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %24 = load ptr, ptr %9, align 8, !dbg !74
  %25 = load ptr, ptr %10, align 8, !dbg !75
  %26 = call i32 @MPI_Iscan(ptr noundef %24, ptr noundef %25, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef 1140850688, ptr noundef %8), !dbg !76
  %27 = load ptr, ptr %9, align 8, !dbg !77
  %28 = getelementptr inbounds i32, ptr %27, i64 2, !dbg !77
  store i32 1, ptr %28, align 4, !dbg !78
  %29 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !79
  %30 = load ptr, ptr %9, align 8, !dbg !80
  call void @free(ptr noundef %30) #6, !dbg !81
  %31 = load ptr, ptr %10, align 8, !dbg !82
  call void @free(ptr noundef %31) #6, !dbg !83
  %32 = call i32 @MPI_Finalize(), !dbg !84
  %33 = load i32, ptr %7, align 4, !dbg !85
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !86
  ret i32 0, !dbg !87
}
...
declare i32 @MPI_Iscan(ptr noundef, ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscan-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38eb25e9e33bf62e919e0eafcee1c556")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscan-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38eb25e9e33bf62e919e0eafcee1c556")
...
!74 = !DILocation(line: 38, column: 32, scope: !41)
!75 = !DILocation(line: 38, column: 37, scope: !41)
!76 = !DILocation(line: 38, column: 22, scope: !41)
!77 = !DILocation(line: 40, column: 22, scope: !41)
!78 = !DILocation(line: 40, column: 29, scope: !41)
!79 = !DILocation(line: 41, column: 3, scope: !41)
!80 = !DILocation(line: 42, column: 8, scope: !41)
!81 = !DILocation(line: 42, column: 3, scope: !41)
!82 = !DILocation(line: 43, column: 8, scope: !41)
!83 = !DILocation(line: 43, column: 3, scope: !41)
!84 = !DILocation(line: 45, column: 3, scope: !41)
!85 = !DILocation(line: 46, column: 41, scope: !41)
!86 = !DILocation(line: 46, column: 3, scope: !41)
!87 = !DILocation(line: 47, column: 3, scope: !41)
