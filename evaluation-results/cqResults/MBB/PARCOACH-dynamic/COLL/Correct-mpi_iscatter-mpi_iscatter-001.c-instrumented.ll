; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %20 = mul nsw i32 %19, 10, !dbg !67
  %21 = sext i32 %20 to i64, !dbg !66
  %22 = call noalias ptr @calloc(i64 noundef %21, i64 noundef 4) #5, !dbg !68
  store ptr %22, ptr %9, align 8, !dbg !65
  call void @llvm.dbg.declare(metadata ptr %10, metadata !69, metadata !DIExpression()), !dbg !70
  %23 = load i32, ptr %6, align 4, !dbg !71
  %24 = mul nsw i32 10, %23, !dbg !72
  %25 = sext i32 %24 to i64, !dbg !73
  %26 = call noalias ptr @calloc(i64 noundef %25, i64 noundef 4) #5, !dbg !74
  store ptr %26, ptr %10, align 8, !dbg !70
  %27 = load i32, ptr %7, align 4, !dbg !75
  %28 = icmp eq i32 %27, 0, !dbg !77
  br i1 %28, label %29, label %33, !dbg !78

29:                                               ; preds = %18
  %30 = load ptr, ptr %9, align 8, !dbg !79
  %31 = load ptr, ptr %10, align 8, !dbg !81
  %32 = call i32 @MPI_Iscatter(ptr noundef %30, i32 noundef 10, i32 noundef 1275069445, ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !82
  br label %33, !dbg !83

33:                                               ; preds = %29, %18
  %34 = load i32, ptr %7, align 4, !dbg !84
  %35 = icmp ne i32 %34, 0, !dbg !86
  br i1 %35, label %36, label %40, !dbg !87

36:                                               ; preds = %33
  %37 = load ptr, ptr %9, align 8, !dbg !88
  %38 = load ptr, ptr %10, align 8, !dbg !90
  %39 = call i32 @MPI_Iscatter(ptr noundef %37, i32 noundef 10, i32 noundef 1275069445, ptr noundef %38, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !91
  br label %40, !dbg !92

40:                                               ; preds = %36, %33
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !93
  %42 = load ptr, ptr %9, align 8, !dbg !94
  call void @free(ptr noundef %42) #6, !dbg !95
  %43 = load ptr, ptr %10, align 8, !dbg !96
  call void @free(ptr noundef %43) #6, !dbg !97
...
declare i32 @MPI_Iscatter(ptr noundef, i32 noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "248b305e53aecb1b6d6013c5a9161f70")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "248b305e53aecb1b6d6013c5a9161f70")
!14 = !{!15, !18, !19, !20, !21}
...
!66 = !DILocation(line: 34, column: 28, scope: !40)
!67 = !DILocation(line: 34, column: 35, scope: !40)
!68 = !DILocation(line: 34, column: 21, scope: !40)
!69 = !DILocalVariable(name: "recv_buf", scope: !40, file: !2, line: 36, type: !19)
!70 = !DILocation(line: 36, column: 8, scope: !40)
!71 = !DILocation(line: 36, column: 38, scope: !40)
!72 = !DILocation(line: 36, column: 36, scope: !40)
!73 = !DILocation(line: 36, column: 33, scope: !40)
!74 = !DILocation(line: 36, column: 26, scope: !40)
!75 = !DILocation(line: 38, column: 7, scope: !76)
!76 = distinct !DILexicalBlock(scope: !40, file: !2, line: 38, column: 7)
!77 = !DILocation(line: 38, column: 12, scope: !76)
!78 = !DILocation(line: 38, column: 7, scope: !40)
!79 = !DILocation(line: 39, column: 18, scope: !80)
!80 = distinct !DILexicalBlock(scope: !76, file: !2, line: 38, column: 18)
!81 = !DILocation(line: 39, column: 36, scope: !80)
!82 = !DILocation(line: 39, column: 5, scope: !80)
!83 = !DILocation(line: 41, column: 3, scope: !80)
!84 = !DILocation(line: 42, column: 7, scope: !85)
!85 = distinct !DILexicalBlock(scope: !40, file: !2, line: 42, column: 7)
!86 = !DILocation(line: 42, column: 12, scope: !85)
!87 = !DILocation(line: 42, column: 7, scope: !40)
!88 = !DILocation(line: 43, column: 18, scope: !89)
!89 = distinct !DILexicalBlock(scope: !85, file: !2, line: 42, column: 18)
!90 = !DILocation(line: 43, column: 36, scope: !89)
!91 = !DILocation(line: 43, column: 5, scope: !89)
!92 = !DILocation(line: 45, column: 3, scope: !89)
!93 = !DILocation(line: 46, column: 3, scope: !40)
!94 = !DILocation(line: 47, column: 8, scope: !40)
!95 = !DILocation(line: 47, column: 3, scope: !40)
!96 = !DILocation(line: 48, column: 8, scope: !40)
!97 = !DILocation(line: 48, column: 3, scope: !40)
!98 = !DILocation(line: 50, column: 3, scope: !40)
!99 = !DILocation(line: 51, column: 41, scope: !40)
!100 = !DILocation(line: 51, column: 3, scope: !40)
!101 = !DILocation(line: 52, column: 3, scope: !40)
