; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_alltoall-mpi_alltoall-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_alltoall-mpi_alltoall-001.c"
...
17:                                               ; preds = %15, %2
  ...
  %26 = load i32, ptr %7, align 4, !dbg !63
  %27 = icmp eq i32 %26, 0, !dbg !65
  br i1 %27, label %28, label %32, !dbg !66

28:                                               ; preds = %17
  %29 = load ptr, ptr %8, align 8, !dbg !67
  %30 = load ptr, ptr %9, align 8, !dbg !69
  %31 = call i32 @MPI_Alltoall(ptr noundef %29, i32 noundef 10, i32 noundef 1275069445, ptr noundef %30, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1140850688), !dbg !70
  br label %32, !dbg !71

32:                                               ; preds = %28, %17
  %33 = load i32, ptr %7, align 4, !dbg !72
  %34 = icmp ne i32 %33, 0, !dbg !74
  br i1 %34, label %35, label %39, !dbg !75

35:                                               ; preds = %32
  %36 = load ptr, ptr %8, align 8, !dbg !76
  %37 = load ptr, ptr %9, align 8, !dbg !78
  %38 = call i32 @MPI_Alltoall(ptr noundef %36, i32 noundef 10, i32 noundef 1275069445, ptr noundef %37, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1140850688), !dbg !79
  br label %39, !dbg !80

39:                                               ; preds = %35, %32
  %40 = load ptr, ptr %8, align 8, !dbg !81
  call void @free(ptr noundef %40) #6, !dbg !82
  %41 = load ptr, ptr %9, align 8, !dbg !83
  call void @free(ptr noundef %41) #6, !dbg !84
...
declare i32 @MPI_Alltoall(ptr noundef, i32 noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, i32 noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_alltoall-mpi_alltoall-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e31d1265f129ebc937dd609b868b4ed9")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_alltoall-mpi_alltoall-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e31d1265f129ebc937dd609b868b4ed9")
!14 = !{!15, !18, !19}
...
!64 = distinct !DILexicalBlock(scope: !30, file: !2, line: 37, column: 7)
!65 = !DILocation(line: 37, column: 12, scope: !64)
!66 = !DILocation(line: 37, column: 7, scope: !30)
!67 = !DILocation(line: 38, column: 18, scope: !68)
!68 = distinct !DILexicalBlock(scope: !64, file: !2, line: 37, column: 18)
!69 = !DILocation(line: 38, column: 36, scope: !68)
!70 = !DILocation(line: 38, column: 5, scope: !68)
!71 = !DILocation(line: 39, column: 3, scope: !68)
!72 = !DILocation(line: 40, column: 7, scope: !73)
!73 = distinct !DILexicalBlock(scope: !30, file: !2, line: 40, column: 7)
!74 = !DILocation(line: 40, column: 12, scope: !73)
!75 = !DILocation(line: 40, column: 7, scope: !30)
!76 = !DILocation(line: 41, column: 18, scope: !77)
!77 = distinct !DILexicalBlock(scope: !73, file: !2, line: 40, column: 18)
!78 = !DILocation(line: 41, column: 36, scope: !77)
!79 = !DILocation(line: 41, column: 5, scope: !77)
!80 = !DILocation(line: 42, column: 3, scope: !77)
!81 = !DILocation(line: 43, column: 8, scope: !30)
!82 = !DILocation(line: 43, column: 3, scope: !30)
!83 = !DILocation(line: 44, column: 8, scope: !30)
!84 = !DILocation(line: 44, column: 3, scope: !30)
!85 = !DILocation(line: 46, column: 3, scope: !30)
!86 = !DILocation(line: 47, column: 41, scope: !30)
!87 = !DILocation(line: 47, column: 3, scope: !30)
!88 = !DILocation(line: 48, column: 3, scope: !30)
