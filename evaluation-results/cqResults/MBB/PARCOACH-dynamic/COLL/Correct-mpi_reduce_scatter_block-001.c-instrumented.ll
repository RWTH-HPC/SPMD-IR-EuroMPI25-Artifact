; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_reduce_scatter_block-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_reduce_scatter_block-001.c"
...
17:                                               ; preds = %15, %2
  ...
  %26 = load ptr, ptr %8, align 8, !dbg !64
  %27 = load ptr, ptr %9, align 8, !dbg !65
  %28 = call i32 @MPI_Reduce_scatter_block(ptr noundef %26, ptr noundef %27, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef 1140850688), !dbg !66
  %29 = load ptr, ptr %8, align 8, !dbg !67
  call void @free(ptr noundef %29) #6, !dbg !68
  %30 = load ptr, ptr %9, align 8, !dbg !69
  call void @free(ptr noundef %30) #6, !dbg !70
  %31 = call i32 @MPI_Finalize(), !dbg !71
  %32 = load i32, ptr %7, align 4, !dbg !72
  %33 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %32), !dbg !73
  ret i32 0, !dbg !74
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_reduce_scatter_block-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "632aae4cf27da5693a37b5c3d7533f3d")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/COLL/Correct-mpi_reduce_scatter_block-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "632aae4cf27da5693a37b5c3d7533f3d")
!14 = !{!15, !18, !19, !20}
...
!64 = !DILocation(line: 37, column: 28, scope: !31)
!65 = !DILocation(line: 37, column: 33, scope: !31)
!66 = !DILocation(line: 37, column: 3, scope: !31)
!67 = !DILocation(line: 38, column: 8, scope: !31)
!68 = !DILocation(line: 38, column: 3, scope: !31)
!69 = !DILocation(line: 39, column: 8, scope: !31)
!70 = !DILocation(line: 39, column: 3, scope: !31)
!71 = !DILocation(line: 41, column: 3, scope: !31)
!72 = !DILocation(line: 42, column: 41, scope: !31)
!73 = !DILocation(line: 42, column: 3, scope: !31)
!74 = !DILocation(line: 43, column: 3, scope: !31)
