; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c"
...
@0 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c\00", align 1
@1 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c\00", align 1
...
26:                                               ; preds = %21, %17
  ...
  br i1 %28, label %29, label %36, !dbg !90

29:                                               ; preds = %26
  %30 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 42, ptr @1), !dbg !91
  %31 = load ptr, ptr %9, align 8, !dbg !93
  %32 = call i32 @MPI_Irsend(ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !94
  %33 = load ptr, ptr %9, align 8, !dbg !95
  %34 = getelementptr inbounds i32, ptr %33, i64 2, !dbg !95
  store i32 1, ptr %34, align 4, !dbg !96
  %35 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !97
  br label %36, !dbg !98

36:                                               ; preds = %29, %26
  %37 = load ptr, ptr %9, align 8, !dbg !99
  call void @free(ptr noundef %37) #6, !dbg !100
  %38 = call i32 @MPI_Finalize(), !dbg !101
  %39 = load i32, ptr %7, align 4, !dbg !102
  %40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %39), !dbg !103
  ret i32 0, !dbg !104
}
...
declare i32 @MPI_Irsend(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "18f323ea86d1a084d0cc6825a3d329a0")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "18f323ea86d1a084d0cc6825a3d329a0")
...
!93 = !DILocation(line: 43, column: 35, scope: !92)
!94 = !DILocation(line: 43, column: 24, scope: !92)
!95 = !DILocation(line: 45, column: 24, scope: !92)
!96 = !DILocation(line: 45, column: 31, scope: !92)
!97 = !DILocation(line: 46, column: 5, scope: !92)
!98 = !DILocation(line: 47, column: 3, scope: !92)
!99 = !DILocation(line: 48, column: 8, scope: !50)
!100 = !DILocation(line: 48, column: 3, scope: !50)
!101 = !DILocation(line: 50, column: 3, scope: !50)
!102 = !DILocation(line: 51, column: 41, scope: !50)
!103 = !DILocation(line: 51, column: 3, scope: !50)
!104 = !DILocation(line: 52, column: 3, scope: !50)
