; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [91 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c\00", align 1
@1 = private unnamed_addr constant [91 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c\00", align 1
...
26:                                               ; preds = %21, %17
  ...
  br i1 %28, label %29, label %36, !dbg !80

29:                                               ; preds = %26
  %30 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 42, ptr @1), !dbg !81
  %31 = load ptr, ptr %9, align 8, !dbg !83
  %32 = call i32 @MPI_Irsend(ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !84
  %33 = load ptr, ptr %9, align 8, !dbg !85
  %34 = getelementptr inbounds i32, ptr %33, i64 2, !dbg !85
  store i32 1, ptr %34, align 4, !dbg !86
  %35 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !87
  br label %36, !dbg !88

36:                                               ; preds = %29, %26
  %37 = load ptr, ptr %9, align 8, !dbg !89
  call void @free(ptr noundef %37) #6, !dbg !90
  %38 = call i32 @MPI_Finalize(), !dbg !91
  %39 = load i32, ptr %7, align 4, !dbg !92
  %40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %39), !dbg !93
  ret i32 0, !dbg !94
}
...
declare i32 @MPI_Irsend(ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "18f323ea86d1a084d0cc6825a3d329a0")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_irsend-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "18f323ea86d1a084d0cc6825a3d329a0")
!14 = !{!15, !18, !19, !20, !21}
...
!83 = !DILocation(line: 43, column: 35, scope: !82)
!84 = !DILocation(line: 43, column: 24, scope: !82)
!85 = !DILocation(line: 45, column: 24, scope: !82)
!86 = !DILocation(line: 45, column: 31, scope: !82)
!87 = !DILocation(line: 46, column: 5, scope: !82)
!88 = !DILocation(line: 47, column: 3, scope: !82)
!89 = !DILocation(line: 48, column: 8, scope: !40)
!90 = !DILocation(line: 48, column: 3, scope: !40)
!91 = !DILocation(line: 50, column: 3, scope: !40)
!92 = !DILocation(line: 51, column: 41, scope: !40)
!93 = !DILocation(line: 51, column: 3, scope: !40)
!94 = !DILocation(line: 52, column: 3, scope: !40)
