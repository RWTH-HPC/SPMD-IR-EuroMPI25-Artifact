; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_precv_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_precv_init-001.c"
...
17:                                               ; preds = %15, %2
  ...
  br i1 %20, label %21, label %28, !dbg !83
...
21:                                               ; preds = %17
  ...
  %25 = load ptr, ptr %9, align 8, !dbg !88
  %26 = getelementptr inbounds i32, ptr %25, i64 2, !dbg !88
  store i32 1, ptr %26, align 4, !dbg !89
  %27 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !90
  br label %28, !dbg !91

28:                                               ; preds = %21, %17
  %29 = load i32, ptr %7, align 4, !dbg !92
  %30 = icmp eq i32 %29, 1, !dbg !94
  br i1 %30, label %31, label %38, !dbg !95

31:                                               ; preds = %28
  %32 = load ptr, ptr %9, align 8, !dbg !96
  %33 = call i32 (ptr, i32, i32, ptr, i32, i32, ptr, ptr, ptr, ...) @MPI_Psend_init(ptr noundef %32, i32 noundef 1, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef @ompi_mpi_info_null, ptr noundef %8), !dbg !98
  %34 = call i32 @MPI_Start(ptr noundef %8), !dbg !99
  %35 = load ptr, ptr %8, align 8, !dbg !100
  %36 = call i32 (i32, ptr, ...) @MPI_Pready(i32 noundef 0, ptr noundef %35), !dbg !101
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_precv_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "8984728055b56df285d86f9819b2d131")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_precv_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "8984728055b56df285d86f9819b2d131")
...
!84 = !DILocation(line: 37, column: 39, scope: !85)
!85 = distinct !DILexicalBlock(scope: !81, file: !2, line: 36, column: 18)
!86 = !DILocation(line: 37, column: 24, scope: !85)
!87 = !DILocation(line: 40, column: 5, scope: !85)
!88 = !DILocation(line: 41, column: 24, scope: !85)
!89 = !DILocation(line: 41, column: 31, scope: !85)
!90 = !DILocation(line: 42, column: 5, scope: !85)
!91 = !DILocation(line: 43, column: 3, scope: !85)
!92 = !DILocation(line: 44, column: 7, scope: !93)
!93 = distinct !DILexicalBlock(scope: !53, file: !2, line: 44, column: 7)
!94 = !DILocation(line: 44, column: 12, scope: !93)
!95 = !DILocation(line: 44, column: 7, scope: !53)
!96 = !DILocation(line: 45, column: 20, scope: !97)
!97 = distinct !DILexicalBlock(scope: !93, file: !2, line: 44, column: 18)
!98 = !DILocation(line: 45, column: 5, scope: !97)
!99 = !DILocation(line: 47, column: 5, scope: !97)
!100 = !DILocation(line: 48, column: 19, scope: !97)
!101 = !DILocation(line: 48, column: 5, scope: !97)
!102 = !DILocation(line: 49, column: 5, scope: !97)
!103 = !DILocation(line: 50, column: 3, scope: !97)
