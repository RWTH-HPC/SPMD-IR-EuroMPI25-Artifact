; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_bsend_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_bsend_init-001.c"
...
30:                                               ; preds = %26, %19
  ...
  br i1 %32, label %33, label %40, !dbg !84
...
33:                                               ; preds = %30
  ...
  %38 = getelementptr inbounds i32, ptr %37, i64 2, !dbg !89
  store i32 1, ptr %38, align 4, !dbg !90
  %39 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !91
  br label %40, !dbg !92

40:                                               ; preds = %33, %30
  call void @llvm.dbg.declare(metadata ptr %11, metadata !93, metadata !DIExpression()), !dbg !94
  %41 = load ptr, ptr %10, align 8, !dbg !95
  %42 = call i32 @MPI_Buffer_detach(ptr noundef %41, ptr noundef %11), !dbg !96
  %43 = load ptr, ptr %10, align 8, !dbg !97
  call void @free(ptr noundef %43) #6, !dbg !98
  %44 = load ptr, ptr %9, align 8, !dbg !99
  call void @free(ptr noundef %44) #6, !dbg !100
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_bsend_init-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d0d04a4d9d4a3a2fea75f54a045724db")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_bsend_init-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d0d04a4d9d4a3a2fea75f54a045724db")
...
!85 = !DILocation(line: 45, column: 39, scope: !86)
!86 = distinct !DILexicalBlock(scope: !82, file: !2, line: 44, column: 18)
!87 = !DILocation(line: 45, column: 24, scope: !86)
!88 = !DILocation(line: 47, column: 5, scope: !86)
!89 = !DILocation(line: 48, column: 24, scope: !86)
!90 = !DILocation(line: 48, column: 31, scope: !86)
!91 = !DILocation(line: 49, column: 5, scope: !86)
!92 = !DILocation(line: 50, column: 3, scope: !86)
!93 = !DILocalVariable(name: "freed_size", scope: !41, file: !2, line: 51, type: !17)
!94 = !DILocation(line: 51, column: 7, scope: !41)
!95 = !DILocation(line: 52, column: 21, scope: !41)
!96 = !DILocation(line: 52, column: 3, scope: !41)
!97 = !DILocation(line: 53, column: 8, scope: !41)
!98 = !DILocation(line: 53, column: 3, scope: !41)
!99 = !DILocation(line: 54, column: 8, scope: !41)
