; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_recv_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_recv_init-001.c"
...
17:                                               ; preds = %15, %2
  ...
  br i1 %20, label %21, label %28, !dbg !80

21:                                               ; preds = %17
  %22 = load ptr, ptr %9, align 8, !dbg !81
  %23 = call i32 @MPI_Recv_init(ptr noundef %22, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !83
  %24 = call i32 @MPI_Start(ptr noundef %8), !dbg !84
  %25 = load ptr, ptr %9, align 8, !dbg !85
  %26 = getelementptr inbounds i32, ptr %25, i64 2, !dbg !85
  store i32 1, ptr %26, align 4, !dbg !86
  %27 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !87
  br label %28, !dbg !88

28:                                               ; preds = %21, %17
  %29 = load i32, ptr %7, align 4, !dbg !89
  %30 = icmp eq i32 %29, 1, !dbg !91
  br i1 %30, label %31, label %35, !dbg !92

31:                                               ; preds = %28
  %32 = load ptr, ptr %9, align 8, !dbg !93
  %33 = call i32 @MPI_Isend(ptr noundef %32, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !95
  %34 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !96
  br label %35, !dbg !97

35:                                               ; preds = %31, %28
  %36 = load ptr, ptr %9, align 8, !dbg !98
  call void @free(ptr noundef %36) #6, !dbg !99
  %37 = load i32, ptr %7, align 4, !dbg !100
  %38 = icmp eq i32 %37, 0, !dbg !102
  br i1 %38, label %39, label %41, !dbg !103

39:                                               ; preds = %35
  %40 = call i32 @MPI_Request_free(ptr noundef %8), !dbg !104
  br label %41, !dbg !106

41:                                               ; preds = %39, %35
  %42 = call i32 @MPI_Finalize(), !dbg !107
  %43 = load i32, ptr %7, align 4, !dbg !108
  %44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %43), !dbg !109
  ret i32 0, !dbg !110
}
...
declare i32 @MPI_Recv_init(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_recv_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "83671b2b40410292e50e6296ad3ef168")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_recv_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "83671b2b40410292e50e6296ad3ef168")
...
!81 = !DILocation(line: 37, column: 38, scope: !82)
!82 = distinct !DILexicalBlock(scope: !78, file: !2, line: 36, column: 18)
!83 = !DILocation(line: 37, column: 24, scope: !82)
!84 = !DILocation(line: 39, column: 5, scope: !82)
!85 = !DILocation(line: 40, column: 24, scope: !82)
!86 = !DILocation(line: 40, column: 31, scope: !82)
!87 = !DILocation(line: 41, column: 5, scope: !82)
!88 = !DILocation(line: 42, column: 3, scope: !82)
!89 = !DILocation(line: 43, column: 7, scope: !90)
!90 = distinct !DILexicalBlock(scope: !50, file: !2, line: 43, column: 7)
!91 = !DILocation(line: 43, column: 12, scope: !90)
!92 = !DILocation(line: 43, column: 7, scope: !50)
!93 = !DILocation(line: 44, column: 15, scope: !94)
!94 = distinct !DILexicalBlock(scope: !90, file: !2, line: 43, column: 18)
!95 = !DILocation(line: 44, column: 5, scope: !94)
!96 = !DILocation(line: 45, column: 5, scope: !94)
!97 = !DILocation(line: 46, column: 3, scope: !94)
!98 = !DILocation(line: 47, column: 8, scope: !50)
!99 = !DILocation(line: 47, column: 3, scope: !50)
!100 = !DILocation(line: 48, column: 7, scope: !101)
!101 = distinct !DILexicalBlock(scope: !50, file: !2, line: 48, column: 7)
!102 = !DILocation(line: 48, column: 12, scope: !101)
!103 = !DILocation(line: 48, column: 7, scope: !50)
!104 = !DILocation(line: 49, column: 5, scope: !105)
!105 = distinct !DILexicalBlock(scope: !101, file: !2, line: 48, column: 18)
!106 = !DILocation(line: 50, column: 3, scope: !105)
!107 = !DILocation(line: 52, column: 3, scope: !50)
!108 = !DILocation(line: 53, column: 41, scope: !50)
!109 = !DILocation(line: 53, column: 3, scope: !50)
!110 = !DILocation(line: 54, column: 3, scope: !50)
