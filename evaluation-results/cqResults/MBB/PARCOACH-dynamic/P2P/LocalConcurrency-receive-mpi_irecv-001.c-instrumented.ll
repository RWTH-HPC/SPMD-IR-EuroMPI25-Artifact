; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_irecv-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_irecv-001.c"
...
17:                                               ; preds = %15, %2
  ...
  br i1 %20, label %21, label %27, !dbg !70
...
21:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds i32, ptr %24, i64 2, !dbg !74
  store i32 1, ptr %25, align 4, !dbg !75
  %26 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !76
  br label %27, !dbg !77

27:                                               ; preds = %21, %17
  %28 = load i32, ptr %7, align 4, !dbg !78
  %29 = icmp eq i32 %28, 1, !dbg !80
  br i1 %29, label %30, label %34, !dbg !81

30:                                               ; preds = %27
  %31 = load ptr, ptr %9, align 8, !dbg !82
  %32 = call i32 @MPI_Isend(ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !84
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_irecv-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "34e7b6d752bdb02627bf020f11739c3a")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-receive-mpi_irecv-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "34e7b6d752bdb02627bf020f11739c3a")
!14 = !{!15, !18, !19, !20, !21}
...
!71 = !DILocation(line: 37, column: 34, scope: !72)
!72 = distinct !DILexicalBlock(scope: !68, file: !2, line: 36, column: 18)
!73 = !DILocation(line: 37, column: 24, scope: !72)
!74 = !DILocation(line: 39, column: 24, scope: !72)
!75 = !DILocation(line: 39, column: 31, scope: !72)
!76 = !DILocation(line: 40, column: 5, scope: !72)
!77 = !DILocation(line: 41, column: 3, scope: !72)
!78 = !DILocation(line: 42, column: 7, scope: !79)
!79 = distinct !DILexicalBlock(scope: !40, file: !2, line: 42, column: 7)
!80 = !DILocation(line: 42, column: 12, scope: !79)
!81 = !DILocation(line: 42, column: 7, scope: !40)
...
!86 = !DILocation(line: 45, column: 3, scope: !83)
