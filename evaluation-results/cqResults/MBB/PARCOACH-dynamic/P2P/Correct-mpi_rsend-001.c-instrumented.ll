; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/Correct-mpi_rsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/Correct-mpi_rsend-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [76 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/Correct-mpi_rsend-001.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/Correct-mpi_rsend-001.c\00", align 1
...
26:                                               ; preds = %21, %17
  ...
  br i1 %28, label %29, label %33, !dbg !80

29:                                               ; preds = %26
  %30 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 42, ptr @1), !dbg !81
  %31 = load ptr, ptr %9, align 8, !dbg !83
  %32 = call i32 @MPI_Rsend(ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 0, i32 noundef 1140850688), !dbg !84
  br label %33, !dbg !85

33:                                               ; preds = %29, %26
  %34 = load ptr, ptr %9, align 8, !dbg !86
  call void @free(ptr noundef %34) #6, !dbg !87
  %35 = call i32 @MPI_Finalize(), !dbg !88
  %36 = load i32, ptr %7, align 4, !dbg !89
  %37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %36), !dbg !90
  ret i32 0, !dbg !91
}
...
declare i32 @MPI_Rsend(ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/Correct-mpi_rsend-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "8eceb9968577e660eeb07639d2120e9b")
