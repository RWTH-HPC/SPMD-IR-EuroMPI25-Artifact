; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c"
...
30:                                               ; preds = %26, %19
  ...
  br i1 %32, label %33, label %39, !dbg !84

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !85
  %35 = call i32 @MPI_Ibsend(ptr noundef %34, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !87
  %36 = load ptr, ptr %9, align 8, !dbg !88
  %37 = getelementptr inbounds i32, ptr %36, i64 2, !dbg !88
  store i32 1, ptr %37, align 4, !dbg !89
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !90
  br label %39, !dbg !91

39:                                               ; preds = %33, %30
  call void @llvm.dbg.declare(metadata ptr %11, metadata !92, metadata !DIExpression()), !dbg !93
  %40 = load ptr, ptr %10, align 8, !dbg !94
  %41 = call i32 @MPI_Buffer_detach(ptr noundef %40, ptr noundef %11), !dbg !95
  %42 = load ptr, ptr %10, align 8, !dbg !96
  call void @free(ptr noundef %42) #6, !dbg !97
  %43 = load ptr, ptr %9, align 8, !dbg !98
  call void @free(ptr noundef %43) #6, !dbg !99
...
declare i32 @MPI_Ibsend(ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2aba4ab37e9c48272093b9f09322ac53")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2aba4ab37e9c48272093b9f09322ac53")
...
!85 = !DILocation(line: 45, column: 35, scope: !86)
!86 = distinct !DILexicalBlock(scope: !82, file: !2, line: 44, column: 18)
!87 = !DILocation(line: 45, column: 24, scope: !86)
!88 = !DILocation(line: 47, column: 24, scope: !86)
!89 = !DILocation(line: 47, column: 31, scope: !86)
!90 = !DILocation(line: 48, column: 5, scope: !86)
!91 = !DILocation(line: 49, column: 3, scope: !86)
!92 = !DILocalVariable(name: "freed_size", scope: !41, file: !2, line: 50, type: !17)
!93 = !DILocation(line: 50, column: 7, scope: !41)
!94 = !DILocation(line: 51, column: 21, scope: !41)
!95 = !DILocation(line: 51, column: 3, scope: !41)
!96 = !DILocation(line: 52, column: 8, scope: !41)
!97 = !DILocation(line: 52, column: 3, scope: !41)
!98 = !DILocation(line: 53, column: 8, scope: !41)
