; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c"
...
30:                                               ; preds = %26, %19
  ...
  br i1 %32, label %33, label %39, !dbg !94

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !95
  %35 = call i32 @MPI_Ibsend(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !97
  %36 = load ptr, ptr %9, align 8, !dbg !98
  %37 = getelementptr inbounds i32, ptr %36, i64 2, !dbg !98
  store i32 1, ptr %37, align 4, !dbg !99
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !100
  br label %39, !dbg !101

39:                                               ; preds = %33, %30
  call void @llvm.dbg.declare(metadata ptr %11, metadata !102, metadata !DIExpression()), !dbg !103
  %40 = load ptr, ptr %10, align 8, !dbg !104
  %41 = call i32 @MPI_Buffer_detach(ptr noundef %40, ptr noundef %11), !dbg !105
  %42 = load ptr, ptr %10, align 8, !dbg !106
  call void @free(ptr noundef %42) #6, !dbg !107
  %43 = load ptr, ptr %9, align 8, !dbg !108
  call void @free(ptr noundef %43) #6, !dbg !109
  %44 = call i32 @MPI_Finalize(), !dbg !110
...
declare i32 @MPI_Ibsend(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2aba4ab37e9c48272093b9f09322ac53")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_ibsend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2aba4ab37e9c48272093b9f09322ac53")
...
!95 = !DILocation(line: 45, column: 35, scope: !96)
!96 = distinct !DILexicalBlock(scope: !92, file: !2, line: 44, column: 18)
!97 = !DILocation(line: 45, column: 24, scope: !96)
!98 = !DILocation(line: 47, column: 24, scope: !96)
!99 = !DILocation(line: 47, column: 31, scope: !96)
!100 = !DILocation(line: 48, column: 5, scope: !96)
!101 = !DILocation(line: 49, column: 3, scope: !96)
!102 = !DILocalVariable(name: "freed_size", scope: !51, file: !2, line: 50, type: !24)
!103 = !DILocation(line: 50, column: 7, scope: !51)
!104 = !DILocation(line: 51, column: 21, scope: !51)
!105 = !DILocation(line: 51, column: 3, scope: !51)
!106 = !DILocation(line: 52, column: 8, scope: !51)
!107 = !DILocation(line: 52, column: 3, scope: !51)
!108 = !DILocation(line: 53, column: 8, scope: !51)
!109 = !DILocation(line: 53, column: 3, scope: !51)
!110 = !DILocation(line: 55, column: 3, scope: !51)
!111 = !DILocation(line: 56, column: 41, scope: !51)
!112 = !DILocation(line: 56, column: 3, scope: !51)
!113 = !DILocation(line: 57, column: 3, scope: !51)
