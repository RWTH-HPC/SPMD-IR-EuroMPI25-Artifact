; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c\00", align 1
...
21:                                               ; preds = %17
  ...
  %24 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 38, ptr @0), !dbg !74
  %25 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !75
  br label %26, !dbg !76

26:                                               ; preds = %21, %17
  %27 = load i32, ptr %7, align 4, !dbg !77
  %28 = icmp eq i32 %27, 1, !dbg !79
  br i1 %28, label %29, label %37, !dbg !80

29:                                               ; preds = %26
  %30 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 42, ptr @1), !dbg !81
  %31 = load ptr, ptr %9, align 8, !dbg !83
  %32 = call i32 @MPI_Rsend_init(ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i32 noundef 0, i32 noundef 1140850688, ptr noundef %8), !dbg !84
  %33 = call i32 @MPI_Start(ptr noundef %8), !dbg !85
  %34 = load ptr, ptr %9, align 8, !dbg !86
  %35 = getelementptr inbounds i32, ptr %34, i64 2, !dbg !86
  store i32 1, ptr %35, align 4, !dbg !87
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !88
  br label %37, !dbg !89

37:                                               ; preds = %29, %26
  %38 = load ptr, ptr %9, align 8, !dbg !90
  call void @free(ptr noundef %38) #6, !dbg !91
  %39 = load i32, ptr %7, align 4, !dbg !92
  %40 = icmp eq i32 %39, 1, !dbg !94
  br i1 %40, label %41, label %43, !dbg !95

41:                                               ; preds = %37
  %42 = call i32 @MPI_Request_free(ptr noundef %8), !dbg !96
  br label %43, !dbg !98
...
declare i32 @MPI_Rsend_init(ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "bc82294b53d4213ef7754fac1f8ba48f")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "bc82294b53d4213ef7754fac1f8ba48f")
!14 = !{!15, !18, !19, !20, !21}
...
!75 = !DILocation(line: 39, column: 5, scope: !72)
!76 = !DILocation(line: 40, column: 3, scope: !72)
!77 = !DILocation(line: 41, column: 7, scope: !78)
!78 = distinct !DILexicalBlock(scope: !40, file: !2, line: 41, column: 7)
!79 = !DILocation(line: 41, column: 12, scope: !78)
!80 = !DILocation(line: 41, column: 7, scope: !40)
!81 = !DILocation(line: 42, column: 5, scope: !82)
!82 = distinct !DILexicalBlock(scope: !78, file: !2, line: 41, column: 18)
!83 = !DILocation(line: 43, column: 39, scope: !82)
!84 = !DILocation(line: 43, column: 24, scope: !82)
!85 = !DILocation(line: 45, column: 5, scope: !82)
!86 = !DILocation(line: 46, column: 24, scope: !82)
!87 = !DILocation(line: 46, column: 31, scope: !82)
!88 = !DILocation(line: 47, column: 5, scope: !82)
!89 = !DILocation(line: 48, column: 3, scope: !82)
!90 = !DILocation(line: 49, column: 8, scope: !40)
!91 = !DILocation(line: 49, column: 3, scope: !40)
!92 = !DILocation(line: 50, column: 7, scope: !93)
!93 = distinct !DILexicalBlock(scope: !40, file: !2, line: 50, column: 7)
!94 = !DILocation(line: 50, column: 12, scope: !93)
!95 = !DILocation(line: 50, column: 7, scope: !40)
...
!99 = !DILocation(line: 54, column: 3, scope: !40)
!100 = !DILocation(line: 55, column: 41, scope: !40)
!101 = !DILocation(line: 55, column: 3, scope: !40)
!102 = !DILocation(line: 56, column: 3, scope: !40)
