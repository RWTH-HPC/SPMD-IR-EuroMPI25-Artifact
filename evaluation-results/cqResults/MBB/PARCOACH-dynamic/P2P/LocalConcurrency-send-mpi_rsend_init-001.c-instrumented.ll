; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c"
...
@0 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c\00", align 1
...
17:                                               ; preds = %15, %2
  ...
  br i1 %20, label %21, label %26, !dbg !80
...
21:                                               ; preds = %17
  ...
  %24 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 38, ptr @0), !dbg !84
  %25 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !85
  br label %26, !dbg !86

26:                                               ; preds = %21, %17
  %27 = load i32, ptr %7, align 4, !dbg !87
  %28 = icmp eq i32 %27, 1, !dbg !89
  br i1 %28, label %29, label %37, !dbg !90

29:                                               ; preds = %26
  %30 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 42, ptr @1), !dbg !91
  %31 = load ptr, ptr %9, align 8, !dbg !93
  %32 = call i32 @MPI_Rsend_init(ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !94
  %33 = call i32 @MPI_Start(ptr noundef %8), !dbg !95
  %34 = load ptr, ptr %9, align 8, !dbg !96
  %35 = getelementptr inbounds i32, ptr %34, i64 2, !dbg !96
  store i32 1, ptr %35, align 4, !dbg !97
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !98
  br label %37, !dbg !99

37:                                               ; preds = %29, %26
  %38 = load ptr, ptr %9, align 8, !dbg !100
  call void @free(ptr noundef %38) #6, !dbg !101
  %39 = load i32, ptr %7, align 4, !dbg !102
  %40 = icmp eq i32 %39, 1, !dbg !104
  br i1 %40, label %41, label %43, !dbg !105

41:                                               ; preds = %37
  %42 = call i32 @MPI_Request_free(ptr noundef %8), !dbg !106
  br label %43, !dbg !108

43:                                               ; preds = %41, %37
  %44 = call i32 @MPI_Finalize(), !dbg !109
  %45 = load i32, ptr %7, align 4, !dbg !110
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !111
  ret i32 0, !dbg !112
}
...
declare i32 @MPI_Rsend_init(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "bc82294b53d4213ef7754fac1f8ba48f")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/LocalConcurrency-send-mpi_rsend_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "bc82294b53d4213ef7754fac1f8ba48f")
...
!86 = !DILocation(line: 40, column: 3, scope: !82)
!87 = !DILocation(line: 41, column: 7, scope: !88)
!88 = distinct !DILexicalBlock(scope: !50, file: !2, line: 41, column: 7)
!89 = !DILocation(line: 41, column: 12, scope: !88)
!90 = !DILocation(line: 41, column: 7, scope: !50)
!91 = !DILocation(line: 42, column: 5, scope: !92)
!92 = distinct !DILexicalBlock(scope: !88, file: !2, line: 41, column: 18)
!93 = !DILocation(line: 43, column: 39, scope: !92)
!94 = !DILocation(line: 43, column: 24, scope: !92)
!95 = !DILocation(line: 45, column: 5, scope: !92)
!96 = !DILocation(line: 46, column: 24, scope: !92)
!97 = !DILocation(line: 46, column: 31, scope: !92)
!98 = !DILocation(line: 47, column: 5, scope: !92)
!99 = !DILocation(line: 48, column: 3, scope: !92)
!100 = !DILocation(line: 49, column: 8, scope: !50)
!101 = !DILocation(line: 49, column: 3, scope: !50)
!102 = !DILocation(line: 50, column: 7, scope: !103)
!103 = distinct !DILexicalBlock(scope: !50, file: !2, line: 50, column: 7)
!104 = !DILocation(line: 50, column: 12, scope: !103)
!105 = !DILocation(line: 50, column: 7, scope: !50)
!106 = !DILocation(line: 51, column: 5, scope: !107)
!107 = distinct !DILexicalBlock(scope: !103, file: !2, line: 50, column: 18)
!108 = !DILocation(line: 52, column: 3, scope: !107)
!109 = !DILocation(line: 54, column: 3, scope: !50)
!110 = !DILocation(line: 55, column: 41, scope: !50)
!111 = !DILocation(line: 55, column: 3, scope: !50)
!112 = !DILocation(line: 56, column: 3, scope: !50)
