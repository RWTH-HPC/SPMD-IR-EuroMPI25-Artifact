; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend-001.c"
...
25:                                               ; preds = %21, %17
  ...
  br i1 %27, label %28, label %31, !dbg !89

28:                                               ; preds = %25
  %29 = load ptr, ptr %9, align 8, !dbg !90
  %30 = call i32 @MPI_Ssend(ptr noundef %29, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !92
  br label %31, !dbg !93

31:                                               ; preds = %28, %25
  %32 = load ptr, ptr %9, align 8, !dbg !94
  call void @free(ptr noundef %32) #6, !dbg !95
  %33 = call i32 @MPI_Finalize(), !dbg !96
  %34 = load i32, ptr %7, align 4, !dbg !97
  %35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %34), !dbg !98
  ret i32 0, !dbg !99
}
...
declare i32 @MPI_Ssend(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "acf565fd1ab56b8176de22b65171b910")
...
!94 = !DILocation(line: 43, column: 8, scope: !50)
!95 = !DILocation(line: 43, column: 3, scope: !50)
!96 = !DILocation(line: 45, column: 3, scope: !50)
!97 = !DILocation(line: 46, column: 41, scope: !50)
