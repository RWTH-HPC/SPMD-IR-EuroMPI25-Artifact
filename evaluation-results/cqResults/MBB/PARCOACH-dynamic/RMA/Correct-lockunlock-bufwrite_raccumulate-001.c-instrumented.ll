; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c"
...
@0 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@1 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@2 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@3 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@4 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@5 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@6 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@7 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@8 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@9 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
@10 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %24, label %25, label %37, !dbg !93
...
25:                                               ; preds = %19
  ...
  call void @parcoach_rma_store(ptr %30, i64 32, i32 45, ptr @4), !dbg !101
  store i32 42, ptr %30, align 4, !dbg !101
  call void @parcoach_rma_load(ptr %11, i64 64, i32 46, ptr @5), !dbg !102
  ...
  %33 = call i32 @MPI_Raccumulate(ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %32, ptr noundef %8), !dbg !104
  call void @parcoach_rma_load(ptr %9, i64 64, i32 48, ptr @7), !dbg !105
  %34 = load ptr, ptr %9, align 8, !dbg !105
  %35 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %34, i32 48, ptr @8), !dbg !106
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !107
  br label %37, !dbg !108

37:                                               ; preds = %25, %19
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @9), !dbg !109
  %39 = call i32 @MPI_Finalize(), !dbg !110
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @10), !dbg !111
  %40 = load i32, ptr %7, align 4, !dbg !111
  %41 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40), !dbg !112
  ret i32 0, !dbg !113
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "be37e53c851d24dff8e3fd2e021af492")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-bufwrite_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "be37e53c851d24dff8e3fd2e021af492")
...
!100 = !DILocation(line: 45, column: 5, scope: !95)
!101 = !DILocation(line: 45, column: 12, scope: !95)
!102 = !DILocation(line: 46, column: 21, scope: !95)
!103 = !DILocation(line: 46, column: 68, scope: !95)
!104 = !DILocation(line: 46, column: 5, scope: !95)
!105 = !DILocation(line: 48, column: 23, scope: !95)
!106 = !DILocation(line: 48, column: 5, scope: !95)
!107 = !DILocation(line: 49, column: 5, scope: !95)
!108 = !DILocation(line: 50, column: 3, scope: !95)
!109 = !DILocation(line: 51, column: 3, scope: !56)
!110 = !DILocation(line: 53, column: 3, scope: !56)
!111 = !DILocation(line: 54, column: 41, scope: !56)
