; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_accumulate_get-001.c'
...
28:                                               ; preds = %20
  ...
  %36 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %35), !dbg !82
  %37 = load ptr, ptr %11, align 8, !dbg !83
  %38 = load i32, ptr %9, align 4, !dbg !84
  %39 = call i32 @MPI_Get(ptr noundef %37, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef %38), !dbg !85
  br label %40, !dbg !86
...
43:                                               ; preds = %40
  ...
  %45 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %44), !dbg !93
  br label %46, !dbg !94

46:                                               ; preds = %43, %40
  %47 = load i32, ptr %9, align 4, !dbg !95
  %48 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %47), !dbg !96
  %49 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !97
