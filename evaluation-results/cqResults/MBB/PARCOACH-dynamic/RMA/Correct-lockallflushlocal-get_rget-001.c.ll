; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_rget-001.c'
...
19:                                               ; preds = %17, %2
  ...
  %24 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %23), !dbg !74
...
37:                                               ; preds = %27, %19
  ...
  %39 = call i32 @MPI_Win_unlock_all(i32 noundef %38), !dbg !93
...
44:                                               ; preds = %42, %37
  %45 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !101
