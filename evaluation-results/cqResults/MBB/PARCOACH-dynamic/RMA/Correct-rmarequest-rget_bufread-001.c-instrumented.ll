; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c"
...
@0 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %26, label %27, label %37, !dbg !83
...
27:                                               ; preds = %19
  ...
  %32 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !91
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @6), !dbg !92
  %33 = load ptr, ptr %11, align 8, !dbg !92
  %34 = getelementptr inbounds i32, ptr %33, i64 0, !dbg !92
  call void @parcoach_rma_load(ptr %34, i64 32, i32 47, ptr @7), !dbg !92
  %35 = load i32, ptr %34, align 4, !dbg !92
  %36 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %35), !dbg !93
  br label %37, !dbg !94

37:                                               ; preds = %27, %19
  call void @parcoach_rma_load(ptr %9, i64 32, i32 49, ptr @8), !dbg !95
  %38 = load i32, ptr %9, align 4, !dbg !95
  %39 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %38, i32 49, ptr @9), !dbg !96
  call void @parcoach_rma_load(ptr %7, i64 32, i32 50, ptr @10), !dbg !97
  %40 = load i32, ptr %7, align 4, !dbg !97
  %41 = icmp eq i32 %40, 0, !dbg !99
  br i1 %41, label %42, label %44, !dbg !100

42:                                               ; preds = %37
  %43 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !101
  br label %44, !dbg !103

44:                                               ; preds = %42, %37
  %45 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !104
  %46 = call i32 @MPI_Finalize(), !dbg !105
  %47 = load i32, ptr %7, align 4, !dbg !106
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %47), !dbg !107
  ret i32 0, !dbg !108
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "64a0f622c5f6c1a1de031bb86f55777c")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "64a0f622c5f6c1a1de031bb86f55777c")
...
!91 = !DILocation(line: 46, column: 5, scope: !85)
!92 = !DILocation(line: 47, column: 27, scope: !85)
!93 = !DILocation(line: 47, column: 5, scope: !85)
!94 = !DILocation(line: 48, column: 3, scope: !85)
!95 = !DILocation(line: 49, column: 22, scope: !46)
!96 = !DILocation(line: 49, column: 3, scope: !46)
!97 = !DILocation(line: 50, column: 7, scope: !98)
!98 = distinct !DILexicalBlock(scope: !46, file: !2, line: 50, column: 7)
!99 = !DILocation(line: 50, column: 12, scope: !98)
!100 = !DILocation(line: 50, column: 7, scope: !46)
...
!104 = !DILocation(line: 53, column: 3, scope: !46)
!105 = !DILocation(line: 55, column: 3, scope: !46)
!106 = !DILocation(line: 56, column: 41, scope: !46)
!107 = !DILocation(line: 56, column: 3, scope: !46)
!108 = !DILocation(line: 57, column: 3, scope: !46)
