; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-rget_accumulate_bufread-001.c'
...
21:                                               ; preds = %19, %2
  ...
  %26 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %25), !dbg !82
...
40:                                               ; preds = %29, %21
  ...
  %42 = call i32 @MPI_Win_unlock_all(i32 noundef %41), !dbg !102
...
47:                                               ; preds = %45, %40
  %48 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !110
