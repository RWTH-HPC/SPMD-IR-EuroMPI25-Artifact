; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-accumulate_get-001.c'
...
18:                                               ; preds = %16, %2
  ...
  %21 = call i32 @MPI_Win_create(ptr noundef %20, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !72
...
24:                                               ; preds = %18
  ...
  %26 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %25), !dbg !79
  ...
  %30 = call i32 @MPI_Accumulate(ptr noundef %28, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %29), !dbg !85
  %31 = load ptr, ptr %10, align 8, !dbg !86
  %32 = load ptr, ptr %8, align 8, !dbg !87
  %33 = call i32 @MPI_Get(ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %32), !dbg !88
  %34 = load ptr, ptr %8, align 8, !dbg !89
  %35 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %34), !dbg !90
  br label %36, !dbg !91

36:                                               ; preds = %24, %18
  %37 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !92
