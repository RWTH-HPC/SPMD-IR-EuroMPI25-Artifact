; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c"
...
@0 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c\00", align 1
...
25:                                               ; preds = %19
  ...
  %33 = call i32 @MPI_Win_flush_local(i32 noundef 1, i32 noundef %32), !dbg !92
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @6), !dbg !93
  %34 = load ptr, ptr %11, align 8, !dbg !93
  %35 = getelementptr inbounds i32, ptr %34, i64 0, !dbg !93
  call void @parcoach_rma_load(ptr %35, i64 32, i32 47, ptr @7), !dbg !93
  %36 = load i32, ptr %35, align 4, !dbg !93
  %37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %36), !dbg !94
  call void @parcoach_rma_load(ptr %9, i64 32, i32 48, ptr @8), !dbg !95
  %38 = load i32, ptr %9, align 4, !dbg !95
  %39 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %38, i32 48, ptr @9), !dbg !96
  %40 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !97
  br label %41, !dbg !98

41:                                               ; preds = %25, %19
  %42 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @10), !dbg !99
  %43 = call i32 @MPI_Finalize(), !dbg !100
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @11), !dbg !101
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1d7454de9ed01670531843e1ef5d852d")
...
!91 = !DILocation(line: 46, column: 28, scope: !83)
