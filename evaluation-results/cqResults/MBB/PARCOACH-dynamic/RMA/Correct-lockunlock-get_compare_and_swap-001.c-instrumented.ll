; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c"
...
@0 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@1 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@2 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@3 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@4 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@5 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@6 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@7 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@8 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@9 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@10 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@11 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@12 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@13 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
@14 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c\00", align 1
...
22:                                               ; preds = %20, %2
  ...
  br i1 %27, label %28, label %44, !dbg !77
...
28:                                               ; preds = %22
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 46, ptr @3), !dbg !84
  %32 = load ptr, ptr %12, align 8, !dbg !84
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @4), !dbg !85
  %33 = load ptr, ptr %10, align 8, !dbg !85
  %34 = call i32 @parcoach_rma_MPI_Get(ptr %32, i32 10, ptr @ompi_mpi_int, i32 1, i64 0, i32 10, ptr @ompi_mpi_int, ptr %33, i32 46, ptr @5), !dbg !86
  %35 = load ptr, ptr %10, align 8, !dbg !87
  %36 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %35, i32 47, ptr @6), !dbg !88
  ...
  call void @parcoach_rma_store(ptr %14, i64 64, i32 51, ptr @8), !dbg !93
  store ptr %38, ptr %14, align 8, !dbg !93
  call void @parcoach_rma_load(ptr %12, i64 64, i32 53, ptr @9), !dbg !95
  %39 = load ptr, ptr %12, align 8, !dbg !95
  call void @parcoach_rma_load(ptr %14, i64 64, i32 53, ptr @10), !dbg !96
  %40 = load ptr, ptr %14, align 8, !dbg !96
  call void @parcoach_rma_load(ptr %13, i64 64, i32 53, ptr @11), !dbg !97
  %41 = load ptr, ptr %13, align 8, !dbg !97
  call void @parcoach_rma_load(ptr %10, i64 64, i32 53, ptr @12), !dbg !98
  %42 = load ptr, ptr %10, align 8, !dbg !98
  %43 = call i32 @MPI_Compare_and_swap(ptr noundef %39, ptr noundef %40, ptr noundef %41, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, ptr noundef %42), !dbg !99
  br label %44, !dbg !100
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f9c11a2e36f7fe51bb10e643f97699dc")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_compare_and_swap-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f9c11a2e36f7fe51bb10e643f97699dc")
!14 = !{!15, !19, !20, !22, !25}
...
!85 = !DILocation(line: 46, column: 50, scope: !79)
!86 = !DILocation(line: 46, column: 5, scope: !79)
!87 = !DILocation(line: 47, column: 23, scope: !79)
!88 = !DILocation(line: 47, column: 5, scope: !79)
!89 = !DILocalVariable(name: "int_0", scope: !79, file: !2, line: 49, type: !20)
!90 = !DILocation(line: 49, column: 10, scope: !79)
!91 = !DILocation(line: 49, column: 25, scope: !79)
!92 = !DILocalVariable(name: "int_1", scope: !79, file: !2, line: 51, type: !20)
!93 = !DILocation(line: 51, column: 10, scope: !79)
!94 = !DILocation(line: 51, column: 25, scope: !79)
!95 = !DILocation(line: 53, column: 26, scope: !79)
!96 = !DILocation(line: 53, column: 31, scope: !79)
!97 = !DILocation(line: 53, column: 38, scope: !79)
!98 = !DILocation(line: 53, column: 61, scope: !79)
!99 = !DILocation(line: 53, column: 5, scope: !79)
!100 = !DILocation(line: 54, column: 3, scope: !79)
