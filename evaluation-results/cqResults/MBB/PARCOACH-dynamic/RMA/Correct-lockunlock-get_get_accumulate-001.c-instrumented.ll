; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c"
...
@0 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c\00", align 1
...
26:                                               ; preds = %20
  ...
  call void @parcoach_rma_load(ptr %9, i64 64, i32 45, ptr @4), !dbg !86
  %31 = load ptr, ptr %9, align 8, !dbg !86
  %32 = call i32 @parcoach_rma_MPI_Get(ptr %30, i32 10, ptr @ompi_mpi_int, i32 1, i64 0, i32 10, ptr @ompi_mpi_int, ptr %31, i32 45, ptr @5), !dbg !87
  %33 = load ptr, ptr %9, align 8, !dbg !88
  %34 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %33, i32 46, ptr @6), !dbg !89
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 48, ptr @7), !dbg !91
  store ptr %35, ptr %12, align 8, !dbg !91
  call void @parcoach_rma_load(ptr %11, i64 64, i32 50, ptr @8), !dbg !93
  %36 = load ptr, ptr %11, align 8, !dbg !93
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @9), !dbg !94
  ...
  %39 = call i32 @MPI_Get_accumulate(ptr noundef %36, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %37, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %38), !dbg !96
  br label %40, !dbg !97

40:                                               ; preds = %26, %20
  %41 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !98
  %42 = call i32 @MPI_Finalize(), !dbg !99
  call void @parcoach_rma_load(ptr %7, i64 32, i32 56, ptr @12), !dbg !100
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "704a6315f5c87a186b9f4bd6fe8703bc")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "704a6315f5c87a186b9f4bd6fe8703bc")
...
!86 = !DILocation(line: 45, column: 50, scope: !80)
!87 = !DILocation(line: 45, column: 5, scope: !80)
!88 = !DILocation(line: 46, column: 23, scope: !80)
!89 = !DILocation(line: 46, column: 5, scope: !80)
!90 = !DILocalVariable(name: "int_0", scope: !80, file: !2, line: 48, type: !20)
!91 = !DILocation(line: 48, column: 10, scope: !80)
!92 = !DILocation(line: 48, column: 25, scope: !80)
!93 = !DILocation(line: 50, column: 24, scope: !80)
!94 = !DILocation(line: 50, column: 42, scope: !80)
!95 = !DILocation(line: 51, column: 33, scope: !80)
