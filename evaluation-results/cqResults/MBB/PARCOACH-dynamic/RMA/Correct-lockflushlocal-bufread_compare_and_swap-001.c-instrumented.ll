; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c"
...
@0 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@1 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@2 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@3 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@4 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@5 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@6 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@7 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@8 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@9 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@10 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@11 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@12 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@13 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
@14 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c\00", align 1
...
28:                                               ; preds = %22
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 46, ptr @3), !dbg !80
  %32 = load ptr, ptr %12, align 8, !dbg !80
  %33 = getelementptr inbounds i32, ptr %32, i64 0, !dbg !80
  call void @parcoach_rma_load(ptr %33, i64 32, i32 46, ptr @4), !dbg !80
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 48, ptr @5), !dbg !83
  ...
  call void @parcoach_rma_store(ptr %14, i64 64, i32 50, ptr @6), !dbg !86
  store ptr %37, ptr %14, align 8, !dbg !86
  call void @parcoach_rma_load(ptr %12, i64 64, i32 52, ptr @7), !dbg !88
  %38 = load ptr, ptr %12, align 8, !dbg !88
  call void @parcoach_rma_load(ptr %14, i64 64, i32 52, ptr @8), !dbg !89
  %39 = load ptr, ptr %14, align 8, !dbg !89
  call void @parcoach_rma_load(ptr %13, i64 64, i32 52, ptr @9), !dbg !90
  %40 = load ptr, ptr %13, align 8, !dbg !90
  call void @parcoach_rma_load(ptr %10, i64 32, i32 52, ptr @10), !dbg !91
  %41 = load i32, ptr %10, align 4, !dbg !91
  %42 = call i32 @MPI_Compare_and_swap(ptr noundef %38, ptr noundef %39, ptr noundef %40, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef %41), !dbg !92
  call void @parcoach_rma_load(ptr %10, i64 32, i32 53, ptr @11), !dbg !93
  %43 = load i32, ptr %10, align 4, !dbg !93
  %44 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %43, i32 53, ptr @12), !dbg !94
  br label %45, !dbg !95

45:                                               ; preds = %28, %22
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 55, ptr @13), !dbg !96
  %47 = call i32 @MPI_Finalize(), !dbg !97
  call void @parcoach_rma_load(ptr %7, i64 32, i32 58, ptr @14), !dbg !98
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "06ef1a0686231f5cf70a4d6bd6ee3fc8")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_compare_and_swap-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "06ef1a0686231f5cf70a4d6bd6ee3fc8")
!19 = !{!20, !23, !24, !25}
...
!80 = !DILocation(line: 46, column: 27, scope: !75)
!81 = !DILocation(line: 46, column: 5, scope: !75)
!82 = !DILocalVariable(name: "int_0", scope: !75, file: !2, line: 48, type: !23)
!83 = !DILocation(line: 48, column: 10, scope: !75)
!84 = !DILocation(line: 48, column: 25, scope: !75)
!85 = !DILocalVariable(name: "int_1", scope: !75, file: !2, line: 50, type: !23)
!86 = !DILocation(line: 50, column: 10, scope: !75)
!87 = !DILocation(line: 50, column: 25, scope: !75)
!88 = !DILocation(line: 52, column: 26, scope: !75)
!89 = !DILocation(line: 52, column: 31, scope: !75)
!90 = !DILocation(line: 52, column: 38, scope: !75)
!91 = !DILocation(line: 52, column: 61, scope: !75)
!92 = !DILocation(line: 52, column: 5, scope: !75)
!93 = !DILocation(line: 53, column: 23, scope: !75)
!94 = !DILocation(line: 53, column: 5, scope: !75)
!95 = !DILocation(line: 54, column: 3, scope: !75)
