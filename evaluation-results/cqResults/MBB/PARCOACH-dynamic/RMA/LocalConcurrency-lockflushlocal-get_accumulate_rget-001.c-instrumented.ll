; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c"
...
@0 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@1 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@2 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@3 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@4 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@5 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@6 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@7 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@8 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@9 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@10 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@11 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
@12 = private unnamed_addr constant [110 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c\00", align 1
...
21:                                               ; preds = %19, %2
  ...
  br i1 %26, label %27, label %42, !dbg !95
...
27:                                               ; preds = %21
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 50, ptr @6), !dbg !107
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 51, ptr @8), !dbg !110
  %37 = load ptr, ptr %10, align 8, !dbg !110
  %38 = call i32 @MPI_Rget(ptr noundef %36, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %37, ptr noundef %9), !dbg !111
  call void @parcoach_rma_load(ptr %10, i64 64, i32 53, ptr @9), !dbg !112
  %39 = load ptr, ptr %10, align 8, !dbg !112
  %40 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %39, i32 53, ptr @10), !dbg !113
  %41 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !114
  br label %42, !dbg !115

42:                                               ; preds = %27, %21
  %43 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 56, ptr @11), !dbg !116
  %44 = call i32 @MPI_Finalize(), !dbg !117
  call void @parcoach_rma_load(ptr %7, i64 32, i32 59, ptr @12), !dbg !118
  %45 = load i32, ptr %7, align 4, !dbg !118
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !119
  ret i32 0, !dbg !120
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "02c5f9a2009cd0f7889bfbae0b07b26a")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-get_accumulate_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "02c5f9a2009cd0f7889bfbae0b07b26a")
...
!105 = !DILocation(line: 48, column: 43, scope: !97)
!106 = !DILocation(line: 48, column: 61, scope: !97)
!107 = !DILocation(line: 50, column: 43, scope: !97)
!108 = !DILocation(line: 48, column: 24, scope: !97)
!109 = !DILocation(line: 51, column: 33, scope: !97)
!110 = !DILocation(line: 51, column: 71, scope: !97)
!111 = !DILocation(line: 51, column: 24, scope: !97)
!112 = !DILocation(line: 53, column: 23, scope: !97)
!113 = !DILocation(line: 53, column: 5, scope: !97)
!114 = !DILocation(line: 54, column: 5, scope: !97)
!115 = !DILocation(line: 55, column: 3, scope: !97)
!116 = !DILocation(line: 56, column: 3, scope: !56)
!117 = !DILocation(line: 58, column: 3, scope: !56)
!118 = !DILocation(line: 59, column: 41, scope: !56)
!119 = !DILocation(line: 59, column: 3, scope: !56)
!120 = !DILocation(line: 60, column: 3, scope: !56)
