; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c"
...
@0 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c\00", align 1
...
24:                                               ; preds = %18
  ...
  %26 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %25, i32 40, ptr @1), !dbg !72
  ...
  call void @parcoach_rma_store(ptr %10, i64 64, i32 42, ptr @2), !dbg !74
  store ptr %27, ptr %10, align 8, !dbg !74
  call void @parcoach_rma_load(ptr %10, i64 64, i32 44, ptr @3), !dbg !76
  %28 = load ptr, ptr %10, align 8, !dbg !76
  %29 = getelementptr inbounds i32, ptr %28, i64 0, !dbg !76
  call void @parcoach_rma_load(ptr %29, i64 32, i32 44, ptr @4), !dbg !76
  %30 = load i32, ptr %29, align 4, !dbg !76
  %31 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %30), !dbg !77
  call void @parcoach_rma_load(ptr %10, i64 64, i32 45, ptr @5), !dbg !78
  %32 = load ptr, ptr %10, align 8, !dbg !78
  call void @parcoach_rma_load(ptr %8, i64 32, i32 45, ptr @6), !dbg !79
  %33 = load i32, ptr %8, align 4, !dbg !79
  %34 = call i32 @parcoach_rma_MPI_Put(ptr %32, i32 10, i32 1275069445, i32 1, i64 10, i32 10, i32 1275069445, i32 %33, i32 45, ptr @7), !dbg !80
  %35 = load i32, ptr %8, align 4, !dbg !81
  %36 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %35, i32 46, ptr @8), !dbg !82
  br label %37, !dbg !83

37:                                               ; preds = %24, %18
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 48, ptr @9), !dbg !84
  %39 = call i32 @MPI_Finalize(), !dbg !85
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @10), !dbg !86
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "73eacf63890444ae1c091d8b93673635")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_put-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "73eacf63890444ae1c091d8b93673635")
!19 = !{!20, !23, !24, !25}
...
!76 = !DILocation(line: 44, column: 27, scope: !71)
!77 = !DILocation(line: 44, column: 5, scope: !71)
!78 = !DILocation(line: 45, column: 13, scope: !71)
!79 = !DILocation(line: 45, column: 51, scope: !71)
!80 = !DILocation(line: 45, column: 5, scope: !71)
!81 = !DILocation(line: 46, column: 23, scope: !71)
!82 = !DILocation(line: 46, column: 5, scope: !71)
!83 = !DILocation(line: 47, column: 3, scope: !71)
