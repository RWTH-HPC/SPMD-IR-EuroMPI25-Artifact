; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_rget_accumulate-001.c'
...
30:                                               ; preds = %24
  ...
  %32 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %31), !dbg !86
  ...
  %45 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %44), !dbg !105
...
48:                                               ; preds = %30, %24
  %49 = call i32 @MPI_Win_free(ptr noundef %12), !dbg !109
