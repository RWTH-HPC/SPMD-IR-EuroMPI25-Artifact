; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-get_accumulate_rget-001.c'
...
27:                                               ; preds = %21
  ...
  %42 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %41), !dbg !99
  %43 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef inttoptr (i64 1 to ptr)), !dbg !100
  br label %44, !dbg !101

44:                                               ; preds = %27, %21
  %45 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !102
