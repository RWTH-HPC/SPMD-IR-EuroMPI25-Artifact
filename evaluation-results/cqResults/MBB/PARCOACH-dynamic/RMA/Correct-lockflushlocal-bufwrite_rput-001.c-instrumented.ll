; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %24, label %25, label %37, !dbg !76
...
25:                                               ; preds = %19
  ...
  %30 = getelementptr inbounds i32, ptr %29, i64 0, !dbg !83
  call void @parcoach_rma_store(ptr %30, i64 32, i32 45, ptr @4), !dbg !84
  store i32 42, ptr %30, align 4, !dbg !84
  call void @parcoach_rma_load(ptr %11, i64 64, i32 46, ptr @5), !dbg !85
  %31 = load ptr, ptr %11, align 8, !dbg !85
  call void @parcoach_rma_load(ptr %9, i64 32, i32 46, ptr @6), !dbg !86
  %32 = load i32, ptr %9, align 4, !dbg !86
  %33 = call i32 @MPI_Rput(ptr noundef %31, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef %32, ptr noundef %8), !dbg !87
  call void @parcoach_rma_load(ptr %9, i64 32, i32 47, ptr @7), !dbg !88
  %34 = load i32, ptr %9, align 4, !dbg !88
  %35 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %34, i32 47, ptr @8), !dbg !89
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !90
  br label %37, !dbg !91

37:                                               ; preds = %25, %19
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 50, ptr @9), !dbg !92
  %39 = call i32 @MPI_Finalize(), !dbg !93
  call void @parcoach_rma_load(ptr %7, i64 32, i32 53, ptr @10), !dbg !94
  %40 = load i32, ptr %7, align 4, !dbg !94
  %41 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40), !dbg !95
  ret i32 0, !dbg !96
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "75cee5ba9218aab09ccca4f276b777ff")
...
!83 = !DILocation(line: 45, column: 5, scope: !78)
!84 = !DILocation(line: 45, column: 12, scope: !78)
!85 = !DILocation(line: 46, column: 14, scope: !78)
!86 = !DILocation(line: 46, column: 52, scope: !78)
!87 = !DILocation(line: 46, column: 5, scope: !78)
!88 = !DILocation(line: 47, column: 23, scope: !78)
!89 = !DILocation(line: 47, column: 5, scope: !78)
!90 = !DILocation(line: 48, column: 5, scope: !78)
!91 = !DILocation(line: 49, column: 3, scope: !78)
!92 = !DILocation(line: 50, column: 3, scope: !41)
!93 = !DILocation(line: 52, column: 3, scope: !41)
!94 = !DILocation(line: 53, column: 41, scope: !41)
!95 = !DILocation(line: 53, column: 3, scope: !41)
!96 = !DILocation(line: 54, column: 3, scope: !41)
