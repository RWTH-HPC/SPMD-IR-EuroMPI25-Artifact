; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c\00", align 1
...
27:                                               ; preds = %21
  ...
  %29 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %28, i32 42, ptr @1), !dbg !87
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 44, ptr @2), !dbg !89
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 46, ptr @3), !dbg !92
  store ptr %31, ptr %13, align 8, !dbg !92
  call void @parcoach_rma_load(ptr %12, i64 64, i32 48, ptr @4), !dbg !94
  %32 = load ptr, ptr %12, align 8, !dbg !94
  call void @parcoach_rma_load(ptr %13, i64 64, i32 48, ptr @5), !dbg !95
  %33 = load ptr, ptr %13, align 8, !dbg !95
  call void @parcoach_rma_load(ptr %10, i64 32, i32 49, ptr @6), !dbg !96
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @7), !dbg !98
  %36 = load ptr, ptr %12, align 8, !dbg !98
  %37 = getelementptr inbounds i32, ptr %36, i64 0, !dbg !98
  call void @parcoach_rma_load(ptr %37, i64 32, i32 50, ptr @8), !dbg !98
  %38 = load i32, ptr %37, align 4, !dbg !98
  %39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %38), !dbg !99
  call void @parcoach_rma_load(ptr %10, i64 32, i32 51, ptr @9), !dbg !100
  %40 = load i32, ptr %10, align 4, !dbg !100
  %41 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %40, i32 51, ptr @10), !dbg !101
  %42 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !102
  br label %43, !dbg !103

43:                                               ; preds = %27, %21
  %44 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 54, ptr @11), !dbg !104
  %45 = call i32 @MPI_Finalize(), !dbg !105
  call void @parcoach_rma_load(ptr %7, i64 32, i32 57, ptr @12), !dbg !106
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7b2a5847908566f8b70886a76903f436")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7b2a5847908566f8b70886a76903f436")
...
!91 = !DILocalVariable(name: "int_0", scope: !86, file: !2, line: 46, type: !24)
!92 = !DILocation(line: 46, column: 10, scope: !86)
!93 = !DILocation(line: 46, column: 25, scope: !86)
!94 = !DILocation(line: 48, column: 25, scope: !86)
!95 = !DILocation(line: 48, column: 43, scope: !86)
!96 = !DILocation(line: 49, column: 34, scope: !86)
!97 = !DILocation(line: 48, column: 5, scope: !86)
!98 = !DILocation(line: 50, column: 27, scope: !86)
!99 = !DILocation(line: 50, column: 5, scope: !86)
!100 = !DILocation(line: 51, column: 23, scope: !86)
!101 = !DILocation(line: 51, column: 5, scope: !86)
!102 = !DILocation(line: 52, column: 5, scope: !86)
!103 = !DILocation(line: 53, column: 3, scope: !86)
!104 = !DILocation(line: 54, column: 3, scope: !47)
!105 = !DILocation(line: 56, column: 3, scope: !47)
!106 = !DILocation(line: 57, column: 41, scope: !47)
!107 = !DILocation(line: 57, column: 3, scope: !47)
!108 = !DILocation(line: 58, column: 3, scope: !47)
