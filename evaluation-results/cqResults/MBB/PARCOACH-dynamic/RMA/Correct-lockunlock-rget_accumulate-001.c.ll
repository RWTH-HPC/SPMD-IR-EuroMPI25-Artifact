; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c'
...
25:                                               ; preds = %19
  ...
  %33 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %32), !dbg !88
  %34 = load i32, ptr %9, align 4, !dbg !89
  %35 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %34), !dbg !90
  %36 = load ptr, ptr %11, align 8, !dbg !91
  %37 = load i32, ptr %9, align 4, !dbg !92
  %38 = call i32 @MPI_Accumulate(ptr noundef %36, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %37), !dbg !93
  %39 = load i32, ptr %9, align 4, !dbg !94
  %40 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %39), !dbg !95
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !96
  br label %42, !dbg !97

42:                                               ; preds = %25, %19
  %43 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !98
