; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_rget-001.c'
...
23:                                               ; preds = %21, %2
  ...
  %28 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %27), !dbg !78
...
45:                                               ; preds = %31, %23
  ...
  %47 = call i32 @MPI_Win_unlock_all(i32 noundef %46), !dbg !105
...
52:                                               ; preds = %50, %45
  %53 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !113
