; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c"
...
@0 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
@13 = private unnamed_addr constant [108 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c\00", align 1
...
29:                                               ; preds = %21
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 46, ptr @4), !dbg !107
  %31 = load ptr, ptr %12, align 8, !dbg !107
  %32 = getelementptr inbounds i32, ptr %31, i64 0, !dbg !107
  call void @parcoach_rma_load(ptr %32, i64 32, i32 46, ptr @5), !dbg !107
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 48, ptr @6), !dbg !110
  store ptr %35, ptr %13, align 8, !dbg !110
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @7), !dbg !112
  %36 = load ptr, ptr %12, align 8, !dbg !112
  call void @parcoach_rma_load(ptr %13, i64 64, i32 50, ptr @8), !dbg !113
  %37 = load ptr, ptr %13, align 8, !dbg !113
  call void @parcoach_rma_load(ptr %10, i64 64, i32 51, ptr @9), !dbg !114
  %38 = load ptr, ptr %10, align 8, !dbg !114
  %39 = call i32 @MPI_Rget_accumulate(ptr noundef %36, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %37, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %38, ptr noundef %8), !dbg !115
  br label %40, !dbg !116

40:                                               ; preds = %29, %21
  call void @parcoach_rma_load(ptr %10, i64 64, i32 53, ptr @10), !dbg !117
  %41 = load ptr, ptr %10, align 8, !dbg !117
  %42 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %41, i32 53, ptr @11), !dbg !118
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @12), !dbg !119
...
47:                                               ; preds = %45, %40
  %48 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 57, ptr @13), !dbg !126
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e48ea3c19b4db3d4d823d6af7e10bc4c")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e48ea3c19b4db3d4d823d6af7e10bc4c")
...
!107 = !DILocation(line: 46, column: 27, scope: !104)
!108 = !DILocation(line: 46, column: 5, scope: !104)
!109 = !DILocalVariable(name: "int_0", scope: !104, file: !2, line: 48, type: !28)
!110 = !DILocation(line: 48, column: 10, scope: !104)
!111 = !DILocation(line: 48, column: 25, scope: !104)
!112 = !DILocation(line: 50, column: 25, scope: !104)
!113 = !DILocation(line: 50, column: 43, scope: !104)
!114 = !DILocation(line: 51, column: 34, scope: !104)
!115 = !DILocation(line: 50, column: 5, scope: !104)
!116 = !DILocation(line: 52, column: 3, scope: !104)
!117 = !DILocation(line: 53, column: 22, scope: !61)
!118 = !DILocation(line: 53, column: 3, scope: !61)
!119 = !DILocation(line: 54, column: 7, scope: !120)
!120 = distinct !DILexicalBlock(scope: !61, file: !2, line: 54, column: 7)
!121 = !DILocation(line: 54, column: 12, scope: !120)
!122 = !DILocation(line: 54, column: 7, scope: !61)
...
!126 = !DILocation(line: 57, column: 3, scope: !61)
!127 = !DILocation(line: 59, column: 3, scope: !61)
!128 = !DILocation(line: 60, column: 41, scope: !61)
!129 = !DILocation(line: 60, column: 3, scope: !61)
!130 = !DILocation(line: 61, column: 3, scope: !61)
