; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufwrite_rput-001.c'
...
25:                                               ; preds = %19
  ...
  %35 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %34), !dbg !89
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !90
  br label %37, !dbg !91

37:                                               ; preds = %25, %19
  %38 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !92
