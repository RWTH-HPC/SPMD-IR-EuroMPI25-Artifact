; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c\00", align 1
...
20:                                               ; preds = %18, %2
  ...
  br i1 %25, label %26, label %44, !dbg !78
...
26:                                               ; preds = %20
  ...
  %34 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %33, i32 47, ptr @6), !dbg !89
  call void @parcoach_rma_load(ptr %10, i64 32, i32 48, ptr @7), !dbg !90
  %35 = load i32, ptr %10, align 4, !dbg !90
  %36 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %35, i32 48, ptr @8), !dbg !91
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !92
  %37 = load ptr, ptr %12, align 8, !dbg !92
  call void @parcoach_rma_load(ptr %10, i64 32, i32 49, ptr @10), !dbg !93
  %38 = load i32, ptr %10, align 4, !dbg !93
  %39 = call i32 @MPI_Rget(ptr noundef %37, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef %38, ptr noundef %9), !dbg !94
  call void @parcoach_rma_load(ptr %10, i64 32, i32 50, ptr @11), !dbg !95
  %40 = load i32, ptr %10, align 4, !dbg !95
  %41 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %40, i32 50, ptr @12), !dbg !96
  %42 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !97
  %43 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef inttoptr (i64 1 to ptr)), !dbg !98
  br label %44, !dbg !99

44:                                               ; preds = %26, %20
  %45 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 54, ptr @13), !dbg !100
  %46 = call i32 @MPI_Finalize(), !dbg !101
  call void @parcoach_rma_load(ptr %7, i64 32, i32 57, ptr @14), !dbg !102
  %47 = load i32, ptr %7, align 4, !dbg !102
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %47), !dbg !103
  ret i32 0, !dbg !104
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "37473efbf18c291877aeafc66b10b707")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "37473efbf18c291877aeafc66b10b707")
...
!88 = !DILocation(line: 47, column: 23, scope: !80)
!89 = !DILocation(line: 47, column: 5, scope: !80)
!90 = !DILocation(line: 48, column: 44, scope: !80)
!91 = !DILocation(line: 48, column: 5, scope: !80)
!92 = !DILocation(line: 49, column: 14, scope: !80)
!93 = !DILocation(line: 49, column: 52, scope: !80)
!94 = !DILocation(line: 49, column: 5, scope: !80)
!95 = !DILocation(line: 50, column: 23, scope: !80)
!96 = !DILocation(line: 50, column: 5, scope: !80)
!97 = !DILocation(line: 51, column: 5, scope: !80)
!98 = !DILocation(line: 52, column: 5, scope: !80)
!99 = !DILocation(line: 53, column: 3, scope: !80)
