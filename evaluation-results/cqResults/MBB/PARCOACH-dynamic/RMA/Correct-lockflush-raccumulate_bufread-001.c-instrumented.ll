; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c"
...
@0 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c\00", align 1
...
25:                                               ; preds = %19
  %26 = load i32, ptr %9, align 4, !dbg !83
  %27 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %26, i32 41, ptr @1), !dbg !85
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @2), !dbg !87
  store ptr %28, ptr %11, align 8, !dbg !87
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !89
  %29 = load ptr, ptr %11, align 8, !dbg !89
  call void @parcoach_rma_load(ptr %9, i64 32, i32 45, ptr @4), !dbg !90
  %30 = load i32, ptr %9, align 4, !dbg !90
  %31 = call i32 @MPI_Raccumulate(ptr noundef %29, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %30, ptr noundef %8), !dbg !91
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @5), !dbg !92
  %32 = load ptr, ptr %11, align 8, !dbg !92
  %33 = getelementptr inbounds i32, ptr %32, i64 0, !dbg !92
  call void @parcoach_rma_load(ptr %33, i64 32, i32 47, ptr @6), !dbg !92
  %34 = load i32, ptr %33, align 4, !dbg !92
  %35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %34), !dbg !93
  call void @parcoach_rma_load(ptr %9, i64 32, i32 48, ptr @7), !dbg !94
  %36 = load i32, ptr %9, align 4, !dbg !94
  %37 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %36, i32 48, ptr @8), !dbg !95
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !96
  br label %39, !dbg !97

39:                                               ; preds = %25, %19
  %40 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @9), !dbg !98
  %41 = call i32 @MPI_Finalize(), !dbg !99
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @10), !dbg !100
  %42 = load i32, ptr %7, align 4, !dbg !100
  %43 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %42), !dbg !101
  ret i32 0, !dbg !102
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "10f19f7fc29d07f05864fe6ac410b759")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-raccumulate_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "10f19f7fc29d07f05864fe6ac410b759")
...
!80 = distinct !DILexicalBlock(scope: !47, file: !2, line: 40, column: 7)
!81 = !DILocation(line: 40, column: 12, scope: !80)
!82 = !DILocation(line: 40, column: 7, scope: !47)
!83 = !DILocation(line: 41, column: 44, scope: !84)
!84 = distinct !DILexicalBlock(scope: !80, file: !2, line: 40, column: 18)
!85 = !DILocation(line: 41, column: 5, scope: !84)
!86 = !DILocalVariable(name: "buf", scope: !84, file: !2, line: 43, type: !24)
!87 = !DILocation(line: 43, column: 10, scope: !84)
!88 = !DILocation(line: 43, column: 23, scope: !84)
!89 = !DILocation(line: 45, column: 21, scope: !84)
!90 = !DILocation(line: 45, column: 67, scope: !84)
!91 = !DILocation(line: 45, column: 5, scope: !84)
!92 = !DILocation(line: 47, column: 27, scope: !84)
!93 = !DILocation(line: 47, column: 5, scope: !84)
!94 = !DILocation(line: 48, column: 23, scope: !84)
!95 = !DILocation(line: 48, column: 5, scope: !84)
!96 = !DILocation(line: 49, column: 5, scope: !84)
!97 = !DILocation(line: 50, column: 3, scope: !84)
!98 = !DILocation(line: 51, column: 3, scope: !47)
!99 = !DILocation(line: 53, column: 3, scope: !47)
!100 = !DILocation(line: 54, column: 41, scope: !47)
!101 = !DILocation(line: 54, column: 3, scope: !47)
!102 = !DILocation(line: 55, column: 3, scope: !47)
