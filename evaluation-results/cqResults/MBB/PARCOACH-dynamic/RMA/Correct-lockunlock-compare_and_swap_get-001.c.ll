; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-compare_and_swap_get-001.c'
...
22:                                               ; preds = %20, %2
  ...
  %25 = call i32 @MPI_Win_create(ptr noundef %24, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %10), !dbg !64
...
28:                                               ; preds = %22
  ...
  %30 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %29), !dbg !71
  ...
  %40 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %39), !dbg !87
  %41 = load i32, ptr %10, align 4, !dbg !88
  %42 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %41), !dbg !89
  %43 = load ptr, ptr %12, align 8, !dbg !90
  %44 = load i32, ptr %10, align 4, !dbg !91
  %45 = call i32 @MPI_Get(ptr noundef %43, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef %44), !dbg !92
  %46 = load i32, ptr %10, align 4, !dbg !93
  %47 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %46), !dbg !94
  br label %48, !dbg !95

48:                                               ; preds = %28, %22
  %49 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !96
