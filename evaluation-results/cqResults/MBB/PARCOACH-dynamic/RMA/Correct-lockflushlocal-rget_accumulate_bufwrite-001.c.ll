; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate_bufwrite-001.c'
...
27:                                               ; preds = %21
  ...
  %41 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %40), !dbg !98
  %42 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !99
  br label %43, !dbg !100

43:                                               ; preds = %27, %21
  %44 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !101
