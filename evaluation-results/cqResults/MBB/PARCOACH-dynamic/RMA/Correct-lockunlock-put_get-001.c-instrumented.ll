; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@1 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@2 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@3 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@4 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@5 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@6 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@7 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@8 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@9 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@10 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@11 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@12 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@13 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
@14 = private unnamed_addr constant [85 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c\00", align 1
...
18:                                               ; preds = %16, %2
  ...
  br i1 %23, label %24, label %40, !dbg !64

24:                                               ; preds = %18
  %25 = load i32, ptr %8, align 4, !dbg !65
  %26 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %25, i32 40, ptr @1), !dbg !67
  ...
  call void @parcoach_rma_store(ptr %10, i64 64, i32 42, ptr @2), !dbg !69
  store ptr %27, ptr %10, align 8, !dbg !69
  call void @parcoach_rma_load(ptr %10, i64 64, i32 44, ptr @3), !dbg !71
  %28 = load ptr, ptr %10, align 8, !dbg !71
  call void @parcoach_rma_load(ptr %8, i64 32, i32 44, ptr @4), !dbg !72
  %29 = load i32, ptr %8, align 4, !dbg !72
  %30 = call i32 @parcoach_rma_MPI_Put(ptr %28, i32 10, i32 1275069445, i32 1, i64 0, i32 10, i32 1275069445, i32 %29, i32 44, ptr @5), !dbg !73
  %31 = load i32, ptr %8, align 4, !dbg !74
  %32 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %31, i32 45, ptr @6), !dbg !75
  call void @parcoach_rma_load(ptr %8, i64 32, i32 46, ptr @7), !dbg !76
  %33 = load i32, ptr %8, align 4, !dbg !76
  %34 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %33, i32 46, ptr @8), !dbg !77
  call void @parcoach_rma_load(ptr %10, i64 64, i32 47, ptr @9), !dbg !78
  %35 = load ptr, ptr %10, align 8, !dbg !78
  call void @parcoach_rma_load(ptr %8, i64 32, i32 47, ptr @10), !dbg !79
  %36 = load i32, ptr %8, align 4, !dbg !79
  %37 = call i32 @parcoach_rma_MPI_Get(ptr %35, i32 10, i32 1275069445, i32 1, i64 10, i32 10, i32 1275069445, i32 %36, i32 47, ptr @11), !dbg !80
  %38 = load i32, ptr %8, align 4, !dbg !81
  %39 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %38, i32 48, ptr @12), !dbg !82
  br label %40, !dbg !83

40:                                               ; preds = %24, %18
  %41 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 50, ptr @13), !dbg !84
  %42 = call i32 @MPI_Finalize(), !dbg !85
  call void @parcoach_rma_load(ptr %7, i64 32, i32 53, ptr @14), !dbg !86
  %43 = load i32, ptr %7, align 4, !dbg !86
  %44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %43), !dbg !87
  ret i32 0, !dbg !88
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "25657c98de23f8f93f0141cee61585da")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-put_get-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "25657c98de23f8f93f0141cee61585da")
!14 = !{!15, !18, !19, !20}
...
!72 = !DILocation(line: 44, column: 50, scope: !66)
!73 = !DILocation(line: 44, column: 5, scope: !66)
!74 = !DILocation(line: 45, column: 23, scope: !66)
!75 = !DILocation(line: 45, column: 5, scope: !66)
!76 = !DILocation(line: 46, column: 44, scope: !66)
!77 = !DILocation(line: 46, column: 5, scope: !66)
!78 = !DILocation(line: 47, column: 13, scope: !66)
!79 = !DILocation(line: 47, column: 51, scope: !66)
!80 = !DILocation(line: 47, column: 5, scope: !66)
!81 = !DILocation(line: 48, column: 23, scope: !66)
!82 = !DILocation(line: 48, column: 5, scope: !66)
!83 = !DILocation(line: 49, column: 3, scope: !66)
!84 = !DILocation(line: 50, column: 3, scope: !31)
!85 = !DILocation(line: 52, column: 3, scope: !31)
!86 = !DILocation(line: 53, column: 41, scope: !31)
!87 = !DILocation(line: 53, column: 3, scope: !31)
!88 = !DILocation(line: 54, column: 3, scope: !31)
