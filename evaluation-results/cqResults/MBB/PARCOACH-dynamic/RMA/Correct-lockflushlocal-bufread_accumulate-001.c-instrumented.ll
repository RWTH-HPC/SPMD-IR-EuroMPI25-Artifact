; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c"
...
@0 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c\00", align 1
...
24:                                               ; preds = %18
  ...
  %26 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %25, i32 40, ptr @1), !dbg !73
  ...
  call void @parcoach_rma_store(ptr %10, i64 64, i32 42, ptr @2), !dbg !75
  store ptr %27, ptr %10, align 8, !dbg !75
  call void @parcoach_rma_load(ptr %10, i64 64, i32 44, ptr @3), !dbg !77
  %28 = load ptr, ptr %10, align 8, !dbg !77
  %29 = getelementptr inbounds i32, ptr %28, i64 0, !dbg !77
  call void @parcoach_rma_load(ptr %29, i64 32, i32 44, ptr @4), !dbg !77
  %30 = load i32, ptr %29, align 4, !dbg !77
  %31 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %30), !dbg !78
  call void @parcoach_rma_load(ptr %10, i64 64, i32 45, ptr @5), !dbg !79
  %32 = load ptr, ptr %10, align 8, !dbg !79
  call void @parcoach_rma_load(ptr %8, i64 32, i32 45, ptr @6), !dbg !80
  %33 = load i32, ptr %8, align 4, !dbg !80
  %34 = call i32 @parcoach_rma_MPI_Accumulate(ptr %32, i32 10, i32 1275069445, i32 1, i64 10, i32 10, i32 1275069445, i32 1476395011, i32 %33, i32 45, ptr @7), !dbg !81
  %35 = load i32, ptr %8, align 4, !dbg !82
  %36 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %35, i32 46, ptr @8), !dbg !83
  br label %37, !dbg !84

37:                                               ; preds = %24, %18
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 48, ptr @9), !dbg !85
  %39 = call i32 @MPI_Finalize(), !dbg !86
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @10), !dbg !87
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_accumulate-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "bce0aae4971b4a7a5563ebef8a3571c0")
