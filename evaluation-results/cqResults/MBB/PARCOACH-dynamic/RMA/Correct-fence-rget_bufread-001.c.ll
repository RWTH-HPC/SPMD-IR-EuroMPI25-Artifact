; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-rget_bufread-001.c'
...
19:                                               ; preds = %17, %2
  ...
  %24 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %23), !dbg !93
...
27:                                               ; preds = %19
  ...
  %33 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %32), !dbg !106
...
41:                                               ; preds = %38
  ...
  %43 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %42), !dbg !116
  br label %44, !dbg !117

44:                                               ; preds = %41, %38
  %45 = load ptr, ptr %9, align 8, !dbg !118
  %46 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %45), !dbg !119
...
51:                                               ; preds = %49, %44
  %52 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !127
