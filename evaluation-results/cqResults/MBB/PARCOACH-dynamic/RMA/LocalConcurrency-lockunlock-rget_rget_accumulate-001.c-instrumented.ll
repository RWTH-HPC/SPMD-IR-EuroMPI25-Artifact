; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c"
...
@0 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c\00", align 1
...
22:                                               ; preds = %20, %2
  ...
  br i1 %27, label %28, label %44, !dbg !97
...
28:                                               ; preds = %22
  ...
  %35 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #4, !dbg !109
  call void @parcoach_rma_store(ptr %14, i64 64, i32 50, ptr @5), !dbg !108
  store ptr %35, ptr %14, align 8, !dbg !108
  call void @parcoach_rma_load(ptr %13, i64 64, i32 53, ptr @6), !dbg !110
  %36 = load ptr, ptr %13, align 8, !dbg !110
  call void @parcoach_rma_load(ptr %14, i64 64, i32 53, ptr @7), !dbg !111
  %37 = load ptr, ptr %14, align 8, !dbg !111
  call void @parcoach_rma_load(ptr %11, i64 64, i32 54, ptr @8), !dbg !112
  %38 = load ptr, ptr %11, align 8, !dbg !112
  %39 = call i32 @MPI_Rget_accumulate(ptr noundef %36, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %37, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %38, ptr noundef %9), !dbg !113
  call void @parcoach_rma_load(ptr %11, i64 64, i32 55, ptr @9), !dbg !114
  %40 = load ptr, ptr %11, align 8, !dbg !114
  %41 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %40, i32 55, ptr @10), !dbg !115
  %42 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !116
  %43 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !117
  br label %44, !dbg !118

44:                                               ; preds = %28, %22
  %45 = call i32 @parcoach_rma_MPI_Win_free(ptr %11, i32 59, ptr @11), !dbg !119
  %46 = call i32 @MPI_Finalize(), !dbg !120
  call void @parcoach_rma_load(ptr %7, i64 32, i32 62, ptr @12), !dbg !121
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "78703d614b3bc56f07796db0b4dbf0fa")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rget_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "78703d614b3bc56f07796db0b4dbf0fa")
...
!104 = !DILocation(line: 47, column: 33, scope: !99)
!105 = !DILocation(line: 47, column: 70, scope: !99)
!106 = !DILocation(line: 47, column: 24, scope: !99)
...
!111 = !DILocation(line: 53, column: 27, scope: !99)
!112 = !DILocation(line: 54, column: 9, scope: !99)
!113 = !DILocation(line: 52, column: 24, scope: !99)
!114 = !DILocation(line: 55, column: 23, scope: !99)
!115 = !DILocation(line: 55, column: 5, scope: !99)
!116 = !DILocation(line: 56, column: 5, scope: !99)
!117 = !DILocation(line: 57, column: 5, scope: !99)
!118 = !DILocation(line: 58, column: 3, scope: !99)
!119 = !DILocation(line: 59, column: 3, scope: !56)
!120 = !DILocation(line: 61, column: 3, scope: !56)
!121 = !DILocation(line: 62, column: 41, scope: !56)
!122 = !DILocation(line: 62, column: 3, scope: !56)
!123 = !DILocation(line: 63, column: 3, scope: !56)
