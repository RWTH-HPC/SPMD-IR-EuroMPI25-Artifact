; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c"
...
@0 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@1 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@2 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@3 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@4 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@5 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@6 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@7 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@8 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@9 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
@10 = private unnamed_addr constant [94 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c\00", align 1
...
25:                                               ; preds = %19
  ...
  call void @parcoach_rma_load(ptr %30, i64 32, i32 45, ptr @4), !dbg !88
  %31 = load i32, ptr %30, align 4, !dbg !88
  %32 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %31), !dbg !89
  call void @parcoach_rma_load(ptr %11, i64 64, i32 46, ptr @5), !dbg !90
  ...
  %35 = call i32 @MPI_Rget(ptr noundef %33, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef %34, ptr noundef %8), !dbg !92
  call void @parcoach_rma_load(ptr %9, i64 32, i32 47, ptr @7), !dbg !93
  %36 = load i32, ptr %9, align 4, !dbg !93
  %37 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %36, i32 47, ptr @8), !dbg !94
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !95
  br label %39, !dbg !96

39:                                               ; preds = %25, %19
  %40 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 50, ptr @9), !dbg !97
  %41 = call i32 @MPI_Finalize(), !dbg !98
  call void @parcoach_rma_load(ptr %7, i64 32, i32 53, ptr @10), !dbg !99
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "14de720724ecd6790b4a7ff84d914296")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "14de720724ecd6790b4a7ff84d914296")
...
!88 = !DILocation(line: 45, column: 27, scope: !83)
!89 = !DILocation(line: 45, column: 5, scope: !83)
!90 = !DILocation(line: 46, column: 14, scope: !83)
!91 = !DILocation(line: 46, column: 52, scope: !83)
!92 = !DILocation(line: 46, column: 5, scope: !83)
!93 = !DILocation(line: 47, column: 23, scope: !83)
!94 = !DILocation(line: 47, column: 5, scope: !83)
!95 = !DILocation(line: 48, column: 5, scope: !83)
!96 = !DILocation(line: 49, column: 3, scope: !83)
!97 = !DILocation(line: 50, column: 3, scope: !46)
!98 = !DILocation(line: 52, column: 3, scope: !46)
!99 = !DILocation(line: 53, column: 41, scope: !46)
!100 = !DILocation(line: 53, column: 3, scope: !46)
!101 = !DILocation(line: 54, column: 3, scope: !46)
