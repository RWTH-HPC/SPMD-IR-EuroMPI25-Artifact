; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_put-001.c'
...
24:                                               ; preds = %18
  ...
  %32 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %31), !dbg !75
  %33 = load i32, ptr %8, align 4, !dbg !76
  %34 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %33), !dbg !77
  %35 = load ptr, ptr %10, align 8, !dbg !78
  %36 = load i32, ptr %8, align 4, !dbg !79
  %37 = call i32 @MPI_Put(ptr noundef %35, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef %36), !dbg !80
  %38 = load i32, ptr %8, align 4, !dbg !81
  %39 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %38), !dbg !82
  br label %40, !dbg !83

40:                                               ; preds = %24, %18
  %41 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !84
