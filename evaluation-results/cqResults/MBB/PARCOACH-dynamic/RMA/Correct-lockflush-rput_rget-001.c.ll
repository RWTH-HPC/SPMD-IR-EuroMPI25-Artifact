; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-rput_rget-001.c'
...
26:                                               ; preds = %20
  ...
  %34 = call i32 @MPI_Win_flush(i32 noundef 1, i32 noundef %33), !dbg !89
  ...
  %39 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %38), !dbg !94
...
42:                                               ; preds = %26, %20
  %43 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !98
