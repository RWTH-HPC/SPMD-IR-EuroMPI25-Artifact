; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c"
...
@0 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c\00", align 1
...
24:                                               ; preds = %18
  ...
  call void @parcoach_rma_load(ptr %8, i64 32, i32 44, ptr @4), !dbg !77
  %29 = load i32, ptr %8, align 4, !dbg !77
  %30 = call i32 @parcoach_rma_MPI_Get(ptr %28, i32 10, i32 1275069445, i32 1, i64 0, i32 10, i32 1275069445, i32 %29, i32 44, ptr @5), !dbg !78
  %31 = load i32, ptr %8, align 4, !dbg !79
  %32 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %31, i32 45, ptr @6), !dbg !80
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @7), !dbg !81
  %33 = load ptr, ptr %10, align 8, !dbg !81
  %34 = getelementptr inbounds i32, ptr %33, i64 0, !dbg !81
  call void @parcoach_rma_load(ptr %34, i64 32, i32 46, ptr @8), !dbg !81
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "4703d8e02360064f548f1fd0be651b54")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "4703d8e02360064f548f1fd0be651b54")
!19 = !{!20, !23, !24, !25}
...
!77 = !DILocation(line: 44, column: 50, scope: !71)
!78 = !DILocation(line: 44, column: 5, scope: !71)
!79 = !DILocation(line: 45, column: 23, scope: !71)
!80 = !DILocation(line: 45, column: 5, scope: !71)
!81 = !DILocation(line: 46, column: 27, scope: !71)
