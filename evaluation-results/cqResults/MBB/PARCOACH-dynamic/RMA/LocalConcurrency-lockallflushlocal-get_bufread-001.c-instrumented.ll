; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
...
26:                                               ; preds = %18
  ...
  call void @parcoach_rma_load(ptr %8, i64 32, i32 45, ptr @5), !dbg !77
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @7), !dbg !79
  %31 = load ptr, ptr %10, align 8, !dbg !79
  %32 = getelementptr inbounds i32, ptr %31, i64 0, !dbg !79
  call void @parcoach_rma_load(ptr %32, i64 32, i32 46, ptr @8), !dbg !79
  %33 = load i32, ptr %32, align 4, !dbg !79
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !80
  br label %35, !dbg !81

35:                                               ; preds = %26, %18
  call void @parcoach_rma_load(ptr %8, i64 32, i32 48, ptr @9), !dbg !82
  %36 = load i32, ptr %8, align 4, !dbg !82
  %37 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %36, i32 48, ptr @10), !dbg !83
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 49, ptr @11), !dbg !84
  %39 = call i32 @MPI_Finalize(), !dbg !85
  call void @parcoach_rma_load(ptr %7, i64 32, i32 52, ptr @12), !dbg !86
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "895773984a923a02d61ebc046fdaa8c9")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "895773984a923a02d61ebc046fdaa8c9")
!19 = !{!20, !23, !24, !25}
...
!76 = !DILocation(line: 44, column: 32, scope: !73)
!77 = !DILocation(line: 45, column: 32, scope: !73)
!78 = !DILocation(line: 44, column: 24, scope: !73)
!79 = !DILocation(line: 46, column: 46, scope: !73)
!80 = !DILocation(line: 46, column: 24, scope: !73)
!81 = !DILocation(line: 47, column: 3, scope: !73)
!82 = !DILocation(line: 48, column: 22, scope: !36)
!83 = !DILocation(line: 48, column: 3, scope: !36)
