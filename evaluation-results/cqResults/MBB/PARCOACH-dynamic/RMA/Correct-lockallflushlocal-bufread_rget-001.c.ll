; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget-001.c'
...
19:                                               ; preds = %17, %2
  ...
  %24 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %23), !dbg !79
...
36:                                               ; preds = %27, %19
  ...
  %38 = call i32 @MPI_Win_unlock_all(i32 noundef %37), !dbg !95
...
43:                                               ; preds = %41, %36
  %44 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !103
