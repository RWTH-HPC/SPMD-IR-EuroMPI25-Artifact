; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-compare_and_swap_rget_accumulate-001.c'
...
31:                                               ; preds = %25
  ...
  %33 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %32), !dbg !86
  ...
  %48 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %47), !dbg !109
  %49 = call i32 @MPI_Wait(ptr noundef %11, ptr noundef inttoptr (i64 1 to ptr)), !dbg !110
  br label %50, !dbg !111

50:                                               ; preds = %31, %25
  %51 = call i32 @MPI_Win_free(ptr noundef %12), !dbg !112
