; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c"
...
@0 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@1 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@2 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@3 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@4 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@5 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@6 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@7 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@8 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@9 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@10 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
@11 = private unnamed_addr constant [94 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c\00", align 1
...
20:                                               ; preds = %18, %2
  ...
  br i1 %27, label %28, label %37, !dbg !97
...
28:                                               ; preds = %20
  ...
  %33 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !105
  call void @parcoach_rma_load(ptr %12, i64 64, i32 48, ptr @6), !dbg !106
  %34 = load ptr, ptr %12, align 8, !dbg !106
  call void @parcoach_rma_load(ptr %10, i64 64, i32 48, ptr @7), !dbg !107
  %35 = load ptr, ptr %10, align 8, !dbg !107
  %36 = call i32 @MPI_Raccumulate(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %35, ptr noundef %9), !dbg !108
  br label %37, !dbg !109

37:                                               ; preds = %28, %20
  call void @parcoach_rma_load(ptr %10, i64 64, i32 51, ptr @8), !dbg !110
  %38 = load ptr, ptr %10, align 8, !dbg !110
  %39 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %38, i32 51, ptr @9), !dbg !111
  call void @parcoach_rma_load(ptr %7, i64 32, i32 52, ptr @10), !dbg !112
  %40 = load i32, ptr %7, align 4, !dbg !112
  %41 = icmp eq i32 %40, 0, !dbg !114
  br i1 %41, label %42, label %45, !dbg !115

42:                                               ; preds = %37
  %43 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !116
  %44 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !118
  br label %45, !dbg !119

45:                                               ; preds = %42, %37
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 56, ptr @11), !dbg !120
  %47 = call i32 @MPI_Finalize(), !dbg !121
  %48 = load i32, ptr %7, align 4, !dbg !122
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !123
  ret i32 0, !dbg !124
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f2fdb826d1912d48c00aaf7a48367a20")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f2fdb826d1912d48c00aaf7a48367a20")
...
!106 = !DILocation(line: 48, column: 21, scope: !99)
!107 = !DILocation(line: 48, column: 67, scope: !99)
!108 = !DILocation(line: 48, column: 5, scope: !99)
!109 = !DILocation(line: 50, column: 3, scope: !99)
!110 = !DILocation(line: 51, column: 22, scope: !56)
!111 = !DILocation(line: 51, column: 3, scope: !56)
!112 = !DILocation(line: 52, column: 7, scope: !113)
!113 = distinct !DILexicalBlock(scope: !56, file: !2, line: 52, column: 7)
!114 = !DILocation(line: 52, column: 12, scope: !113)
!115 = !DILocation(line: 52, column: 7, scope: !56)
!116 = !DILocation(line: 53, column: 5, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 52, column: 18)
!118 = !DILocation(line: 54, column: 5, scope: !117)
!119 = !DILocation(line: 55, column: 3, scope: !117)
!120 = !DILocation(line: 56, column: 3, scope: !56)
!121 = !DILocation(line: 58, column: 3, scope: !56)
!122 = !DILocation(line: 59, column: 41, scope: !56)
