; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_rput-001.c'
...
25:                                               ; preds = %19
  ...
  %27 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %26), !dbg !79
  ...
  %31 = call i32 @MPI_Get(ptr noundef %29, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef %30), !dbg !85
  %32 = load i32, ptr %9, align 4, !dbg !86
  %33 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %32), !dbg !87
  %34 = load i32, ptr %9, align 4, !dbg !88
  %35 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %34), !dbg !89
  ...
  %40 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %39), !dbg !94
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !95
  br label %42, !dbg !96

42:                                               ; preds = %25, %19
  %43 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !97
