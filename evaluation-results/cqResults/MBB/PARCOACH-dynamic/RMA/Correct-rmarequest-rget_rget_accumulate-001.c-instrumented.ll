; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c"
...
@0 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
@13 = private unnamed_addr constant [98 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c\00", align 1
...
22:                                               ; preds = %20, %2
  ...
  br i1 %29, label %30, label %41, !dbg !99
...
30:                                               ; preds = %22
  ...
  %35 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !107
  call void @llvm.dbg.declare(metadata ptr %14, metadata !108, metadata !DIExpression()), !dbg !109
  %36 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #4, !dbg !110
  call void @parcoach_rma_store(ptr %14, i64 64, i32 50, ptr @6), !dbg !109
  store ptr %36, ptr %14, align 8, !dbg !109
  call void @parcoach_rma_load(ptr %13, i64 64, i32 52, ptr @7), !dbg !111
  %37 = load ptr, ptr %13, align 8, !dbg !111
  call void @parcoach_rma_load(ptr %14, i64 64, i32 52, ptr @8), !dbg !112
  %38 = load ptr, ptr %14, align 8, !dbg !112
  call void @parcoach_rma_load(ptr %11, i64 64, i32 53, ptr @9), !dbg !113
  %39 = load ptr, ptr %11, align 8, !dbg !113
  %40 = call i32 @MPI_Rget_accumulate(ptr noundef %37, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %38, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %39, ptr noundef %9), !dbg !114
  br label %41, !dbg !115

41:                                               ; preds = %30, %22
  call void @parcoach_rma_load(ptr %11, i64 64, i32 55, ptr @10), !dbg !116
  %42 = load ptr, ptr %11, align 8, !dbg !116
  %43 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %42, i32 55, ptr @11), !dbg !117
  call void @parcoach_rma_load(ptr %7, i64 32, i32 56, ptr @12), !dbg !118
  %44 = load i32, ptr %7, align 4, !dbg !118
  %45 = icmp eq i32 %44, 0, !dbg !120
  br i1 %45, label %46, label %49, !dbg !121

46:                                               ; preds = %41
  %47 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !122
  %48 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !124
  br label %49, !dbg !125

49:                                               ; preds = %46, %41
  %50 = call i32 @parcoach_rma_MPI_Win_free(ptr %11, i32 60, ptr @13), !dbg !126
  %51 = call i32 @MPI_Finalize(), !dbg !127
  %52 = load i32, ptr %7, align 4, !dbg !128
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %52), !dbg !129
  ret i32 0, !dbg !130
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "245e00e548ca9129181f3b064b05c440")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "245e00e548ca9129181f3b064b05c440")
...
!107 = !DILocation(line: 48, column: 5, scope: !101)
!108 = !DILocalVariable(name: "int_0", scope: !101, file: !2, line: 50, type: !23)
!109 = !DILocation(line: 50, column: 10, scope: !101)
!110 = !DILocation(line: 50, column: 25, scope: !101)
!111 = !DILocation(line: 52, column: 25, scope: !101)
!112 = !DILocation(line: 52, column: 43, scope: !101)
!113 = !DILocation(line: 53, column: 34, scope: !101)
!114 = !DILocation(line: 52, column: 5, scope: !101)
!115 = !DILocation(line: 54, column: 3, scope: !101)
!116 = !DILocation(line: 55, column: 22, scope: !56)
!117 = !DILocation(line: 55, column: 3, scope: !56)
!118 = !DILocation(line: 56, column: 7, scope: !119)
!119 = distinct !DILexicalBlock(scope: !56, file: !2, line: 56, column: 7)
!120 = !DILocation(line: 56, column: 12, scope: !119)
!121 = !DILocation(line: 56, column: 7, scope: !56)
!122 = !DILocation(line: 57, column: 5, scope: !123)
!123 = distinct !DILexicalBlock(scope: !119, file: !2, line: 56, column: 18)
!124 = !DILocation(line: 58, column: 5, scope: !123)
!125 = !DILocation(line: 59, column: 3, scope: !123)
!126 = !DILocation(line: 60, column: 3, scope: !56)
!127 = !DILocation(line: 62, column: 3, scope: !56)
!128 = !DILocation(line: 63, column: 41, scope: !56)
!129 = !DILocation(line: 63, column: 3, scope: !56)
!130 = !DILocation(line: 64, column: 3, scope: !56)
