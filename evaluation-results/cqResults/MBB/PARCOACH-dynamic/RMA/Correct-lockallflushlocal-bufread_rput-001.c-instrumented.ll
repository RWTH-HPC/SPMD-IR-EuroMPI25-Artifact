; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c"
...
@0 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@1 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@2 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@3 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@4 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@5 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@6 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@7 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@8 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@9 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@10 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
@11 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c\00", align 1
...
27:                                               ; preds = %19
  ...
  %30 = getelementptr inbounds i32, ptr %29, i64 0, !dbg !88
  call void @parcoach_rma_load(ptr %30, i64 32, i32 45, ptr @5), !dbg !88
  %31 = load i32, ptr %30, align 4, !dbg !88
  %32 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %31), !dbg !89
  call void @parcoach_rma_load(ptr %11, i64 64, i32 46, ptr @6), !dbg !90
  %33 = load ptr, ptr %11, align 8, !dbg !90
  call void @parcoach_rma_load(ptr %9, i64 32, i32 46, ptr @7), !dbg !91
  %34 = load i32, ptr %9, align 4, !dbg !91
  %35 = call i32 @MPI_Rput(ptr noundef %33, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef %34, ptr noundef %8), !dbg !92
  br label %36, !dbg !93

36:                                               ; preds = %27, %19
  call void @parcoach_rma_load(ptr %9, i64 32, i32 48, ptr @8), !dbg !94
  %37 = load i32, ptr %9, align 4, !dbg !94
  %38 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %37, i32 48, ptr @9), !dbg !95
  call void @parcoach_rma_load(ptr %7, i64 32, i32 49, ptr @10), !dbg !96
  %39 = load i32, ptr %7, align 4, !dbg !96
  %40 = icmp eq i32 %39, 0, !dbg !98
  br i1 %40, label %41, label %43, !dbg !99
...
43:                                               ; preds = %41, %36
  %44 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 52, ptr @11), !dbg !103
  %45 = call i32 @MPI_Finalize(), !dbg !104
  %46 = load i32, ptr %7, align 4, !dbg !105
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %46), !dbg !106
  ret i32 0, !dbg !107
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "b22759c783555f4f08c0a335956a765e")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rput-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "b22759c783555f4f08c0a335956a765e")
...
!78 = !DILocation(line: 40, column: 23, scope: !46)
...
!91 = !DILocation(line: 46, column: 51, scope: !85)
!92 = !DILocation(line: 46, column: 5, scope: !85)
!93 = !DILocation(line: 47, column: 3, scope: !85)
!94 = !DILocation(line: 48, column: 22, scope: !46)
!95 = !DILocation(line: 48, column: 3, scope: !46)
...
!102 = !DILocation(line: 51, column: 3, scope: !101)
!103 = !DILocation(line: 52, column: 3, scope: !46)
!104 = !DILocation(line: 54, column: 3, scope: !46)
!105 = !DILocation(line: 55, column: 41, scope: !46)
!106 = !DILocation(line: 55, column: 3, scope: !46)
!107 = !DILocation(line: 56, column: 3, scope: !46)
