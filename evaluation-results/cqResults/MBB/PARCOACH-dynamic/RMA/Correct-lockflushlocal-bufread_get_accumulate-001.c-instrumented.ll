; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c"
...
@0 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
...
26:                                               ; preds = %20
  ...
  %28 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %27, i32 41, ptr @1), !dbg !75
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @2), !dbg !77
  store ptr %29, ptr %11, align 8, !dbg !77
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !79
  %30 = load ptr, ptr %11, align 8, !dbg !79
  %31 = getelementptr inbounds i32, ptr %30, i64 0, !dbg !79
  call void @parcoach_rma_load(ptr %31, i64 32, i32 45, ptr @4), !dbg !79
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 47, ptr @5), !dbg !82
  store ptr %34, ptr %12, align 8, !dbg !82
  call void @parcoach_rma_load(ptr %11, i64 64, i32 49, ptr @6), !dbg !84
  %35 = load ptr, ptr %11, align 8, !dbg !84
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @7), !dbg !85
  %36 = load ptr, ptr %12, align 8, !dbg !85
  call void @parcoach_rma_load(ptr %9, i64 32, i32 50, ptr @8), !dbg !86
  %37 = load i32, ptr %9, align 4, !dbg !86
  %38 = call i32 @MPI_Get_accumulate(ptr noundef %35, i32 noundef 10, i32 noundef 1275069445, ptr noundef %36, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %37), !dbg !87
  call void @parcoach_rma_load(ptr %9, i64 32, i32 51, ptr @9), !dbg !88
  %39 = load i32, ptr %9, align 4, !dbg !88
  %40 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %39, i32 51, ptr @10), !dbg !89
  br label %41, !dbg !90

41:                                               ; preds = %26, %20
  %42 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !91
  %43 = call i32 @MPI_Finalize(), !dbg !92
  call void @parcoach_rma_load(ptr %7, i64 32, i32 56, ptr @12), !dbg !93
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "90467f4e46a39d95e9517c5837360c87")
...
!79 = !DILocation(line: 45, column: 27, scope: !74)
!80 = !DILocation(line: 45, column: 5, scope: !74)
!81 = !DILocalVariable(name: "int_0", scope: !74, file: !2, line: 47, type: !23)
!82 = !DILocation(line: 47, column: 10, scope: !74)
!83 = !DILocation(line: 47, column: 25, scope: !74)
!84 = !DILocation(line: 49, column: 24, scope: !74)
!85 = !DILocation(line: 49, column: 42, scope: !74)
!86 = !DILocation(line: 50, column: 33, scope: !74)
!87 = !DILocation(line: 49, column: 5, scope: !74)
!88 = !DILocation(line: 51, column: 23, scope: !74)
!89 = !DILocation(line: 51, column: 5, scope: !74)
!90 = !DILocation(line: 52, column: 3, scope: !74)
