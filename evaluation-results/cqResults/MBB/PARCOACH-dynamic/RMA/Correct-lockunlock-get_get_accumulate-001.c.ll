; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_get_accumulate-001.c'
...
26:                                               ; preds = %20
  ...
  %28 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %27), !dbg !70
  ...
  %32 = call i32 @MPI_Get(ptr noundef %30, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef %31), !dbg !76
  %33 = load i32, ptr %9, align 4, !dbg !77
  %34 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %33), !dbg !78
  %35 = load i32, ptr %9, align 4, !dbg !79
  %36 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %35), !dbg !80
  ...
  %43 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %42), !dbg !89
  br label %44, !dbg !90

44:                                               ; preds = %26, %20
  %45 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !91
