; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c"
...
@0 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c\00", align 1
...
26:                                               ; preds = %18
  ...
  call void @parcoach_rma_store(ptr %29, i64 32, i32 44, ptr @5), !dbg !84
  store i32 42, ptr %29, align 4, !dbg !84
  call void @parcoach_rma_load(ptr %10, i64 64, i32 45, ptr @6), !dbg !85
  ...
  %32 = call i32 @parcoach_rma_MPI_Accumulate(ptr %30, i32 10, ptr @ompi_mpi_int, i32 0, i64 0, i32 10, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %31, i32 45, ptr @8), !dbg !87
  br label %33, !dbg !88

33:                                               ; preds = %26, %18
  call void @parcoach_rma_load(ptr %8, i64 64, i32 47, ptr @9), !dbg !89
  %34 = load ptr, ptr %8, align 8, !dbg !89
  %35 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %34, i32 47, ptr @10), !dbg !90
  %36 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 48, ptr @11), !dbg !91
  %37 = call i32 @MPI_Finalize(), !dbg !92
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @12), !dbg !93
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d54a6fd1c2f29d62bc98f452e16eeeb7")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufwrite_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d54a6fd1c2f29d62bc98f452e16eeeb7")
...
!83 = !DILocation(line: 44, column: 5, scope: !80)
!84 = !DILocation(line: 44, column: 12, scope: !80)
!85 = !DILocation(line: 45, column: 20, scope: !80)
!86 = !DILocation(line: 45, column: 66, scope: !80)
!87 = !DILocation(line: 45, column: 5, scope: !80)
!88 = !DILocation(line: 46, column: 3, scope: !80)
!89 = !DILocation(line: 47, column: 22, scope: !41)
!90 = !DILocation(line: 47, column: 3, scope: !41)
