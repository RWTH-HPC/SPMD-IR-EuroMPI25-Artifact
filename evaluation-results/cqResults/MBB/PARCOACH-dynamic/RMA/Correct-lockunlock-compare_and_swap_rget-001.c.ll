; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-compare_and_swap_rget-001.c'
...
29:                                               ; preds = %23
  ...
  %31 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %30), !dbg !83
  ...
  %41 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %40), !dbg !99
  %42 = load i32, ptr %11, align 4, !dbg !100
  %43 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %42), !dbg !101
  ...
  %48 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %47), !dbg !106
  %49 = call i32 @MPI_Wait(ptr noundef %10, ptr noundef inttoptr (i64 1 to ptr)), !dbg !107
  br label %50, !dbg !108

50:                                               ; preds = %29, %23
  %51 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !109
