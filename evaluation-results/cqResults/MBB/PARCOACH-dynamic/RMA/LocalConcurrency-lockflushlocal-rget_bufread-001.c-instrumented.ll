; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %24, label %25, label %39, !dbg !81

25:                                               ; preds = %19
  %26 = load i32, ptr %9, align 4, !dbg !82
  %27 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %26, i32 41, ptr @1), !dbg !84
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @2), !dbg !86
  store ptr %28, ptr %11, align 8, !dbg !86
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !88
  %29 = load ptr, ptr %11, align 8, !dbg !88
  call void @parcoach_rma_load(ptr %9, i64 32, i32 45, ptr @4), !dbg !89
  ...
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @5), !dbg !91
  %32 = load ptr, ptr %11, align 8, !dbg !91
  %33 = getelementptr inbounds i32, ptr %32, i64 0, !dbg !91
  call void @parcoach_rma_load(ptr %33, i64 32, i32 47, ptr @6), !dbg !91
  %34 = load i32, ptr %33, align 4, !dbg !91
  %35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %34), !dbg !92
  call void @parcoach_rma_load(ptr %9, i64 32, i32 48, ptr @7), !dbg !93
  %36 = load i32, ptr %9, align 4, !dbg !93
  %37 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %36, i32 48, ptr @8), !dbg !94
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !95
  br label %39, !dbg !96

39:                                               ; preds = %25, %19
  %40 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @9), !dbg !97
  %41 = call i32 @MPI_Finalize(), !dbg !98
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @10), !dbg !99
  %42 = load i32, ptr %7, align 4, !dbg !99
  %43 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %42), !dbg !100
  ret i32 0, !dbg !101
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5875453eeee316543871f068238e87c4")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5875453eeee316543871f068238e87c4")
...
!88 = !DILocation(line: 45, column: 33, scope: !83)
!89 = !DILocation(line: 45, column: 70, scope: !83)
!90 = !DILocation(line: 45, column: 24, scope: !83)
!91 = !DILocation(line: 47, column: 46, scope: !83)
!92 = !DILocation(line: 47, column: 24, scope: !83)
!93 = !DILocation(line: 48, column: 23, scope: !83)
!94 = !DILocation(line: 48, column: 5, scope: !83)
!95 = !DILocation(line: 49, column: 5, scope: !83)
!96 = !DILocation(line: 50, column: 3, scope: !83)
!97 = !DILocation(line: 51, column: 3, scope: !46)
!98 = !DILocation(line: 53, column: 3, scope: !46)
!99 = !DILocation(line: 54, column: 41, scope: !46)
!100 = !DILocation(line: 54, column: 3, scope: !46)
!101 = !DILocation(line: 55, column: 3, scope: !46)
