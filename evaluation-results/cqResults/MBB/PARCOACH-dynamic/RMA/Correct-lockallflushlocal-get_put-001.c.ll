; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c'
...
18:                                               ; preds = %16, %2
  ...
  %23 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %22), !dbg !62
...
36:                                               ; preds = %26, %18
  ...
  %38 = call i32 @MPI_Win_unlock_all(i32 noundef %37), !dbg !81
  %39 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !82
