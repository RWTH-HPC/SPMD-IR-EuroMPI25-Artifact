; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockflushlocal-rget_accumulate-001.c'
...
25:                                               ; preds = %19
  ...
  %36 = call i32 @MPI_Accumulate(ptr noundef %34, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 10, i32 noundef 10, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %35), !dbg !91
  %37 = load i32, ptr %9, align 4, !dbg !92
  %38 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %37), !dbg !93
  %39 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !94
  br label %40, !dbg !95

40:                                               ; preds = %25, %19
  %41 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !96
