; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-accumulate_rget-001.c'
...
25:                                               ; preds = %19
  ...
  %27 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %26), !dbg !96
  ...
  %33 = call i32 @MPI_Win_flush(i32 noundef 1, ptr noundef %32), !dbg !104
  ...
  %38 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %37), !dbg !109
  %39 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !110
  br label %40, !dbg !111

40:                                               ; preds = %25, %19
  %41 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !112
