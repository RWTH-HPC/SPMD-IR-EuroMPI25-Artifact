; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %24, label %25, label %42, !dbg !77

25:                                               ; preds = %19
  %26 = load i32, ptr %9, align 4, !dbg !78
  %27 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %26, i32 41, ptr @1), !dbg !80
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @2), !dbg !82
  store ptr %28, ptr %11, align 8, !dbg !82
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !84
  %29 = load ptr, ptr %11, align 8, !dbg !84
  call void @parcoach_rma_load(ptr %9, i64 32, i32 45, ptr @4), !dbg !85
  ...
  call void @parcoach_rma_load(ptr %9, i64 32, i32 46, ptr @5), !dbg !87
  %32 = load i32, ptr %9, align 4, !dbg !87
  %33 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %32, i32 46, ptr @6), !dbg !88
  call void @parcoach_rma_load(ptr %9, i64 32, i32 47, ptr @7), !dbg !89
  %34 = load i32, ptr %9, align 4, !dbg !89
  %35 = call i32 @parcoach_rma_MPI_Win_lock(i32 234, i32 1, i32 0, i32 %34, i32 47, ptr @8), !dbg !90
  call void @parcoach_rma_load(ptr %11, i64 64, i32 48, ptr @9), !dbg !91
  %36 = load ptr, ptr %11, align 8, !dbg !91
  call void @parcoach_rma_load(ptr %9, i64 32, i32 48, ptr @10), !dbg !92
  %37 = load i32, ptr %9, align 4, !dbg !92
  %38 = call i32 @parcoach_rma_MPI_Accumulate(ptr %36, i32 10, i32 1275069445, i32 1, i64 10, i32 10, i32 1275069445, i32 1476395011, i32 %37, i32 48, ptr @11), !dbg !93
  %39 = load i32, ptr %9, align 4, !dbg !94
  %40 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %39, i32 49, ptr @12), !dbg !95
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !96
  br label %42, !dbg !97

42:                                               ; preds = %25, %19
  %43 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 52, ptr @13), !dbg !98
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "496bcd6fd2bc2fec3130022b3c15308e")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "496bcd6fd2bc2fec3130022b3c15308e")
...
!84 = !DILocation(line: 45, column: 14, scope: !79)
!85 = !DILocation(line: 45, column: 51, scope: !79)
!86 = !DILocation(line: 45, column: 5, scope: !79)
!87 = !DILocation(line: 46, column: 23, scope: !79)
!88 = !DILocation(line: 46, column: 5, scope: !79)
!89 = !DILocation(line: 47, column: 44, scope: !79)
!90 = !DILocation(line: 47, column: 5, scope: !79)
!91 = !DILocation(line: 48, column: 20, scope: !79)
!92 = !DILocation(line: 48, column: 67, scope: !79)
!93 = !DILocation(line: 48, column: 5, scope: !79)
!94 = !DILocation(line: 49, column: 23, scope: !79)
!95 = !DILocation(line: 49, column: 5, scope: !79)
!96 = !DILocation(line: 50, column: 5, scope: !79)
!97 = !DILocation(line: 51, column: 3, scope: !79)
!98 = !DILocation(line: 52, column: 3, scope: !42)
!99 = !DILocation(line: 54, column: 3, scope: !42)
!100 = !DILocation(line: 55, column: 41, scope: !42)
