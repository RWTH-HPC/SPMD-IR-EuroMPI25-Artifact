; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_get_accumulate-001.c'
...
24:                                               ; preds = %22, %2
  ...
  %27 = call i32 @MPI_Win_create(ptr noundef %26, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %11), !dbg !67
  %28 = load i32, ptr %11, align 4, !dbg !68
  %29 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %28), !dbg !69
...
46:                                               ; preds = %32, %24
  ...
  %48 = call i32 @MPI_Win_unlock_all(i32 noundef %47), !dbg !98
  %49 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !99
