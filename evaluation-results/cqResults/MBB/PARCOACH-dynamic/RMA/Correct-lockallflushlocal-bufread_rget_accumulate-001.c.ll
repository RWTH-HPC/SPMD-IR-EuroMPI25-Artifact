; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_rget_accumulate-001.c'
...
21:                                               ; preds = %19, %2
  ...
  %26 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %25), !dbg !98
...
40:                                               ; preds = %29, %21
  ...
  %42 = call i32 @MPI_Win_unlock_all(ptr noundef %41), !dbg !118
...
47:                                               ; preds = %45, %40
  %48 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !126
