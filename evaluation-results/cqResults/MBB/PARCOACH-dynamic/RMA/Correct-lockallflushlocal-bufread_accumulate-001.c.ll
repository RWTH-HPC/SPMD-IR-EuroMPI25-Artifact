; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_accumulate-001.c'
...
18:                                               ; preds = %16, %2
  ...
  %23 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %22), !dbg !79
...
26:                                               ; preds = %18
  ...
  %34 = call i32 @MPI_Accumulate(ptr noundef %32, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %33), !dbg !92
  br label %35, !dbg !93

35:                                               ; preds = %26, %18
  %36 = load ptr, ptr %8, align 8, !dbg !94
  %37 = call i32 @MPI_Win_unlock_all(ptr noundef %36), !dbg !95
