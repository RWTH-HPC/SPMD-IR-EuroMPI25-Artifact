; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-bufread_compare_and_swap-001.c'
...
22:                                               ; preds = %20, %2
  ...
  %25 = call i32 @MPI_Win_create(ptr noundef %24, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %10), !dbg !69
  %26 = load i32, ptr %10, align 4, !dbg !70
  %27 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %26), !dbg !71
...
43:                                               ; preds = %30, %22
  ...
  %45 = call i32 @MPI_Win_unlock_all(i32 noundef %44), !dbg !95
  %46 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !96
