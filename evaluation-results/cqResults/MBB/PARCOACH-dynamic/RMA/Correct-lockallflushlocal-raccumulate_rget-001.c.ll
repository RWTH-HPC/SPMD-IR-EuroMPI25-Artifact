; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-raccumulate_rget-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %25 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %24), !dbg !77
...
38:                                               ; preds = %28, %20
  ...
  %40 = call i32 @MPI_Win_unlock_all(i32 noundef %39), !dbg !96
...
46:                                               ; preds = %43, %38
  %47 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !105
