; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [67 x i8] c"MBB ERROR: This test needs at least 2 processes to produce a bug!\0A\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [27 x i8] c"Rank %d finished normally\0A\00", align 1, !dbg !7
@0 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
...
28:                                               ; preds = %20
  ...
  %33 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !88
  call void @parcoach_rma_load(ptr %12, i64 64, i32 48, ptr @6), !dbg !89
  %34 = load ptr, ptr %12, align 8, !dbg !89
  call void @parcoach_rma_load(ptr %10, i64 32, i32 48, ptr @7), !dbg !90
  %35 = load i32, ptr %10, align 4, !dbg !90
  %36 = call i32 @MPI_Rget(ptr noundef %34, i32 noundef 10, i32 noundef 1275069445, i32 noundef 0, i64 noundef 0, i32 noundef 10, i32 noundef 1275069445, i32 noundef %35, ptr noundef %9), !dbg !91
  br label %37, !dbg !92

37:                                               ; preds = %28, %20
  call void @parcoach_rma_load(ptr %10, i64 32, i32 50, ptr @8), !dbg !93
  %38 = load i32, ptr %10, align 4, !dbg !93
  %39 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %38, i32 50, ptr @9), !dbg !94
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @10), !dbg !95
  %40 = load i32, ptr %7, align 4, !dbg !95
  %41 = icmp eq i32 %40, 0, !dbg !97
  br i1 %41, label %42, label %45, !dbg !98

42:                                               ; preds = %37
  %43 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !99
  %44 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef inttoptr (i64 1 to ptr)), !dbg !101
  br label %45, !dbg !102

45:                                               ; preds = %42, %37
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 55, ptr @11), !dbg !103
  %47 = call i32 @MPI_Finalize(), !dbg !104
  %48 = load i32, ptr %7, align 4, !dbg !105
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !106
  ret i32 0, !dbg !107
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2766954f75ccd83bfecf92bd2bee84a9")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2766954f75ccd83bfecf92bd2bee84a9")
...
!88 = !DILocation(line: 47, column: 5, scope: !82)
!89 = !DILocation(line: 48, column: 14, scope: !82)
!90 = !DILocation(line: 48, column: 51, scope: !82)
!91 = !DILocation(line: 48, column: 5, scope: !82)
!92 = !DILocation(line: 49, column: 3, scope: !82)
!93 = !DILocation(line: 50, column: 22, scope: !41)
!94 = !DILocation(line: 50, column: 3, scope: !41)
!95 = !DILocation(line: 51, column: 7, scope: !96)
!96 = distinct !DILexicalBlock(scope: !41, file: !2, line: 51, column: 7)
!97 = !DILocation(line: 51, column: 12, scope: !96)
!98 = !DILocation(line: 51, column: 7, scope: !41)
...
!105 = !DILocation(line: 58, column: 41, scope: !41)
