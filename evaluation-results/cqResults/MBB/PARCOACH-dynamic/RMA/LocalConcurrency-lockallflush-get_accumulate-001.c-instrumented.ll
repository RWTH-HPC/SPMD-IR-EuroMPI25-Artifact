; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
@13 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c\00", align 1
...
18:                                               ; preds = %16, %2
  ...
  br i1 %25, label %26, label %34, !dbg !78
...
26:                                               ; preds = %18
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 45, ptr @5), !dbg !84
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @7), !dbg !86
  %31 = load ptr, ptr %10, align 8, !dbg !86
  call void @parcoach_rma_load(ptr %8, i64 64, i32 47, ptr @8), !dbg !87
  %32 = load ptr, ptr %8, align 8, !dbg !87
  %33 = call i32 @parcoach_rma_MPI_Accumulate(ptr %31, i32 10, ptr @ompi_mpi_int, i32 0, i64 0, i32 10, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %32, i32 46, ptr @9), !dbg !88
  br label %34, !dbg !89

34:                                               ; preds = %26, %18
  call void @parcoach_rma_load(ptr %8, i64 64, i32 49, ptr @10), !dbg !90
  %35 = load ptr, ptr %8, align 8, !dbg !90
  %36 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %35, i32 49, ptr @11), !dbg !91
  %37 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 50, ptr @12), !dbg !92
  %38 = call i32 @MPI_Finalize(), !dbg !93
  call void @parcoach_rma_load(ptr %7, i64 32, i32 53, ptr @13), !dbg !94
  %39 = load i32, ptr %7, align 4, !dbg !94
  %40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %39), !dbg !95
  ret i32 0, !dbg !96
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "756d59315035d1e07dce40430e3f8d45")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflush-get_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "756d59315035d1e07dce40430e3f8d45")
...
!83 = !DILocation(line: 44, column: 32, scope: !80)
!84 = !DILocation(line: 45, column: 32, scope: !80)
!85 = !DILocation(line: 44, column: 24, scope: !80)
!86 = !DILocation(line: 46, column: 39, scope: !80)
!87 = !DILocation(line: 47, column: 48, scope: !80)
!88 = !DILocation(line: 46, column: 24, scope: !80)
!89 = !DILocation(line: 48, column: 3, scope: !80)
!90 = !DILocation(line: 49, column: 22, scope: !41)
!91 = !DILocation(line: 49, column: 3, scope: !41)
