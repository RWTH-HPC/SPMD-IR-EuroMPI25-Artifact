; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rget_accumulate_rget-001.c'
...
28:                                               ; preds = %22
  ...
  %30 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %29), !dbg !84
  ...
  %38 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %37), !dbg !96
  %39 = load i32, ptr %11, align 4, !dbg !97
  %40 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %39), !dbg !98
  ...
  %45 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %44), !dbg !103
...
48:                                               ; preds = %28, %22
  %49 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !107
