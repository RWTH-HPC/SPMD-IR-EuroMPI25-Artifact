; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-fence-compare_and_swap_bufwrite-001.c'
...
46:                                               ; preds = %43
  ...
  %48 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %47), !dbg !97
  br label %49, !dbg !98

49:                                               ; preds = %46, %43
  %50 = load i32, ptr %10, align 4, !dbg !99
  %51 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %50), !dbg !100
  %52 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !101
