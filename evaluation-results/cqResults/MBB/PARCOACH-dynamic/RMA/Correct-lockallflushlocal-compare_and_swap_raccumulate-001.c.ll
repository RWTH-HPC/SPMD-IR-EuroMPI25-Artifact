; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_raccumulate-001.c'
...
23:                                               ; preds = %21, %2
  ...
  %26 = call i32 @MPI_Win_create(ptr noundef %25, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %11), !dbg !77
  %27 = load i32, ptr %11, align 4, !dbg !78
  %28 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %27), !dbg !79
...
43:                                               ; preds = %31, %23
  ...
  %45 = call i32 @MPI_Win_unlock_all(i32 noundef %44), !dbg !104
...
50:                                               ; preds = %48, %43
  %51 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !112
