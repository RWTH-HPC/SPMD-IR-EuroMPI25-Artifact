; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_accumulate_rget_accumulate-001.c'
...
29:                                               ; preds = %23
  ...
  %31 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %30), !dbg !84
  ...
  %44 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %43), !dbg !103
  %45 = call i32 @MPI_Wait(ptr noundef %10, ptr noundef inttoptr (i64 1 to ptr)), !dbg !104
  br label %46, !dbg !105

46:                                               ; preds = %29, %23
  %47 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !106
