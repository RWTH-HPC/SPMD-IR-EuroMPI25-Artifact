; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_accumulate_raccumulate-001.c'
...
27:                                               ; preds = %21
  ...
  %40 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %39), !dbg !97
  %41 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef inttoptr (i64 1 to ptr)), !dbg !98
  br label %42, !dbg !99

42:                                               ; preds = %27, %21
  %43 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !100
