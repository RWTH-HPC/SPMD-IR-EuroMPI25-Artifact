; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-raccumulate_rget-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %23 = call i32 @MPI_Win_create(ptr noundef %22, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %10), !dbg !75
...
26:                                               ; preds = %20
  ...
  %28 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %27), !dbg !82
  ...
  %34 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %33), !dbg !90
  %35 = load i32, ptr %10, align 4, !dbg !91
  %36 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %35), !dbg !92
  ...
  %41 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %40), !dbg !97
...
44:                                               ; preds = %26, %20
  %45 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !101
