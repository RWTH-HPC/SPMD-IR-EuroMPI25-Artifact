; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-get_accumulate_rget-001.c'
...
27:                                               ; preds = %21
  ...
  %29 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %28), !dbg !82
  ...
  %37 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %36), !dbg !94
  %38 = load i32, ptr %10, align 4, !dbg !95
  %39 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %38), !dbg !96
  ...
  %44 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %43), !dbg !101
  %45 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef inttoptr (i64 1 to ptr)), !dbg !102
  br label %46, !dbg !103

46:                                               ; preds = %27, %21
  %47 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !104
