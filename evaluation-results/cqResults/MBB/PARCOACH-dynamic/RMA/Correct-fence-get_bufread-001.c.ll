; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c'
...
18:                                               ; preds = %16, %2
  ...
  %23 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %22), !dbg !67
...
26:                                               ; preds = %18
  ...
  %32 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %31), !dbg !80
...
40:                                               ; preds = %37
  ...
  %42 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %41), !dbg !90
  br label %43, !dbg !91

43:                                               ; preds = %40, %37
  %44 = load i32, ptr %8, align 4, !dbg !92
  %45 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %44), !dbg !93
  %46 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !94
