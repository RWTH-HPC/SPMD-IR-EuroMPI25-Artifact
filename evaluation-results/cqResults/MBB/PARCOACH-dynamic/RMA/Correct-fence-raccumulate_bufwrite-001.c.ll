; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-fence-raccumulate_bufwrite-001.c'
...
39:                                               ; preds = %36
  ...
  %41 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %40), !dbg !98
  br label %42, !dbg !99

42:                                               ; preds = %39, %36
  %43 = load i32, ptr %9, align 4, !dbg !100
  %44 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %43), !dbg !101
...
49:                                               ; preds = %47, %42
  %50 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !109
