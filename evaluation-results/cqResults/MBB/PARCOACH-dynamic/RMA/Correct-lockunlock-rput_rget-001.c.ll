; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockunlock-rput_rget-001.c'
...
26:                                               ; preds = %20
  ...
  %28 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %27), !dbg !81
  ...
  %34 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %33), !dbg !89
  %35 = load i32, ptr %10, align 4, !dbg !90
  %36 = call i32 @MPI_Win_lock(i32 noundef 234, i32 noundef 1, i32 noundef 0, i32 noundef %35), !dbg !91
  ...
  %41 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %40), !dbg !96
...
44:                                               ; preds = %26, %20
  %45 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !100
