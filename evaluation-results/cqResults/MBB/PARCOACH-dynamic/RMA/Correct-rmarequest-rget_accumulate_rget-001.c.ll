; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_accumulate_rget-001.c'
...
22:                                               ; preds = %20, %2
  ...
  %27 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %26), !dbg !79
...
41:                                               ; preds = %30, %22
  ...
  %43 = call i32 @MPI_Win_unlock_all(i32 noundef %42), !dbg !101
...
49:                                               ; preds = %46, %41
  %50 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !110
