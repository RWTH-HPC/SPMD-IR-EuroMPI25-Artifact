; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-put_rget-001.c'
...
25:                                               ; preds = %19
  ...
  %36 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %35), !dbg !90
  %37 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef inttoptr (i64 1 to ptr)), !dbg !91
  br label %38, !dbg !92

38:                                               ; preds = %25, %19
  %39 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !93
