; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c"
...
@0 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [106 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c\00", align 1
...
27:                                               ; preds = %19
  ...
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @6), !dbg !91
  %32 = load ptr, ptr %11, align 8, !dbg !91
  %33 = getelementptr inbounds i32, ptr %32, i64 0, !dbg !91
  call void @parcoach_rma_load(ptr %33, i64 32, i32 47, ptr @7), !dbg !91
  %34 = load i32, ptr %33, align 4, !dbg !91
  %35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %34), !dbg !92
  br label %36, !dbg !93

36:                                               ; preds = %27, %19
  call void @parcoach_rma_load(ptr %9, i64 32, i32 49, ptr @8), !dbg !94
  %37 = load i32, ptr %9, align 4, !dbg !94
  %38 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %37, i32 49, ptr @9), !dbg !95
  call void @parcoach_rma_load(ptr %7, i64 32, i32 50, ptr @10), !dbg !96
...
43:                                               ; preds = %41, %36
  %44 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !103
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "81a4b0a2046526852ebbfe9c52346052")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-rget_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "81a4b0a2046526852ebbfe9c52346052")
...
!88 = !DILocation(line: 45, column: 33, scope: !85)
!89 = !DILocation(line: 45, column: 70, scope: !85)
!90 = !DILocation(line: 45, column: 24, scope: !85)
!91 = !DILocation(line: 47, column: 46, scope: !85)
!92 = !DILocation(line: 47, column: 24, scope: !85)
!93 = !DILocation(line: 48, column: 3, scope: !85)
!94 = !DILocation(line: 49, column: 22, scope: !46)
!95 = !DILocation(line: 49, column: 3, scope: !46)
!96 = !DILocation(line: 50, column: 7, scope: !97)
!97 = distinct !DILexicalBlock(scope: !46, file: !2, line: 50, column: 7)
!98 = !DILocation(line: 50, column: 12, scope: !97)
!99 = !DILocation(line: 50, column: 7, scope: !46)
!100 = !DILocation(line: 51, column: 5, scope: !101)
!101 = distinct !DILexicalBlock(scope: !97, file: !2, line: 50, column: 18)
!102 = !DILocation(line: 52, column: 3, scope: !101)
!103 = !DILocation(line: 53, column: 3, scope: !46)
!104 = !DILocation(line: 55, column: 3, scope: !46)
!105 = !DILocation(line: 56, column: 41, scope: !46)
!106 = !DILocation(line: 56, column: 3, scope: !46)
!107 = !DILocation(line: 57, column: 3, scope: !46)
