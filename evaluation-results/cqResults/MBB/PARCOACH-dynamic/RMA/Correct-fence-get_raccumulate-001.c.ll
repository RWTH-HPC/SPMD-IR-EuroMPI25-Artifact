; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_raccumulate-001.c'
...
19:                                               ; preds = %17, %2
  ...
  %22 = call i32 @MPI_Win_create(ptr noundef %21, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9), !dbg !89
  %23 = load ptr, ptr %9, align 8, !dbg !90
  %24 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %23), !dbg !91
...
27:                                               ; preds = %19
  ...
  %31 = call i32 @MPI_Get(ptr noundef %29, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %30), !dbg !102
  %32 = load ptr, ptr %9, align 8, !dbg !103
  %33 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %32), !dbg !104
...
40:                                               ; preds = %37
  ...
  %42 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %41), !dbg !115
  br label %43, !dbg !116

43:                                               ; preds = %40, %37
  %44 = load ptr, ptr %9, align 8, !dbg !117
  %45 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %44), !dbg !118
...
50:                                               ; preds = %48, %43
  %51 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !126
