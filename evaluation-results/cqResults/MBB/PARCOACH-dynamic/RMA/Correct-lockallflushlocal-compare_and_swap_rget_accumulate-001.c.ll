; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_rget_accumulate-001.c'
...
25:                                               ; preds = %23, %2
  ...
  %28 = call i32 @MPI_Win_create(ptr noundef %27, i64 noundef 80, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %12), !dbg !79
  %29 = load i32, ptr %12, align 4, !dbg !80
  %30 = call i32 @MPI_Win_lock_all(i32 noundef 0, i32 noundef %29), !dbg !81
...
47:                                               ; preds = %33, %25
  ...
  %49 = call i32 @MPI_Win_unlock_all(i32 noundef %48), !dbg !110
...
54:                                               ; preds = %52, %47
  %55 = call i32 @MPI_Win_free(ptr noundef %12), !dbg !118
