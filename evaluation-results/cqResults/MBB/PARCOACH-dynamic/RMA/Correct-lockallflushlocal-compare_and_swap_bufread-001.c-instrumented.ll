; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c"
...
@0 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@13 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@14 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
@15 = private unnamed_addr constant [109 x i8] c"cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c\00", align 1
...
30:                                               ; preds = %22
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 46, ptr @4), !dbg !81
  ...
  call void @parcoach_rma_store(ptr %14, i64 64, i32 48, ptr @5), !dbg !84
  store ptr %33, ptr %14, align 8, !dbg !84
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @6), !dbg !86
  %34 = load ptr, ptr %12, align 8, !dbg !86
  call void @parcoach_rma_load(ptr %14, i64 64, i32 50, ptr @7), !dbg !87
  %35 = load ptr, ptr %14, align 8, !dbg !87
  call void @parcoach_rma_load(ptr %13, i64 64, i32 50, ptr @8), !dbg !88
  %36 = load ptr, ptr %13, align 8, !dbg !88
  call void @parcoach_rma_load(ptr %10, i64 32, i32 50, ptr @9), !dbg !89
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 51, ptr @10), !dbg !91
  %39 = load ptr, ptr %12, align 8, !dbg !91
  %40 = getelementptr inbounds i32, ptr %39, i64 0, !dbg !91
  call void @parcoach_rma_load(ptr %40, i64 32, i32 51, ptr @11), !dbg !91
  %41 = load i32, ptr %40, align 4, !dbg !91
  %42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %41), !dbg !92
  br label %43, !dbg !93

43:                                               ; preds = %30, %22
  call void @parcoach_rma_load(ptr %10, i64 32, i32 53, ptr @12), !dbg !94
  %44 = load i32, ptr %10, align 4, !dbg !94
  %45 = call i32 @parcoach_rma_MPI_Win_unlock_all(i32 %44, i32 53, ptr @13), !dbg !95
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 54, ptr @14), !dbg !96
  %47 = call i32 @MPI_Finalize(), !dbg !97
  call void @parcoach_rma_load(ptr %7, i64 32, i32 57, ptr @15), !dbg !98
...
!2 = !DIFile(filename: "cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "87e2be28d6d723675dde2bc9daaf37b5")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-compare_and_swap_bufread-001.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "87e2be28d6d723675dde2bc9daaf37b5")
!19 = !{!20, !23, !24, !25}
...
!80 = !DILocalVariable(name: "int_0", scope: !77, file: !2, line: 46, type: !23)
!81 = !DILocation(line: 46, column: 10, scope: !77)
!82 = !DILocation(line: 46, column: 25, scope: !77)
!83 = !DILocalVariable(name: "int_1", scope: !77, file: !2, line: 48, type: !23)
!84 = !DILocation(line: 48, column: 10, scope: !77)
!85 = !DILocation(line: 48, column: 25, scope: !77)
!86 = !DILocation(line: 50, column: 26, scope: !77)
!87 = !DILocation(line: 50, column: 31, scope: !77)
!88 = !DILocation(line: 50, column: 38, scope: !77)
!89 = !DILocation(line: 50, column: 60, scope: !77)
!90 = !DILocation(line: 50, column: 5, scope: !77)
!91 = !DILocation(line: 51, column: 27, scope: !77)
!92 = !DILocation(line: 51, column: 5, scope: !77)
!93 = !DILocation(line: 52, column: 3, scope: !77)
!94 = !DILocation(line: 53, column: 22, scope: !36)
!95 = !DILocation(line: 53, column: 3, scope: !36)
