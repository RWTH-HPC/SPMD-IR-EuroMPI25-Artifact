...
#di_file = #llvm.di_file<"cq-results-20250731-154348/RRB/NVSHMEM-hostInitiated/SPMDIR/dynamic/003-nvshmem-dynamic-while-local-no.cpp" in "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
#di_global_variable = #llvm.di_global_variable<file = #di_file, line = 34, type = #di_composite_type, isLocalToUnit = true, isDefined = true>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, f80 = dense<128> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    llvm.store %c0_i32, %7 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    %8 = arith.cmpi sgt, %arg0, %c1_i32 {spmd.executionKind = "All"} : i32
    %9 = scf.if %8 -> (i32) {
      %27 = llvm.getelementptr inbounds %arg1[8] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, i8
      %28 = llvm.load %27 {alignment = 8 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag1]} : !llvm.ptr -> !llvm.ptr
      %29 = llvm.call tail @strtol(%28, %2, %c10_i32) {no_unwind, spmd.executionKind = "All", will_return} : (!llvm.ptr, !llvm.ptr, i32) -> i64
      %30 = arith.trunci %29 {spmd.executionKind = "All"} : i64 to i32
      scf.yield {spmd.executionKind = "All"} %30 : i32
    } else {
    ...
    scf.if %12 {
      ...
      %27 = llvm.call tail @printf(%1, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) {no_unwind, spmd.executionKind = "All"} : (!llvm.ptr, i32, i32) -> i32
      %28 = "spmd.abort"(%4, %c1_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, i32) -> !spmd.error
    } {spmd.executionKind = "All", spmd.isMultiValued = false}
    ...
    scf.if %16 {
      %27 = scf.while (%arg2 = %9) : (i32) -> i32 {
        %28 = arith.addi %arg2, %c-6_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %29 = arith.remsi %28, %c3_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %30 = arith.cmpi slt, %29, %c2_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %31 = llvm.load %7 {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> i32
        %32 = arith.cmpi slt, %31, %c9999_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %33 = arith.select %30, %32, %false {fastmathFlags = #llvm.fastmath<none>, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i1
        scf.condition(%33) {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %arg2 : i32
      } do {
      ^bb0(%arg2: i32):
        %28 = arith.addi %arg2, %c-1_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        ...
        scf.yield {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %28 : i32
    ...
    %18 = "spmd.memcpy"(%6, %address, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %19 = "spmd.memcpy"(%7, %address_4, %c4_i64, %c2_i32) <{usedModel = 4 : i32}> {spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr, i64, i32) -> !spmd.error
    %20 = "spmd.fence"(%c0_i32) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (i32) -> !spmd.error
    %21 = llvm.load %6 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
    %22 = llvm.load %7 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
    %23 = llvm.call @printf(%0, %rank_0, %21, %22) vararg(!llvm.func<i32 (ptr, ...)>) {no_unwind, spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32) -> i32
    %24 = "spmd.free"(%4, %address) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %25 = "spmd.free"(%4, %address_4) <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, !llvm.ptr) -> !spmd.error
    %26 = "spmd.finalize"() <{usedModel = 2 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
