...
#di_file = #llvm.di_file<"cq-results-20250604-173113/RRB/MPIRMA/SPMDIR/dynamic/004-MPI-dynamic-while-local-no.c" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
module attributes {dlti.dl_spec = #dlti.dl_spec<i8 = dense<8> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = [["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %12 = arith.cmpi sgt, %arg0, %c1_i32 {spmd.executionKind = "All"} : i32
    %13 = scf.if %12 -> (i32) {
      %24 = llvm.getelementptr inbounds %arg1[8] {spmd.executionKind = "All"} : (!llvm.ptr) -> !llvm.ptr, i8
      %25 = llvm.load %24 {alignment = 8 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag2]} : !llvm.ptr -> !llvm.ptr
      %26 = llvm.call tail @strtol(%25, %2, %c10_i32) {no_unwind, spmd.executionKind = "All", will_return} : (!llvm.ptr, !llvm.ptr, i32) -> i64
      %27 = arith.trunci %26 {spmd.executionKind = "All"} : i64 to i32
      scf.yield {spmd.executionKind = "All"} %27 : i32
    } else {
      scf.yield {spmd.executionKind = "All"} %c10_i32 : i32
    } {spmd.executionKind = "All", spmd.isMultiValued = false}
    %14 = "spmd.init"() <{usedModel = 0 : i32}> {spmd.executionKind = "All"} : () -> !spmd.error
    ...
    %15 = arith.cmpi eq, %size, %c2_i32 {spmd.executionKind = "All"} : i32
    scf.if %15 {
    } else {
      %24 = llvm.call @printf(%1, %size, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) {no_unwind, spmd.executionKind = "All"} : (!llvm.ptr, i32, i32) -> i32
      %25 = "spmd.abort"(%3, %c1_i32) <{usedModel = 0 : i32}> {spmd.executionKind = "All"} : (!spmd.comm, i32) -> !spmd.error
    } {spmd.executionKind = "All", spmd.isMultiValued = false}
    ...
    scf.if %17 {
      %24 = scf.while (%arg2 = %13) : (i32) -> i32 {
        %25 = arith.addi %arg2, %c-6_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %26 = arith.remsi %25, %c3_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %27 = arith.cmpi slt, %26, %c2_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %28 = llvm.load %11 {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> i32
        %29 = arith.cmpi slt, %28, %c9999_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %30 = arith.select %27, %29, %false {fastmathFlags = #llvm.fastmath<none>, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i1
        scf.condition(%30) {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %arg2 : i32
      } do {
      ^bb0(%arg2: i32):
        %25 = arith.addi %arg2, %c-1_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
        %error_3 = "spmd.get"(%11, %c1_i64, %4, %c1_i64, %c1_i32, %win, %c0_i64, %c1_i64, %4, %c1_i64) <{isAtomic = true, isBlocking = false, usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!llvm.ptr, i64, !spmd.datatype, i64, i32, !spmd.win, i64, i64, !spmd.datatype, i64) -> !spmd.error
        %26 = "spmd.fence"(%win, %c0_i32) <{usedModel = 0 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (!spmd.win, i32) -> !spmd.error
        scf.yield {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %25 : i32
    ...
    %19 = llvm.load %11 {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
    %20 = llvm.load %baseAddress {alignment = 4 : i64, spmd.executionKind = "All", tbaa = [#tbaa_tag]} : !llvm.ptr -> i32
    %21 = llvm.call @printf(%0, %rank, %19, %c2_i32, %20) vararg(!llvm.func<i32 (ptr, ...)>) {no_unwind, spmd.executionKind = "All"} : (!llvm.ptr, i32, i32, i32, i32) -> i32
