; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c'
...
26:                                               ; preds = %22, %2
  %27 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !93
...
39:                                               ; preds = %28
  ...
  %41 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %40), !dbg !118
...
44:                                               ; preds = %39
  ...
  %47 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %46), !dbg !126
...
54:                                               ; preds = %52, %49
  ...
  %56 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %55), !dbg !137
  %57 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !138
  ...
  %66 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !145
