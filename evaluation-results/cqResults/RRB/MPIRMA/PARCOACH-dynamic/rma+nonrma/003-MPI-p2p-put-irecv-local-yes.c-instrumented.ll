; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c"
...
@0 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@1 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@2 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@3 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@4 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@5 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@6 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@7 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@8 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@9 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@10 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@11 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@12 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@13 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@14 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@15 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@16 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
@17 = private unnamed_addr constant [100 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c\00", align 1
...
44:                                               ; preds = %39
  ...
  call void @parcoach_rma_load(ptr %8, i64 32, i32 42, ptr @3), !dbg !111
  %46 = load i32, ptr %8, align 4, !dbg !111
  %47 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %46, i32 42, ptr @4), !dbg !112
  %48 = call i32 @MPI_Wait(ptr noundef %16, ptr noundef inttoptr (i64 1 to ptr)), !dbg !113
  br label %49, !dbg !114

49:                                               ; preds = %44, %39
  call void @parcoach_rma_load(ptr %6, i64 32, i32 45, ptr @5), !dbg !115
...
54:                                               ; preds = %52, %49
  call void @parcoach_rma_load(ptr %8, i64 32, i32 48, ptr @6), !dbg !122
  %55 = load i32, ptr %8, align 4, !dbg !122
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %55, i32 48, ptr @7), !dbg !123
  %57 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 50, ptr @8), !dbg !124
  call void @parcoach_rma_load(ptr %6, i64 32, i32 53, ptr @9), !dbg !125
  %58 = load i32, ptr %6, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %12, i64 64, i32 54, ptr @10), !dbg !126
  %59 = load ptr, ptr %12, align 8, !dbg !126
  call void @parcoach_rma_load(ptr %59, i64 32, i32 54, ptr @11), !dbg !127
  %60 = load i32, ptr %59, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %11, i64 32, i32 55, ptr @12), !dbg !128
  %61 = load i32, ptr %11, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %9, i64 64, i32 56, ptr @13), !dbg !129
  %62 = load ptr, ptr %9, align 8, !dbg !129
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !129
  call void @parcoach_rma_load(ptr %63, i64 32, i32 56, ptr @14), !dbg !129
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 58, ptr @15), !dbg !131
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "43c4bc49e077c86884743a3dad356b73")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/003-MPI-p2p-put-irecv-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "43c4bc49e077c86884743a3dad356b73")
!14 = !{!15, !18, !19, !20}
