; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c"
...
@0 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@1 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@2 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@3 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@4 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@5 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@6 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@7 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@8 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@9 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@10 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@11 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@12 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@13 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@14 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@15 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
@16 = private unnamed_addr constant [113 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c\00", align 1
...
26:                                               ; preds = %22, %2
  %27 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, i32 469762048, i32 1140850688, ptr %9, ptr %8, i32 31, ptr @0), !dbg !81
...
36:                                               ; preds = %31
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @15), !dbg !95
  %37 = load i32, ptr %15, align 4, !dbg !95
  %38 = add nsw i32 %37, 1, !dbg !95
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @16), !dbg !95
  store i32 %38, ptr %15, align 4, !dbg !95
  br label %28, !dbg !96, !llvm.loop !97

39:                                               ; preds = %28
  call void @llvm.dbg.declare(metadata ptr %16, metadata !100, metadata !DIExpression()), !dbg !105
  %40 = load i32, ptr %8, align 4, !dbg !106
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %40, i32 37, ptr @1), !dbg !107
  %42 = getelementptr inbounds [1 x i32], ptr %16, i64 0, i64 0, !dbg !108
  %43 = call i32 @MPI_Ibcast(ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688, ptr noundef %42), !dbg !109
  %44 = getelementptr inbounds [1 x i32], ptr %16, i64 0, i64 0, !dbg !110
  %45 = call i32 @MPI_Waitall(i32 noundef 1, ptr noundef %44, ptr noundef inttoptr (i64 1 to ptr)), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 40, ptr @2), !dbg !112
  %46 = load i32, ptr %6, align 4, !dbg !112
  %47 = icmp eq i32 %46, 0, !dbg !114
  br i1 %47, label %48, label %51, !dbg !115

48:                                               ; preds = %39
  call void @parcoach_rma_load(ptr %8, i64 32, i32 41, ptr @3), !dbg !116
  %49 = load i32, ptr %8, align 4, !dbg !116
  %50 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %49, i32 41, ptr @4), !dbg !118
  br label %51, !dbg !119

51:                                               ; preds = %48, %39
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @5), !dbg !120
  %52 = load i32, ptr %8, align 4, !dbg !120
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %52, i32 43, ptr @6), !dbg !121
  %54 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @7), !dbg !122
  ...
  call void @parcoach_rma_load(ptr %56, i64 32, i32 49, ptr @10), !dbg !125
  ...
  call void @parcoach_rma_load(ptr %60, i64 32, i32 51, ptr @13), !dbg !127
  %61 = load i32, ptr %60, align 4, !dbg !127
  %62 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %55, i32 noundef %57, i32 noundef %58, i32 noundef %61), !dbg !128
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !129
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "9170db10a64ad24d9e0cbc06b578916c")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/014-MPI-coll-get-ibroadcast-waitall-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "9170db10a64ad24d9e0cbc06b578916c")
!14 = !{!15, !18, !19, !20}
...
!100 = !DILocalVariable(name: "reqs", scope: !39, file: !2, line: 36, type: !101)
...
!105 = !DILocation(line: 36, column: 17, scope: !39)
!106 = !DILocation(line: 37, column: 22, scope: !39)
!107 = !DILocation(line: 37, column: 5, scope: !39)
!108 = !DILocation(line: 38, column: 55, scope: !39)
!109 = !DILocation(line: 38, column: 5, scope: !39)
!110 = !DILocation(line: 39, column: 20, scope: !39)
!111 = !DILocation(line: 39, column: 5, scope: !39)
!112 = !DILocation(line: 40, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !39, file: !2, line: 40, column: 9)
!114 = !DILocation(line: 40, column: 14, scope: !113)
!115 = !DILocation(line: 40, column: 9, scope: !39)
!116 = !DILocation(line: 41, column: 55, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 40, column: 20)
!118 = !DILocation(line: 41, column: 9, scope: !117)
!119 = !DILocation(line: 42, column: 5, scope: !117)
!120 = !DILocation(line: 43, column: 22, scope: !39)
!121 = !DILocation(line: 43, column: 5, scope: !39)
!122 = !DILocation(line: 45, column: 5, scope: !39)
!123 = !DILocation(line: 48, column: 9, scope: !39)
!124 = !DILocation(line: 49, column: 10, scope: !39)
!125 = !DILocation(line: 49, column: 9, scope: !39)
!126 = !DILocation(line: 50, column: 9, scope: !39)
!127 = !DILocation(line: 51, column: 9, scope: !39)
!128 = !DILocation(line: 46, column: 5, scope: !39)
!129 = !DILocation(line: 53, column: 5, scope: !39)
!130 = !DILocation(line: 54, column: 5, scope: !39)
!131 = !DILocation(line: 56, column: 5, scope: !39)
