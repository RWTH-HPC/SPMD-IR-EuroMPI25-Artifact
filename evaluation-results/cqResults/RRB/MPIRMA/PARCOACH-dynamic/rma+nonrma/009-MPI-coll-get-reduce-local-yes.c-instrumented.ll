; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c"
...
@0 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@1 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@2 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@3 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@4 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@5 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@6 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@7 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@8 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@9 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@10 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@11 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@12 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@13 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@14 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@15 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@16 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 39, ptr @4), !dbg !111
  br label %46, !dbg !112

46:                                               ; preds = %43, %38
  %47 = call i32 @MPI_Reduce(ptr noundef %11, ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !113
  call void @parcoach_rma_load(ptr %8, i64 64, i32 43, ptr @5), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 43, ptr @6), !dbg !115
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 45, ptr @7), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @8), !dbg !117
  %51 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !118
  %52 = load ptr, ptr %12, align 8, !dbg !118
  call void @parcoach_rma_load(ptr %52, i64 32, i32 49, ptr @10), !dbg !119
  %53 = load i32, ptr %52, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @11), !dbg !120
  %54 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @12), !dbg !121
  %55 = load ptr, ptr %9, align 8, !dbg !121
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %56, i64 32, i32 51, ptr @13), !dbg !121
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !123
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d4f454400e56a92c4c37c9c5dba7bba1")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d4f454400e56a92c4c37c9c5dba7bba1")
!14 = !{!15, !19, !20, !23, !26}
...
!109 = !DILocation(line: 39, column: 55, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 37, column: 20)
!111 = !DILocation(line: 39, column: 9, scope: !110)
!112 = !DILocation(line: 40, column: 5, scope: !110)
!113 = !DILocation(line: 42, column: 5, scope: !39)
