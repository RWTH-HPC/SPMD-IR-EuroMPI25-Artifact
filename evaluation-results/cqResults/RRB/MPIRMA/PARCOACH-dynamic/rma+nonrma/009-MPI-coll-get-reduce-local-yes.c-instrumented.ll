; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c"
...
@0 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@1 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@2 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@3 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@4 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@5 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@6 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@7 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@8 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@9 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@10 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@11 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@12 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@13 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@14 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@15 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
@16 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %44, i32 39, ptr @4), !dbg !100
  br label %46, !dbg !101

46:                                               ; preds = %43, %38
  %47 = call i32 @MPI_Reduce(ptr noundef %11, ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef 0, i32 noundef 1140850688), !dbg !102
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @5), !dbg !103
  %48 = load i32, ptr %8, align 4, !dbg !103
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %48, i32 43, ptr @6), !dbg !104
  %50 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @7), !dbg !105
  ...
  call void @parcoach_rma_load(ptr %52, i64 32, i32 49, ptr @10), !dbg !108
  ...
  call void @parcoach_rma_load(ptr %56, i64 32, i32 51, ptr @13), !dbg !110
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !112
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d4f454400e56a92c4c37c9c5dba7bba1")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/009-MPI-coll-get-reduce-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d4f454400e56a92c4c37c9c5dba7bba1")
!14 = !{!15, !18, !19, !20}
...
!98 = !DILocation(line: 39, column: 55, scope: !99)
!99 = distinct !DILexicalBlock(scope: !95, file: !2, line: 37, column: 20)
!100 = !DILocation(line: 39, column: 9, scope: !99)
!101 = !DILocation(line: 40, column: 5, scope: !99)
!102 = !DILocation(line: 42, column: 5, scope: !31)
