; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@13 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@14 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@15 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@16 = private unnamed_addr constant [105 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @15), !dbg !86
  %36 = load i32, ptr %15, align 4, !dbg !86
  %37 = add nsw i32 %36, 1, !dbg !86
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @16), !dbg !86
...
46:                                               ; preds = %43, %38
  %47 = call i32 @MPI_Bcast(ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 0, i32 noundef 1140850688), !dbg !101
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @5), !dbg !102
  %48 = load i32, ptr %8, align 4, !dbg !102
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %48, i32 43, ptr @6), !dbg !103
  %50 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @7), !dbg !104
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @8), !dbg !105
  %51 = load i32, ptr %6, align 4, !dbg !105
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !106
  %52 = load ptr, ptr %12, align 8, !dbg !106
  call void @parcoach_rma_load(ptr %52, i64 32, i32 49, ptr @10), !dbg !107
  %53 = load i32, ptr %52, align 4, !dbg !107
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @11), !dbg !108
  %54 = load i32, ptr %11, align 4, !dbg !108
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @12), !dbg !109
  %55 = load ptr, ptr %9, align 8, !dbg !109
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !109
  call void @parcoach_rma_load(ptr %56, i64 32, i32 51, ptr @13), !dbg !109
  %57 = load i32, ptr %56, align 4, !dbg !109
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51, i32 noundef %53, i32 noundef %54, i32 noundef %57), !dbg !110
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !111
  %60 = call i32 @MPI_Finalize(), !dbg !112
  ret i32 0, !dbg !113
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0ae2636b0db3334e833a291e07441e87")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0ae2636b0db3334e833a291e07441e87")
!14 = !{!15, !18, !19}
...
!100 = !DILocation(line: 40, column: 5, scope: !98)
!101 = !DILocation(line: 42, column: 5, scope: !30)
