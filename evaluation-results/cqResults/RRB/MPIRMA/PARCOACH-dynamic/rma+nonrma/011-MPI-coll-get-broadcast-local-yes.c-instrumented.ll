; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@13 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@14 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@15 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
@16 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c\00", align 1
...
46:                                               ; preds = %43, %38
  %47 = call i32 @MPI_Bcast(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !110
  call void @parcoach_rma_load(ptr %8, i64 64, i32 43, ptr @5), !dbg !111
  %48 = load ptr, ptr %8, align 8, !dbg !111
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 43, ptr @6), !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 45, ptr @7), !dbg !113
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @8), !dbg !114
  %51 = load i32, ptr %6, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !115
  %52 = load ptr, ptr %12, align 8, !dbg !115
  call void @parcoach_rma_load(ptr %52, i64 32, i32 49, ptr @10), !dbg !116
  %53 = load i32, ptr %52, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @11), !dbg !117
  %54 = load i32, ptr %11, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @12), !dbg !118
  %55 = load ptr, ptr %9, align 8, !dbg !118
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %56, i64 32, i32 51, ptr @13), !dbg !118
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !120
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0ae2636b0db3334e833a291e07441e87")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/011-MPI-coll-get-broadcast-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0ae2636b0db3334e833a291e07441e87")
!14 = !{!15, !19, !20, !23}
...
!109 = !DILocation(line: 40, column: 5, scope: !107)
!110 = !DILocation(line: 42, column: 5, scope: !36)
