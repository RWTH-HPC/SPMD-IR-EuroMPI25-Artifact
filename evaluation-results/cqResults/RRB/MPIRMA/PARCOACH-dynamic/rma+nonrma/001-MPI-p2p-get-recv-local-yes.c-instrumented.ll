; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c"
...
@0 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
@17 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 39, ptr @3), !dbg !118
  %44 = load ptr, ptr %8, align 8, !dbg !118
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 39, ptr @4), !dbg !120
  %46 = call i32 @MPI_Recv(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i32 noundef -1, ptr noundef @ompi_mpi_comm_world, ptr noundef null), !dbg !121
  br label %47, !dbg !122

47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 43, ptr @5), !dbg !123
  %48 = load i32, ptr %6, align 4, !dbg !123
  %49 = icmp eq i32 %48, 1, !dbg !125
  br i1 %49, label %50, label %52, !dbg !126

50:                                               ; preds = %47
  %51 = call i32 @MPI_Send(ptr noundef %11, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !127
  br label %52, !dbg !129

52:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 46, ptr @6), !dbg !130
  %53 = load ptr, ptr %8, align 8, !dbg !130
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 46, ptr @7), !dbg !131
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 48, ptr @8), !dbg !132
  call void @parcoach_rma_load(ptr %6, i64 32, i32 51, ptr @9), !dbg !133
  %56 = load i32, ptr %6, align 4, !dbg !133
  call void @parcoach_rma_load(ptr %12, i64 64, i32 52, ptr @10), !dbg !134
  %57 = load ptr, ptr %12, align 8, !dbg !134
  call void @parcoach_rma_load(ptr %57, i64 32, i32 52, ptr @11), !dbg !135
  %58 = load i32, ptr %57, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %11, i64 32, i32 53, ptr @12), !dbg !136
  %59 = load i32, ptr %11, align 4, !dbg !136
  call void @parcoach_rma_load(ptr %9, i64 64, i32 54, ptr @13), !dbg !137
  %60 = load ptr, ptr %9, align 8, !dbg !137
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !137
  call void @parcoach_rma_load(ptr %61, i64 32, i32 54, ptr @14), !dbg !137
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 56, ptr @15), !dbg !139
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "038fa04ef58c70d545f143e32bb158c3")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/001-MPI-p2p-get-recv-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "038fa04ef58c70d545f143e32bb158c3")
!14 = !{!15, !19, !20, !23, !26}
...
!118 = !DILocation(line: 39, column: 55, scope: !119)
!119 = distinct !DILexicalBlock(scope: !115, file: !2, line: 37, column: 20)
!120 = !DILocation(line: 39, column: 9, scope: !119)
!121 = !DILocation(line: 41, column: 9, scope: !119)
!122 = !DILocation(line: 42, column: 5, scope: !119)
!123 = !DILocation(line: 43, column: 9, scope: !124)
!124 = distinct !DILexicalBlock(scope: !49, file: !2, line: 43, column: 9)
!125 = !DILocation(line: 43, column: 14, scope: !124)
!126 = !DILocation(line: 43, column: 9, scope: !49)
!127 = !DILocation(line: 44, column: 9, scope: !128)
!128 = distinct !DILexicalBlock(scope: !124, file: !2, line: 43, column: 20)
!129 = !DILocation(line: 45, column: 5, scope: !128)
!130 = !DILocation(line: 46, column: 22, scope: !49)
!131 = !DILocation(line: 46, column: 5, scope: !49)
!132 = !DILocation(line: 48, column: 5, scope: !49)
!133 = !DILocation(line: 51, column: 9, scope: !49)
!134 = !DILocation(line: 52, column: 10, scope: !49)
!135 = !DILocation(line: 52, column: 9, scope: !49)
!136 = !DILocation(line: 53, column: 9, scope: !49)
!137 = !DILocation(line: 54, column: 9, scope: !49)
!138 = !DILocation(line: 49, column: 5, scope: !49)
!139 = !DILocation(line: 56, column: 5, scope: !49)
!140 = !DILocation(line: 57, column: 5, scope: !49)
!141 = !DILocation(line: 59, column: 5, scope: !49)
