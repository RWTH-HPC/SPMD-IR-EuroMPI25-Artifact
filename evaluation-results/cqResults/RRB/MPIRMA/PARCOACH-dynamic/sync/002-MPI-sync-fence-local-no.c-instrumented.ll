; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c"
...
@0 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %40, i32 38, ptr @2), !dbg !98
  call void @parcoach_rma_load(ptr %6, i64 32, i32 39, ptr @3), !dbg !99
  %42 = load i32, ptr %6, align 4, !dbg !99
  %43 = icmp eq i32 %42, 0, !dbg !101
  br i1 %43, label %44, label %47, !dbg !102

44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 40, ptr @4), !dbg !103
  %45 = load i32, ptr %8, align 4, !dbg !103
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %45, i32 40, ptr @5), !dbg !105
  br label %47, !dbg !106

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 42, ptr @6), !dbg !107
  %48 = load i32, ptr %8, align 4, !dbg !107
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %48, i32 42, ptr @7), !dbg !108
  call void @parcoach_rma_load(ptr %6, i64 32, i32 43, ptr @8), !dbg !109
  %50 = load i32, ptr %6, align 4, !dbg !109
  %51 = icmp eq i32 %50, 0, !dbg !111
  br i1 %51, label %52, label %55, !dbg !112

52:                                               ; preds = %47
  %53 = load i32, ptr %10, align 4, !dbg !113
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %53), !dbg !115
  br label %55, !dbg !116

55:                                               ; preds = %52, %47
  %56 = load i32, ptr %8, align 4, !dbg !117
  %57 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %56, i32 47, ptr @9), !dbg !118
  %58 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 49, ptr @10), !dbg !119
  %59 = load i32, ptr %6, align 4, !dbg !120
  %60 = load ptr, ptr %12, align 8, !dbg !121
  %61 = load i32, ptr %60, align 4, !dbg !122
  %62 = load i32, ptr %11, align 4, !dbg !123
  %63 = load ptr, ptr %9, align 8, !dbg !124
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !124
  %65 = load i32, ptr %64, align 4, !dbg !124
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %59, i32 noundef %61, i32 noundef %62, i32 noundef %65), !dbg !125
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 57, ptr @11), !dbg !126
  %68 = call i32 @MPI_Finalize(), !dbg !127
  ret i32 0, !dbg !128
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f045c288940e1fe92e546f8fda0f4d8c")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f045c288940e1fe92e546f8fda0f4d8c")
!19 = !{!20, !23, !24}
...
!97 = !DILocation(line: 38, column: 22, scope: !35)
!98 = !DILocation(line: 38, column: 5, scope: !35)
!99 = !DILocation(line: 39, column: 9, scope: !100)
!100 = distinct !DILexicalBlock(scope: !35, file: !2, line: 39, column: 9)
!101 = !DILocation(line: 39, column: 14, scope: !100)
!102 = !DILocation(line: 39, column: 9, scope: !35)
!103 = !DILocation(line: 40, column: 55, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !2, line: 39, column: 20)
!105 = !DILocation(line: 40, column: 9, scope: !104)
!106 = !DILocation(line: 41, column: 5, scope: !104)
!107 = !DILocation(line: 42, column: 22, scope: !35)
!108 = !DILocation(line: 42, column: 5, scope: !35)
!109 = !DILocation(line: 43, column: 9, scope: !110)
!110 = distinct !DILexicalBlock(scope: !35, file: !2, line: 43, column: 9)
!111 = !DILocation(line: 43, column: 14, scope: !110)
!112 = !DILocation(line: 43, column: 9, scope: !35)
!113 = !DILocation(line: 44, column: 33, scope: !114)
!114 = distinct !DILexicalBlock(scope: !110, file: !2, line: 43, column: 20)
!115 = !DILocation(line: 44, column: 9, scope: !114)
!116 = !DILocation(line: 45, column: 5, scope: !114)
!117 = !DILocation(line: 47, column: 22, scope: !35)
!118 = !DILocation(line: 47, column: 5, scope: !35)
!119 = !DILocation(line: 49, column: 5, scope: !35)
!120 = !DILocation(line: 52, column: 9, scope: !35)
!121 = !DILocation(line: 53, column: 10, scope: !35)
!122 = !DILocation(line: 53, column: 9, scope: !35)
!123 = !DILocation(line: 54, column: 9, scope: !35)
!124 = !DILocation(line: 55, column: 9, scope: !35)
!125 = !DILocation(line: 50, column: 5, scope: !35)
!126 = !DILocation(line: 57, column: 5, scope: !35)
!127 = !DILocation(line: 58, column: 5, scope: !35)
!128 = !DILocation(line: 60, column: 5, scope: !35)
