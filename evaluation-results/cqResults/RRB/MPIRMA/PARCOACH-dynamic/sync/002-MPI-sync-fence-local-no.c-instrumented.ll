; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c"
...
@0 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
...
38:                                               ; preds = %27
  ...
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %40, i32 38, ptr @2), !dbg !107
  call void @parcoach_rma_load(ptr %6, i64 32, i32 39, ptr @3), !dbg !108
  %42 = load i32, ptr %6, align 4, !dbg !108
  %43 = icmp eq i32 %42, 0, !dbg !110
  br i1 %43, label %44, label %47, !dbg !111

44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 40, ptr @4), !dbg !112
  %45 = load ptr, ptr %8, align 8, !dbg !112
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 40, ptr @5), !dbg !114
  br label %47, !dbg !115

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 42, ptr @6), !dbg !116
  %48 = load ptr, ptr %8, align 8, !dbg !116
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 42, ptr @7), !dbg !117
  call void @parcoach_rma_load(ptr %6, i64 32, i32 43, ptr @8), !dbg !118
  %50 = load i32, ptr %6, align 4, !dbg !118
  %51 = icmp eq i32 %50, 0, !dbg !120
  br i1 %51, label %52, label %55, !dbg !121

52:                                               ; preds = %47
  %53 = load i32, ptr %10, align 4, !dbg !122
  %54 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %53), !dbg !124
  br label %55, !dbg !125

55:                                               ; preds = %52, %47
  %56 = load ptr, ptr %8, align 8, !dbg !126
  %57 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %56, i32 47, ptr @9), !dbg !127
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 49, ptr @10), !dbg !128
  %59 = load i32, ptr %6, align 4, !dbg !129
  %60 = load ptr, ptr %12, align 8, !dbg !130
  %61 = load i32, ptr %60, align 4, !dbg !131
  %62 = load i32, ptr %11, align 4, !dbg !132
  %63 = load ptr, ptr %9, align 8, !dbg !133
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !133
  %65 = load i32, ptr %64, align 4, !dbg !133
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %59, i32 noundef %61, i32 noundef %62, i32 noundef %65), !dbg !134
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 57, ptr @11), !dbg !135
  %68 = call i32 @MPI_Finalize(), !dbg !136
  ret i32 0, !dbg !137
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f045c288940e1fe92e546f8fda0f4d8c")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f045c288940e1fe92e546f8fda0f4d8c")
!19 = !{!20, !24, !25, !28}
...
!106 = !DILocation(line: 38, column: 22, scope: !41)
!107 = !DILocation(line: 38, column: 5, scope: !41)
!108 = !DILocation(line: 39, column: 9, scope: !109)
!109 = distinct !DILexicalBlock(scope: !41, file: !2, line: 39, column: 9)
!110 = !DILocation(line: 39, column: 14, scope: !109)
!111 = !DILocation(line: 39, column: 9, scope: !41)
!112 = !DILocation(line: 40, column: 55, scope: !113)
!113 = distinct !DILexicalBlock(scope: !109, file: !2, line: 39, column: 20)
!114 = !DILocation(line: 40, column: 9, scope: !113)
!115 = !DILocation(line: 41, column: 5, scope: !113)
!116 = !DILocation(line: 42, column: 22, scope: !41)
!117 = !DILocation(line: 42, column: 5, scope: !41)
!118 = !DILocation(line: 43, column: 9, scope: !119)
!119 = distinct !DILexicalBlock(scope: !41, file: !2, line: 43, column: 9)
!120 = !DILocation(line: 43, column: 14, scope: !119)
!121 = !DILocation(line: 43, column: 9, scope: !41)
!122 = !DILocation(line: 44, column: 33, scope: !123)
!123 = distinct !DILexicalBlock(scope: !119, file: !2, line: 43, column: 20)
!124 = !DILocation(line: 44, column: 9, scope: !123)
!125 = !DILocation(line: 45, column: 5, scope: !123)
!126 = !DILocation(line: 47, column: 22, scope: !41)
!127 = !DILocation(line: 47, column: 5, scope: !41)
!128 = !DILocation(line: 49, column: 5, scope: !41)
!129 = !DILocation(line: 52, column: 9, scope: !41)
!130 = !DILocation(line: 53, column: 10, scope: !41)
!131 = !DILocation(line: 53, column: 9, scope: !41)
!132 = !DILocation(line: 54, column: 9, scope: !41)
!133 = !DILocation(line: 55, column: 9, scope: !41)
!134 = !DILocation(line: 50, column: 5, scope: !41)
!135 = !DILocation(line: 57, column: 5, scope: !41)
!136 = !DILocation(line: 58, column: 5, scope: !41)
!137 = !DILocation(line: 60, column: 5, scope: !41)
