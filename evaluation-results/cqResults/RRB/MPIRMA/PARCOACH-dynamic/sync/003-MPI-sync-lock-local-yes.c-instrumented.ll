; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @14), !dbg !91
  %36 = load i32, ptr %15, align 4, !dbg !91
  %37 = add nsw i32 %36, 1, !dbg !91
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @15), !dbg !91
...
42:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 32, i32 41, ptr @3), !dbg !104
  %45 = load i32, ptr %8, align 4, !dbg !104
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %45, i32 41, ptr @4), !dbg !105
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %49, i32 44, ptr @5), !dbg !109
  br label %51, !dbg !110

51:                                               ; preds = %42, %38
  %52 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 47, ptr @6), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 50, ptr @7), !dbg !112
  %53 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %12, i64 64, i32 51, ptr @8), !dbg !113
  %54 = load ptr, ptr %12, align 8, !dbg !113
  call void @parcoach_rma_load(ptr %54, i64 32, i32 51, ptr @9), !dbg !114
  %55 = load i32, ptr %54, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %11, i64 32, i32 52, ptr @10), !dbg !115
  %56 = load i32, ptr %11, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %9, i64 64, i32 53, ptr @11), !dbg !116
  %57 = load ptr, ptr %9, align 8, !dbg !116
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %58, i64 32, i32 53, ptr @12), !dbg !116
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 55, ptr @13), !dbg !118
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f911fb9e2f31f61af60ed29dd2bfb057")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f911fb9e2f31f61af60ed29dd2bfb057")
!19 = !{!20, !23, !24}
...
!104 = !DILocation(line: 41, column: 55, scope: !102)
!105 = !DILocation(line: 41, column: 9, scope: !102)
!106 = !DILocation(line: 43, column: 33, scope: !102)
!107 = !DILocation(line: 43, column: 9, scope: !102)
!108 = !DILocation(line: 44, column: 27, scope: !102)
!109 = !DILocation(line: 44, column: 9, scope: !102)
!110 = !DILocation(line: 45, column: 5, scope: !102)
!111 = !DILocation(line: 47, column: 5, scope: !35)
!112 = !DILocation(line: 50, column: 9, scope: !35)
!113 = !DILocation(line: 51, column: 10, scope: !35)
!114 = !DILocation(line: 51, column: 9, scope: !35)
!115 = !DILocation(line: 52, column: 9, scope: !35)
!116 = !DILocation(line: 53, column: 9, scope: !35)
!117 = !DILocation(line: 48, column: 5, scope: !35)
!118 = !DILocation(line: 55, column: 5, scope: !35)
!119 = !DILocation(line: 56, column: 5, scope: !35)
!120 = !DILocation(line: 58, column: 5, scope: !35)
