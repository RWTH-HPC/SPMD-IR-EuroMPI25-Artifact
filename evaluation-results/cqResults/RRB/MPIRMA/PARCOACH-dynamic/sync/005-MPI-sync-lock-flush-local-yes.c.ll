; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c'
...
42:                                               ; preds = %38
  ...
  %44 = call i32 @MPI_Win_lock(i32 noundef 235, i32 noundef 1, i32 noundef 0, i32 noundef %43), !dbg !103
  %45 = load i32, ptr %8, align 4, !dbg !104
  %46 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 1, i32 noundef 1275069445, i32 noundef %45), !dbg !105
  ...
  %50 = call i32 @MPI_Win_flush(i32 noundef 1, i32 noundef %49), !dbg !109
  %51 = load i32, ptr %8, align 4, !dbg !110
  %52 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %51), !dbg !111
  br label %53, !dbg !112

53:                                               ; preds = %42, %38
  %54 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !113
  ...
  %63 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !120
