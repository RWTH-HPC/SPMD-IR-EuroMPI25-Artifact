; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@11 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@12 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@13 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@14 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@15 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@16 = private unnamed_addr constant [95 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
...
42:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 32, i32 40, ptr @3), !dbg !104
  %45 = load i32, ptr %8, align 4, !dbg !104
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %45, i32 40, ptr @4), !dbg !105
  %47 = load i32, ptr %8, align 4, !dbg !106
  %48 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, i32 %47, i32 41, ptr @5), !dbg !107
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %51, i32 43, ptr @6), !dbg !111
  br label %53, !dbg !112

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 46, ptr @7), !dbg !113
  call void @parcoach_rma_load(ptr %6, i64 32, i32 49, ptr @8), !dbg !114
  %55 = load i32, ptr %6, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @9), !dbg !115
  %56 = load ptr, ptr %12, align 8, !dbg !115
  call void @parcoach_rma_load(ptr %56, i64 32, i32 50, ptr @10), !dbg !116
  %57 = load i32, ptr %56, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %11, i64 32, i32 51, ptr @11), !dbg !117
  %58 = load i32, ptr %11, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %9, i64 64, i32 52, ptr @12), !dbg !118
  %59 = load ptr, ptr %9, align 8, !dbg !118
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %60, i64 32, i32 52, ptr @13), !dbg !118
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 54, ptr @14), !dbg !120
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7a3b2d74cc10a888fe909a1d3e94ed85")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7a3b2d74cc10a888fe909a1d3e94ed85")
!19 = !{!20, !23, !24}
...
!104 = !DILocation(line: 40, column: 55, scope: !102)
!105 = !DILocation(line: 40, column: 9, scope: !102)
!106 = !DILocation(line: 41, column: 26, scope: !102)
!107 = !DILocation(line: 41, column: 9, scope: !102)
!108 = !DILocation(line: 42, column: 33, scope: !102)
!109 = !DILocation(line: 42, column: 9, scope: !102)
!110 = !DILocation(line: 43, column: 27, scope: !102)
!111 = !DILocation(line: 43, column: 9, scope: !102)
!112 = !DILocation(line: 44, column: 5, scope: !102)
!113 = !DILocation(line: 46, column: 5, scope: !35)
!114 = !DILocation(line: 49, column: 9, scope: !35)
!115 = !DILocation(line: 50, column: 10, scope: !35)
!116 = !DILocation(line: 50, column: 9, scope: !35)
!117 = !DILocation(line: 51, column: 9, scope: !35)
!118 = !DILocation(line: 52, column: 9, scope: !35)
!119 = !DILocation(line: 47, column: 5, scope: !35)
!120 = !DILocation(line: 54, column: 5, scope: !35)
!121 = !DILocation(line: 55, column: 5, scope: !35)
!122 = !DILocation(line: 57, column: 5, scope: !35)
