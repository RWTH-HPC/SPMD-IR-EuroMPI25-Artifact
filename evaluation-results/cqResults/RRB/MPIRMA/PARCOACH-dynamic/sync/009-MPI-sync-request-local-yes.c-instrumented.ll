; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@15 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@16 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
@17 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c\00", align 1
...
26:                                               ; preds = %22, %2
  %27 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 44, ptr @0), !dbg !98
...
36:                                               ; preds = %31
  call void @parcoach_rma_load(ptr %15, i64 32, i32 45, ptr @16), !dbg !112
  %37 = load i32, ptr %15, align 4, !dbg !112
  %38 = add nsw i32 %37, 1, !dbg !112
  call void @parcoach_rma_store(ptr %15, i64 32, i32 45, ptr @17), !dbg !112
  store i32 %38, ptr %15, align 4, !dbg !112
  br label %28, !dbg !113, !llvm.loop !114

39:                                               ; preds = %28
  %40 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 49, ptr @1), !dbg !117
  %41 = load ptr, ptr %8, align 8, !dbg !118
  %42 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %41, i32 51, ptr @2), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 52, ptr @3), !dbg !120
...
45:                                               ; preds = %39
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 55, ptr @4), !dbg !130
  ...
  call void @parcoach_rma_load(ptr %10, i64 32, i32 57, ptr @5), !dbg !132
...
51:                                               ; preds = %45, %39
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @6), !dbg !136
  %52 = load ptr, ptr %8, align 8, !dbg !136
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 61, ptr @7), !dbg !137
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @8), !dbg !138
  call void @parcoach_rma_load(ptr %6, i64 32, i32 66, ptr @9), !dbg !139
  %55 = load i32, ptr %6, align 4, !dbg !139
  call void @parcoach_rma_load(ptr %12, i64 64, i32 67, ptr @10), !dbg !140
  %56 = load ptr, ptr %12, align 8, !dbg !140
  call void @parcoach_rma_load(ptr %56, i64 32, i32 67, ptr @11), !dbg !141
  %57 = load i32, ptr %56, align 4, !dbg !141
  call void @parcoach_rma_load(ptr %11, i64 32, i32 68, ptr @12), !dbg !142
  %58 = load i32, ptr %11, align 4, !dbg !142
  call void @parcoach_rma_load(ptr %9, i64 64, i32 69, ptr @13), !dbg !143
  %59 = load ptr, ptr %9, align 8, !dbg !143
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !143
  call void @parcoach_rma_load(ptr %60, i64 32, i32 69, ptr @14), !dbg !143
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 71, ptr @15), !dbg !145
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1c105d3f9c3270b3b719f992a83ec1e2")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1c105d3f9c3270b3b719f992a83ec1e2")
!19 = !{!20, !24, !25, !28, !31}
