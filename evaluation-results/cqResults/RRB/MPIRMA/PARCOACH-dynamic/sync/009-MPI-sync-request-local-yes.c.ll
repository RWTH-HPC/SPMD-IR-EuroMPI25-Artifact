; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/009-MPI-sync-request-local-yes.c'
...
26:                                               ; preds = %22, %2
  %27 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %9, ptr noundef %8), !dbg !86
...
39:                                               ; preds = %28
  %40 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !105
  %41 = load i32, ptr %8, align 4, !dbg !106
  %42 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %41), !dbg !107
...
51:                                               ; preds = %45, %39
  ...
  %53 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %52), !dbg !123
  %54 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !124
  ...
  %63 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !131
