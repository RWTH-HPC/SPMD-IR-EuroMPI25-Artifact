; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c'
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @MPI_Win_unlock(i32 noundef 1, i32 noundef %47), !dbg !107
  %49 = load i32, ptr %10, align 4, !dbg !108
  %50 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %49), !dbg !109
  br label %51, !dbg !110

51:                                               ; preds = %42, %38
  %52 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !111
  ...
  %61 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !118
