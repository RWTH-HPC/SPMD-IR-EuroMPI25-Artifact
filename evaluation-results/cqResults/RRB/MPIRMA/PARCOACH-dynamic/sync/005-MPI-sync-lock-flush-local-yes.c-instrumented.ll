; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c"
...
@0 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@1 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@2 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@3 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@4 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@5 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@6 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@7 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@8 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@9 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@10 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@11 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@12 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@13 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@14 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@15 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@16 = private unnamed_addr constant [96 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @15), !dbg !91
  %36 = load i32, ptr %15, align 4, !dbg !91
  %37 = add nsw i32 %36, 1, !dbg !91
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @16), !dbg !91
...
38:                                               ; preds = %27
  ...
  %40 = load i32, ptr %6, align 4, !dbg !97
  %41 = icmp eq i32 %40, 0, !dbg !99
  br i1 %41, label %42, label %53, !dbg !100

42:                                               ; preds = %38
  %43 = load i32, ptr %8, align 4, !dbg !101
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 235, i32 1, i32 0, i32 %43, i32 39, ptr @2), !dbg !103
  call void @parcoach_rma_load(ptr %8, i64 32, i32 42, ptr @3), !dbg !104
  %45 = load i32, ptr %8, align 4, !dbg !104
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %45, i32 42, ptr @4), !dbg !105
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, i32 %49, i32 45, ptr @5), !dbg !109
  %51 = load i32, ptr %8, align 4, !dbg !110
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, i32 %51, i32 46, ptr @6), !dbg !111
  br label %53, !dbg !112

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 49, ptr @7), !dbg !113
  call void @parcoach_rma_load(ptr %6, i64 32, i32 52, ptr @8), !dbg !114
  %55 = load i32, ptr %6, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %12, i64 64, i32 53, ptr @9), !dbg !115
  %56 = load ptr, ptr %12, align 8, !dbg !115
  call void @parcoach_rma_load(ptr %56, i64 32, i32 53, ptr @10), !dbg !116
  %57 = load i32, ptr %56, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %11, i64 32, i32 54, ptr @11), !dbg !117
  %58 = load i32, ptr %11, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %9, i64 64, i32 55, ptr @12), !dbg !118
  %59 = load ptr, ptr %9, align 8, !dbg !118
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %60, i64 32, i32 55, ptr @13), !dbg !118
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 57, ptr @14), !dbg !120
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38678298a1fc0716206d647d32365721")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38678298a1fc0716206d647d32365721")
!19 = !{!20, !23, !24}
...
!97 = !DILocation(line: 38, column: 9, scope: !98)
!98 = distinct !DILexicalBlock(scope: !35, file: !2, line: 38, column: 9)
!99 = !DILocation(line: 38, column: 14, scope: !98)
!100 = !DILocation(line: 38, column: 9, scope: !35)
!101 = !DILocation(line: 39, column: 45, scope: !102)
!102 = distinct !DILexicalBlock(scope: !98, file: !2, line: 38, column: 20)
!103 = !DILocation(line: 39, column: 9, scope: !102)
!104 = !DILocation(line: 42, column: 55, scope: !102)
!105 = !DILocation(line: 42, column: 9, scope: !102)
!106 = !DILocation(line: 44, column: 33, scope: !102)
!107 = !DILocation(line: 44, column: 9, scope: !102)
!108 = !DILocation(line: 45, column: 26, scope: !102)
!109 = !DILocation(line: 45, column: 9, scope: !102)
!110 = !DILocation(line: 46, column: 27, scope: !102)
!111 = !DILocation(line: 46, column: 9, scope: !102)
!112 = !DILocation(line: 47, column: 5, scope: !102)
!113 = !DILocation(line: 49, column: 5, scope: !35)
!114 = !DILocation(line: 52, column: 9, scope: !35)
!115 = !DILocation(line: 53, column: 10, scope: !35)
!116 = !DILocation(line: 53, column: 9, scope: !35)
!117 = !DILocation(line: 54, column: 9, scope: !35)
!118 = !DILocation(line: 55, column: 9, scope: !35)
!119 = !DILocation(line: 50, column: 5, scope: !35)
!120 = !DILocation(line: 57, column: 5, scope: !35)
!121 = !DILocation(line: 58, column: 5, scope: !35)
!122 = !DILocation(line: 60, column: 5, scope: !35)
