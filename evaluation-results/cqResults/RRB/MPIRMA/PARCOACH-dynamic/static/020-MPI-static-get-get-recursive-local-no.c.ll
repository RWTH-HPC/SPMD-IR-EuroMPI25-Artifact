; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/static/020-MPI-static-get-get-recursive-local-no.c'
...
define dso_local void @inefficient_get(i32 noundef %0, ptr noundef %1, ptr noundef %2) #0 !dbg !36 {
  ...
  %14 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef %12, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %13), !dbg !56
...
21:                                               ; preds = %2
  ...
  %22 = call i32 @MPI_Win_allocate(i64 noundef 400, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !97
...
52:                                               ; preds = %51, %37
  ...
  %54 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %53), !dbg !144
...
60:                                               ; preds = %57, %52
  ...
  %62 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %61), !dbg !155
  %63 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !156
  ...
  %69 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !160
