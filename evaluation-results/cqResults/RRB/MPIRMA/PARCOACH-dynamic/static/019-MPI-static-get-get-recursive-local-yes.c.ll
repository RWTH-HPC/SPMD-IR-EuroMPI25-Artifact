; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/static/019-MPI-static-get-get-recursive-local-yes.c'
...
define dso_local void @inefficient_get(i32 noundef %0, ptr noundef %1, i32 noundef %2) #0 !dbg !30 {
  ...
  %11 = call i32 @MPI_Get(ptr noundef %7, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1, i64 noundef %9, i32 noundef 1, i32 noundef 1275069445, i32 noundef %10), !dbg !45
...
22:                                               ; preds = %18, %2
  ...
  %23 = call i32 @MPI_Win_allocate(i64 noundef 400, i32 noundef 4, i32 noundef 469762048, i32 noundef 1140850688, ptr noundef %9, ptr noundef %8), !dbg !87
...
53:                                               ; preds = %52, %38
  ...
  %55 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %54), !dbg !134
...
61:                                               ; preds = %58, %53
  ...
  %63 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %62), !dbg !145
  %64 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !146
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !150
