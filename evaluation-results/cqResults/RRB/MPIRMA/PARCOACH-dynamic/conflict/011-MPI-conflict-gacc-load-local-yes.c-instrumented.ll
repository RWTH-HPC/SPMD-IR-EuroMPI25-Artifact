; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @15), !dbg !92
  %36 = load i32, ptr %15, align 4, !dbg !92
  %37 = add nsw i32 %36, 1, !dbg !92
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @16), !dbg !92
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 39, ptr @3), !dbg !103
  %44 = load i32, ptr %8, align 4, !dbg !103
  %45 = call i32 @MPI_Get_accumulate(ptr noundef %11, i32 noundef 1, i32 noundef 1275069445, ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %44), !dbg !105
  call void @parcoach_rma_load(ptr %10, i64 32, i32 41, ptr @4), !dbg !106
  %46 = load i32, ptr %10, align 4, !dbg !106
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !107
  br label %48, !dbg !108

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @5), !dbg !109
  %49 = load i32, ptr %8, align 4, !dbg !109
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %49, i32 43, ptr @6), !dbg !110
  %51 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @7), !dbg !111
  ...
  call void @parcoach_rma_load(ptr %53, i64 32, i32 49, ptr @10), !dbg !114
  ...
  call void @parcoach_rma_load(ptr %57, i64 32, i32 51, ptr @13), !dbg !116
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !118
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "c3540d7650d14cc78fb97534e04fd349")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/011-MPI-conflict-gacc-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "c3540d7650d14cc78fb97534e04fd349")
!19 = !{!20, !23, !24, !25}
...
!103 = !DILocation(line: 39, column: 96, scope: !104)
