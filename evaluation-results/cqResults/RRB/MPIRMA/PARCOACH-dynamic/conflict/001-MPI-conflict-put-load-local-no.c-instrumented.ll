; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c"
...
@0 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@1 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@2 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@3 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@4 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@5 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@6 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@7 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@8 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@9 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@10 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@11 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@12 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@13 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@14 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@15 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@16 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@17 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 38, ptr @3), !dbg !111
  %44 = load ptr, ptr %8, align 8, !dbg !111
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 38, ptr @4), !dbg !113
  call void @parcoach_rma_load(ptr %10, i64 32, i32 39, ptr @5), !dbg !114
  %46 = load i32, ptr %10, align 4, !dbg !114
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !115
  br label %48, !dbg !116

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 41, ptr @6), !dbg !117
  %49 = load ptr, ptr %8, align 8, !dbg !117
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %49, i32 41, ptr @7), !dbg !118
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 43, ptr @8), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 46, ptr @9), !dbg !120
  %52 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %12, i64 64, i32 47, ptr @10), !dbg !121
  %53 = load ptr, ptr %12, align 8, !dbg !121
  call void @parcoach_rma_load(ptr %53, i64 32, i32 47, ptr @11), !dbg !122
  %54 = load i32, ptr %53, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 48, ptr @12), !dbg !123
  %55 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 49, ptr @13), !dbg !124
  %56 = load ptr, ptr %9, align 8, !dbg !124
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %57, i64 32, i32 49, ptr @14), !dbg !124
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 51, ptr @15), !dbg !126
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e1e06390b022fe269517ae7703d5cc0")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e1e06390b022fe269517ae7703d5cc0")
!19 = !{!20, !24, !25, !28}
...
!111 = !DILocation(line: 38, column: 55, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 37, column: 20)
!113 = !DILocation(line: 38, column: 9, scope: !112)
!114 = !DILocation(line: 39, column: 33, scope: !112)
!115 = !DILocation(line: 39, column: 9, scope: !112)
!116 = !DILocation(line: 40, column: 5, scope: !112)
!117 = !DILocation(line: 41, column: 22, scope: !41)
!118 = !DILocation(line: 41, column: 5, scope: !41)
!119 = !DILocation(line: 43, column: 5, scope: !41)
!120 = !DILocation(line: 46, column: 9, scope: !41)
!121 = !DILocation(line: 47, column: 10, scope: !41)
!122 = !DILocation(line: 47, column: 9, scope: !41)
!123 = !DILocation(line: 48, column: 9, scope: !41)
!124 = !DILocation(line: 49, column: 9, scope: !41)
!125 = !DILocation(line: 44, column: 5, scope: !41)
!126 = !DILocation(line: 51, column: 5, scope: !41)
