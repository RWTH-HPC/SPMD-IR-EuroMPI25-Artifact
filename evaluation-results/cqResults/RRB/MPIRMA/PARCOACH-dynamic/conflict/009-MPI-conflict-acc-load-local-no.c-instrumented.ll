; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c"
...
@0 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@1 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@2 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@3 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@4 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@5 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@6 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@7 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@8 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@9 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@10 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@11 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@12 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@13 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@14 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@15 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@16 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@17 = private unnamed_addr constant [101 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, i32 469762048, i32 1140850688, ptr %9, ptr %8, i32 31, ptr @0), !dbg !78
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @16), !dbg !92
  %36 = load i32, ptr %15, align 4, !dbg !92
  %37 = add nsw i32 %36, 1, !dbg !92
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @17), !dbg !92
  store i32 %37, ptr %15, align 4, !dbg !92
  br label %27, !dbg !93, !llvm.loop !94

38:                                               ; preds = %27
  %39 = load i32, ptr %8, align 4, !dbg !97
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %39, i32 36, ptr @1), !dbg !98
  call void @parcoach_rma_load(ptr %6, i64 32, i32 37, ptr @2), !dbg !99
  %41 = load i32, ptr %6, align 4, !dbg !99
  %42 = icmp eq i32 %41, 0, !dbg !101
  br i1 %42, label %43, label %48, !dbg !102

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 38, ptr @3), !dbg !103
  %44 = load i32, ptr %8, align 4, !dbg !103
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 1476395011, i32 %44, i32 38, ptr @4), !dbg !105
  call void @parcoach_rma_load(ptr %10, i64 32, i32 39, ptr @5), !dbg !106
  %46 = load i32, ptr %10, align 4, !dbg !106
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !107
  br label %48, !dbg !108

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 41, ptr @6), !dbg !109
  %49 = load i32, ptr %8, align 4, !dbg !109
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %49, i32 41, ptr @7), !dbg !110
  %51 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 43, ptr @8), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 46, ptr @9), !dbg !112
  %52 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %12, i64 64, i32 47, ptr @10), !dbg !113
  %53 = load ptr, ptr %12, align 8, !dbg !113
  call void @parcoach_rma_load(ptr %53, i64 32, i32 47, ptr @11), !dbg !114
  %54 = load i32, ptr %53, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %11, i64 32, i32 48, ptr @12), !dbg !115
  %55 = load i32, ptr %11, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %9, i64 64, i32 49, ptr @13), !dbg !116
  %56 = load ptr, ptr %9, align 8, !dbg !116
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %57, i64 32, i32 49, ptr @14), !dbg !116
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 51, ptr @15), !dbg !118
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f86e7acfa4f860876fab1e4d2db46f88")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f86e7acfa4f860876fab1e4d2db46f88")
!19 = !{!20, !23, !24, !25}
...
!103 = !DILocation(line: 38, column: 71, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !2, line: 37, column: 20)
!105 = !DILocation(line: 38, column: 9, scope: !104)
!106 = !DILocation(line: 39, column: 33, scope: !104)
!107 = !DILocation(line: 39, column: 9, scope: !104)
!108 = !DILocation(line: 40, column: 5, scope: !104)
!109 = !DILocation(line: 41, column: 22, scope: !36)
!110 = !DILocation(line: 41, column: 5, scope: !36)
!111 = !DILocation(line: 43, column: 5, scope: !36)
!112 = !DILocation(line: 46, column: 9, scope: !36)
!113 = !DILocation(line: 47, column: 10, scope: !36)
!114 = !DILocation(line: 47, column: 9, scope: !36)
!115 = !DILocation(line: 48, column: 9, scope: !36)
!116 = !DILocation(line: 49, column: 9, scope: !36)
!117 = !DILocation(line: 44, column: 5, scope: !36)
!118 = !DILocation(line: 51, column: 5, scope: !36)
!119 = !DILocation(line: 52, column: 5, scope: !36)
!120 = !DILocation(line: 54, column: 5, scope: !36)
