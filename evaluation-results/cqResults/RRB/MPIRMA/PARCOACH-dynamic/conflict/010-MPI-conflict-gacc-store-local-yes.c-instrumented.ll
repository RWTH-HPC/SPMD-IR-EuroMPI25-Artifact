; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c"
...
@0 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [104 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @MPI_Get_accumulate(ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, ptr noundef %11, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1476395011, i32 noundef %44), !dbg !100
  call void @parcoach_rma_store(ptr %10, i64 32, i32 41, ptr @4), !dbg !101
  store i32 42, ptr %10, align 4, !dbg !101
  br label %46, !dbg !102

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @5), !dbg !103
  %47 = load i32, ptr %8, align 4, !dbg !103
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %47, i32 43, ptr @6), !dbg !104
  %49 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @7), !dbg !105
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @8), !dbg !106
  %50 = load i32, ptr %6, align 4, !dbg !106
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !107
  %51 = load ptr, ptr %12, align 8, !dbg !107
  call void @parcoach_rma_load(ptr %51, i64 32, i32 49, ptr @10), !dbg !108
  %52 = load i32, ptr %51, align 4, !dbg !108
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @11), !dbg !109
  %53 = load i32, ptr %11, align 4, !dbg !109
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @12), !dbg !110
  %54 = load ptr, ptr %9, align 8, !dbg !110
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !110
  call void @parcoach_rma_load(ptr %55, i64 32, i32 51, ptr @13), !dbg !110
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !112
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5a9bd1c49c89bf88b83d7d2f358df0b1")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/010-MPI-conflict-gacc-store-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5a9bd1c49c89bf88b83d7d2f358df0b1")
!14 = !{!15, !18, !19, !20}
...
!98 = !DILocation(line: 39, column: 96, scope: !99)
