; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [103 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
...
38:                                               ; preds = %27
  ...
  br i1 %42, label %43, label %46, !dbg !96

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 39, ptr @3), !dbg !97
  %44 = load i32, ptr %8, align 4, !dbg !97
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %44, i32 39, ptr @4), !dbg !99
  call void @parcoach_rma_store(ptr %10, i64 32, i32 41, ptr @5), !dbg !100
  store i32 42, ptr %10, align 4, !dbg !100
  br label %46, !dbg !101

46:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @6), !dbg !102
  %47 = load i32, ptr %8, align 4, !dbg !102
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %47, i32 43, ptr @7), !dbg !103
  %49 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @8), !dbg !104
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @9), !dbg !105
  %50 = load i32, ptr %6, align 4, !dbg !105
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @10), !dbg !106
  %51 = load ptr, ptr %12, align 8, !dbg !106
  call void @parcoach_rma_load(ptr %51, i64 32, i32 49, ptr @11), !dbg !107
  %52 = load i32, ptr %51, align 4, !dbg !107
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @12), !dbg !108
  %53 = load i32, ptr %11, align 4, !dbg !108
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @13), !dbg !109
  %54 = load ptr, ptr %9, align 8, !dbg !109
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !109
  call void @parcoach_rma_load(ptr %55, i64 32, i32 51, ptr @14), !dbg !109
  %56 = load i32, ptr %55, align 4, !dbg !109
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %50, i32 noundef %52, i32 noundef %53, i32 noundef %56), !dbg !110
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @15), !dbg !111
  %59 = call i32 @MPI_Finalize(), !dbg !112
  ret i32 0, !dbg !113
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0b2165d9385be4c59153c5b35075a7f9")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "0b2165d9385be4c59153c5b35075a7f9")
!14 = !{!15, !18, !19}
...
!101 = !DILocation(line: 42, column: 5, scope: !98)
!102 = !DILocation(line: 43, column: 22, scope: !30)
!103 = !DILocation(line: 43, column: 5, scope: !30)
!104 = !DILocation(line: 45, column: 5, scope: !30)
!105 = !DILocation(line: 48, column: 9, scope: !30)
!106 = !DILocation(line: 49, column: 10, scope: !30)
!107 = !DILocation(line: 49, column: 9, scope: !30)
!108 = !DILocation(line: 50, column: 9, scope: !30)
!109 = !DILocation(line: 51, column: 9, scope: !30)
!110 = !DILocation(line: 46, column: 5, scope: !30)
!111 = !DILocation(line: 53, column: 5, scope: !30)
!112 = !DILocation(line: 54, column: 5, scope: !30)
!113 = !DILocation(line: 56, column: 5, scope: !30)
