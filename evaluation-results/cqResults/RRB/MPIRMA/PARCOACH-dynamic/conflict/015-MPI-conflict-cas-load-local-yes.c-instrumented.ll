; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c"
...
@0 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@17 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @16), !dbg !91
  %36 = load i32, ptr %15, align 4, !dbg !91
  %37 = add nsw i32 %36, 1, !dbg !91
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @17), !dbg !91
  store i32 %37, ptr %15, align 4, !dbg !91
  br label %27, !dbg !92, !llvm.loop !93

38:                                               ; preds = %27
  %39 = load i32, ptr %8, align 4, !dbg !96
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %39, i32 36, ptr @1), !dbg !97
  call void @parcoach_rma_load(ptr %6, i64 32, i32 37, ptr @2), !dbg !98
  %41 = load i32, ptr %6, align 4, !dbg !98
  %42 = icmp eq i32 %41, 0, !dbg !100
  br i1 %42, label %43, label %50, !dbg !101

43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %9, i64 64, i32 39, ptr @3), !dbg !102
  %44 = load ptr, ptr %9, align 8, !dbg !102
  %45 = getelementptr inbounds i32, ptr %44, i64 0, !dbg !102
  call void @parcoach_rma_load(ptr %8, i64 32, i32 39, ptr @4), !dbg !104
  %46 = load i32, ptr %8, align 4, !dbg !104
  %47 = call i32 @MPI_Compare_and_swap(ptr noundef %11, ptr noundef %45, ptr noundef %10, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef %46), !dbg !105
  call void @parcoach_rma_load(ptr %10, i64 32, i32 41, ptr @5), !dbg !106
  %48 = load i32, ptr %10, align 4, !dbg !106
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !107
  br label %50, !dbg !108

50:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @6), !dbg !109
  %51 = load i32, ptr %8, align 4, !dbg !109
  %52 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %51, i32 43, ptr @7), !dbg !110
  %53 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @8), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @9), !dbg !112
  %54 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @10), !dbg !113
  %55 = load ptr, ptr %12, align 8, !dbg !113
  call void @parcoach_rma_load(ptr %55, i64 32, i32 49, ptr @11), !dbg !114
  %56 = load i32, ptr %55, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @12), !dbg !115
  %57 = load i32, ptr %11, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @13), !dbg !116
  %58 = load ptr, ptr %9, align 8, !dbg !116
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %59, i64 32, i32 51, ptr @14), !dbg !116
  %60 = load i32, ptr %59, align 4, !dbg !116
  %61 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %54, i32 noundef %56, i32 noundef %57, i32 noundef %60), !dbg !117
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @15), !dbg !118
  %63 = call i32 @MPI_Finalize(), !dbg !119
  ret i32 0, !dbg !120
}
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "58d22a0fe08ef4c72e2a3bfcf2588239")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "58d22a0fe08ef4c72e2a3bfcf2588239")
!19 = !{!20, !23, !24}
...
!102 = !DILocation(line: 39, column: 40, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !2, line: 37, column: 20)
!104 = !DILocation(line: 39, column: 76, scope: !103)
!105 = !DILocation(line: 39, column: 9, scope: !103)
!106 = !DILocation(line: 41, column: 33, scope: !103)
!107 = !DILocation(line: 41, column: 9, scope: !103)
!108 = !DILocation(line: 42, column: 5, scope: !103)
!109 = !DILocation(line: 43, column: 22, scope: !35)
!110 = !DILocation(line: 43, column: 5, scope: !35)
!111 = !DILocation(line: 45, column: 5, scope: !35)
!112 = !DILocation(line: 48, column: 9, scope: !35)
!113 = !DILocation(line: 49, column: 10, scope: !35)
!114 = !DILocation(line: 49, column: 9, scope: !35)
!115 = !DILocation(line: 50, column: 9, scope: !35)
!116 = !DILocation(line: 51, column: 9, scope: !35)
!117 = !DILocation(line: 46, column: 5, scope: !35)
!118 = !DILocation(line: 53, column: 5, scope: !35)
!119 = !DILocation(line: 54, column: 5, scope: !35)
