; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c"
...
@0 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@17 = private unnamed_addr constant [102 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 39, ptr @3), !dbg !102
  %44 = load i32, ptr %8, align 4, !dbg !102
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %44, i32 39, ptr @4), !dbg !104
  call void @parcoach_rma_load(ptr %10, i64 32, i32 41, ptr @5), !dbg !105
  %46 = load i32, ptr %10, align 4, !dbg !105
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !106
  br label %48, !dbg !107

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 43, ptr @6), !dbg !108
  %49 = load i32, ptr %8, align 4, !dbg !108
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %49, i32 43, ptr @7), !dbg !109
  %51 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 45, ptr @8), !dbg !110
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @9), !dbg !111
  %52 = load i32, ptr %6, align 4, !dbg !111
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @10), !dbg !112
  %53 = load ptr, ptr %12, align 8, !dbg !112
  call void @parcoach_rma_load(ptr %53, i64 32, i32 49, ptr @11), !dbg !113
  %54 = load i32, ptr %53, align 4, !dbg !113
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @12), !dbg !114
  %55 = load i32, ptr %11, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @13), !dbg !115
  %56 = load ptr, ptr %9, align 8, !dbg !115
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !115
  call void @parcoach_rma_load(ptr %57, i64 32, i32 51, ptr @14), !dbg !115
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @15), !dbg !117
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "65b528987e713500edff80285d455c6d")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/004-MPI-conflict-get-load-local-yes.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "65b528987e713500edff80285d455c6d")
!19 = !{!20, !23, !24}
