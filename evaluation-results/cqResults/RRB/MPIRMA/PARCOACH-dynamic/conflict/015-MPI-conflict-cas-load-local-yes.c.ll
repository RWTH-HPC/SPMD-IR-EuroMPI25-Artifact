; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c'
...
50:                                               ; preds = %43, %38
  ...
  %52 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %51), !dbg !110
  %53 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !111
  ...
  %62 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !118
