; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-dynamic/dynamic/001-MPI-dynamic-put-store-impossible-local-yes.c'
...
55:                                               ; preds = %52
  ...
  %57 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, i32 noundef 1275069445, i32 noundef 1, i64 noundef 0, i32 noundef 1, i32 noundef 1275069445, i32 noundef %56), !dbg !113
  store i32 42, ptr %10, align 4, !dbg !114
  br label %58, !dbg !115

58:                                               ; preds = %55, %52, %47
  %59 = load i32, ptr %8, align 4, !dbg !116
  %60 = call i32 @MPI_Win_fence(i32 noundef 0, i32 noundef %59), !dbg !117
  %61 = call i32 @MPI_Barrier(i32 noundef 1140850688), !dbg !118
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !125
