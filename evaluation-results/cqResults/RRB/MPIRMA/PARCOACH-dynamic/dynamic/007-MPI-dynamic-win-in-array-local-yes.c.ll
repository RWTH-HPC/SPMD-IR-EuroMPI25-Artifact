; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/dynamic/007-MPI-dynamic-win-in-array-local-yes.c'
...
64:                                               ; preds = %55
  ...
  %78 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %77), !dbg !126
  ...
  %89 = call i32 @MPI_Get(ptr noundef %79, i32 noundef %80, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef %82, i32 noundef %83, ptr noundef @ompi_mpi_int, ptr noundef %88), !dbg !134
  br label %96, !dbg !135
...
90:                                               ; preds = %55
  ...
  %95 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %94), !dbg !139
  br label %96

96:                                               ; preds = %90, %64
  %97 = getelementptr inbounds [2 x ptr], ptr %13, i64 0, i64 0, !dbg !140
  %98 = load ptr, ptr %97, align 16, !dbg !140
  %99 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %98), !dbg !141
  %100 = getelementptr inbounds [2 x ptr], ptr %13, i64 0, i64 1, !dbg !142
  %101 = load ptr, ptr %100, align 8, !dbg !142
  %102 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %101), !dbg !143
  %103 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !144
