; ModuleID = '/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c"
...
@0 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@1 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@2 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@3 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@4 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@5 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@6 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@7 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@8 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@9 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@10 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@11 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@12 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@13 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@14 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@15 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@16 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
@17 = private unnamed_addr constant [97 x i8] c"cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 32, i32 38, ptr @3), !dbg !106
  %44 = load i32, ptr %8, align 4, !dbg !106
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, i32 1275069445, i32 1, i64 0, i32 1, i32 1275069445, i32 %44, i32 38, ptr @4), !dbg !108
...
47:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %6, i64 32, i32 41, ptr @5), !dbg !111
...
52:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 32, i32 44, ptr @6), !dbg !118
  %53 = load i32, ptr %8, align 4, !dbg !118
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, i32 %53, i32 44, ptr @7), !dbg !119
  %55 = call i32 @parcoach_rma_MPI_Barrier(i32 1140850688, i32 46, ptr @8), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 49, ptr @9), !dbg !121
  %56 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @10), !dbg !122
  %57 = load ptr, ptr %12, align 8, !dbg !122
  call void @parcoach_rma_load(ptr %57, i64 32, i32 50, ptr @11), !dbg !123
  %58 = load i32, ptr %57, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 51, ptr @12), !dbg !124
  %59 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 52, ptr @13), !dbg !125
  %60 = load ptr, ptr %9, align 8, !dbg !125
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %61, i64 32, i32 52, ptr @14), !dbg !125
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 54, ptr @15), !dbg !127
...
!2 = !DIFile(filename: "cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e2b6eaa45bcebfc59044a0a8c50f92b")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/MPIRMA/PARCOACH-static/rma+nonrma/002-MPI-p2p-put-send-local-no.c", directory: "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7e2b6eaa45bcebfc59044a0a8c50f92b")
!14 = !{!15, !18, !19, !20}
