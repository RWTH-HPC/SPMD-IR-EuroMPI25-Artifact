...
#di_file = #llvm.di_file<"/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/SHMEM/SPMDIR/dynamic/003-shmem-dynamic-while-local-no.c" in "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite">
#di_file1 = #llvm.di_file<"cq-results-20250731-154348/RRB/SHMEM/SPMDIR/dynamic/003-shmem-dynamic-while-local-no.c" in "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
#di_global_variable1 = #llvm.di_global_variable<file = #di_file1, line = 45, type = #di_composite_type1, isLocalToUnit = true, isDefined = true>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = [["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    scf.if %10 {
      ...
      scf.if %13 {
        %19 = scf.while (%arg2 = %8) : (i32) -> i32 {
          %20 = arith.addi %arg2, %c-6_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
          %21 = arith.remsi %20, %c3_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
          %22 = arith.cmpi slt, %21, %c2_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
          %23 = llvm.load %6 {alignment = 4 : i64, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : !llvm.ptr -> i32
          %24 = arith.cmpi slt, %23, %c9999_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
          %25 = arith.select %22, %24, %false {fastmathFlags = #llvm.fastmath<none>, spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i1
          scf.condition(%25) {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %arg2 : i32
        } do {
        ^bb0(%arg2: i32):
          %20 = arith.addi %arg2, %c-1_i32 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : i32
          ...
          %21 = "spmd.flushAll"() <{isLocal = false, usedModel = 1 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : () -> !spmd.error
          scf.yield {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} %20 : i32
