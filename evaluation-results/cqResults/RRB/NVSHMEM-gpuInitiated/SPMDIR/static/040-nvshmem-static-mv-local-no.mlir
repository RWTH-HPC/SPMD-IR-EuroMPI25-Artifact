...
#di_file = #llvm.di_file<"cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu" in "/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.mlir.global private constant @mlir.llvm.nameless_global_1("#di_file = #llvm.di_file<\22/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22 in \22/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite\22>\0A#di_file1 = #llvm.di_file<\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22 in \22/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite\22>\0A#di_subroutine_type = #llvm.di_subroutine_type<>\0A#loc1 = loc(\22nvshmem_kernel\22)\0A#loc2 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:14:0)\0A#tbaa_root = #llvm.tbaa_root<id = \22Simple C++ TBAA\22>\0A#di_compile_unit = #llvm.di_compile_unit<id = distinct[0]<>, sourceLanguage = DW_LANG_C_plus_plus_14, file = #di_file, producer = \22clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)\22, isOptimized = true, emissionKind = DebugDirectivesOnly, nameTableKind = None>\0A#di_subprogram = #llvm.di_subprogram<id = distinct[1]<>, compileUnit = #di_compile_unit, scope = #di_file1, name = \22nvshmem_kernel\22, file = #di_file1, line = 14, scopeLine = 14, subprogramFlags = \22Definition|Optimized\22, type = #di_subroutine_type>\0A#tbaa_type_desc = #llvm.tbaa_type_desc<id = \22omnipotent char\22, members = {<#tbaa_root, 0>}>\0A#loc17 = loc(fused<#di_subprogram>[#loc1, #loc2])\0A#tbaa_type_desc1 = #llvm.tbaa_type_desc<id = \22int\22, members = {<#tbaa_type_desc, 0>}>\0A#tbaa_tag = #llvm.tbaa_tag<base_type = #tbaa_type_desc1, access_type = #tbaa_type_desc1, offset = 0>\0Amodule attributes {dlti.dl_spec = #dlti.dl_spec<i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, \22dlti.endianness\22 = \22little\22>, llvm.data_layout = \22e-i64:64-i128:128-v16:16-v32:32-n16:32:64\22, llvm.target_triple = \22nvptx64-nvidia-cuda\22} {\0A  llvm.mlir.global private unnamed_addr constant @\22.str\22(\22PE: %d\\0A\\00\22) {addr_space = 0 : i32, alignment = 1 : i64, dso_local} loc(#loc)\0A  llvm.func local_unnamed_addr ptx_kernelcc @_Z14nvshmem_kernelPiS_(%arg0: !llvm.ptr {llvm.noundef} loc(fused<#di_subprogram>[#loc1, #loc2]), %arg1: !llvm.ptr {llvm.noundef} loc(fused<#di_subprogram>[#loc1, #loc2])) attributes {convergent, frame_pointer = #llvm.framePointerKind<all>, no_unwind, passthrough = [\22mustprogress\22, \22norecurse\22, [\22no-trapping-math\22, \22true\22], [\22stack-protector-buffer-size\22, \228\22], [\22target-cpu\22, \22sm_89\22], [\22uniform-work-group-size\22, \22true\22]], target_cpu = \22sm_89\22, target_features = #llvm.target_features<[\22+ptx78\22, \22+sm_89\22]>} {\0A    %c1_i32 = arith.constant 1 : i32 loc(#loc3)\0A    %c0_i32 = arith.constant 0 : i32 loc(#loc3)\0A    %c1_i64 = arith.constant 1 : i64 loc(#loc3)\0A    %0 = llvm.mlir.addressof @\22.str\22 : !llvm.ptr loc(#loc3)\0A    %c2_i32 = arith.constant 2 : i32 loc(#loc3)\0A    %1 = llvm.alloca %c1_i32 x !llvm.struct<\22printf_args\22, (i32)> {alignment = 8 : i64} : (i32) -> !llvm.ptr loc(#loc3)\0A    llvm.store %c0_i32, %arg0 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : i32, !llvm.ptr loc(#loc18)\0A    llvm.store %c1_i32, %arg1 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : i32, !llvm.ptr loc(#loc19)\0A    %2 = llvm.call tail @nvshmem_my_pe() {convergent, no_unwind} : () -> i32 loc(#loc20)\0A    llvm.call tail @nvshmem_barrier_all() {convergent, no_unwind} : () -> () loc(#loc21)\0A    %3 = arith.cmpi eq, %2, %c0_i32 : i32 loc(#loc22)\0A    cf.cond_br %3, ^bb1, ^bb2 loc(#loc22)\0A  ^bb1:  // pred: ^bb0\0A    llvm.call tail @nvshmem_int_put_nbi(%arg0, %arg1, %c1_i64, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, i32) -> () loc(#loc23)\0A    cf.br ^bb2 loc(#loc24)\0A  ^bb2:  // 2 preds: ^bb0, ^bb1\0A    llvm.store %2, %1 {alignment = 8 : i64} : i32, !llvm.ptr loc(#loc25)\0A    %4 = llvm.call @vprintf(%0, %1) {no_unwind} : (!llvm.ptr, !llvm.ptr) -> i32 loc(#loc25)\0A    %5 = arith.cmpi eq, %2, %c1_i32 : i32 loc(#loc26)\0A    cf.cond_br %5, ^bb3, ^bb4 loc(#loc26)\0A  ^bb3:  // pred: ^bb2\0A    llvm.store %c2_i32, %arg1 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : i32, !llvm.ptr loc(#loc27)\0A    cf.br ^bb4 loc(#loc28)\0A  ^bb4:  // 2 preds: ^bb2, ^bb3\0A    llvm.call @nvshmem_barrier_all() {convergent, no_unwind} : () -> () loc(#loc29)\0A    llvm.return loc(#loc30)\0A  } loc(#loc17)\0A  llvm.func local_unnamed_addr @nvshmem_my_pe() -> i32 attributes {convergent, frame_pointer = #llvm.framePointerKind<all>, no_unwind, passthrough = [[\22no-trapping-math\22, \22true\22], [\22stack-protector-buffer-size\22, \228\22], [\22target-cpu\22, \22sm_89\22]], target_cpu = \22sm_89\22, target_features = #llvm.target_features<[\22+ptx78\22, \22+sm_89\22]>} loc(#loc3)\0A  llvm.func local_unnamed_addr @nvshmem_barrier_all() attributes {convergent, frame_pointer = #llvm.framePointerKind<all>, no_unwind, passthrough = [[\22no-trapping-math\22, \22true\22], [\22stack-protector-buffer-size\22, \228\22], [\22target-cpu\22, \22sm_89\22]], target_cpu = \22sm_89\22, target_features = #llvm.target_features<[\22+ptx78\22, \22+sm_89\22]>} loc(#loc3)\0A  llvm.func local_unnamed_addr @nvshmem_int_put_nbi(!llvm.ptr {llvm.noundef}, !llvm.ptr {llvm.noundef}, i64 {llvm.noundef}, i32 {llvm.noundef}) attributes {convergent, frame_pointer = #llvm.framePointerKind<all>, no_unwind, passthrough = [[\22no-trapping-math\22, \22true\22], [\22stack-protector-buffer-size\22, \228\22], [\22target-cpu\22, \22sm_89\22]], target_cpu = \22sm_89\22, target_features = #llvm.target_features<[\22+ptx78\22, \22+sm_89\22]>} loc(#loc3)\0A  llvm.func local_unnamed_addr @vprintf(!llvm.ptr, !llvm.ptr) -> i32 loc(#loc3)\0A} loc(#loc)\0A#loc = loc(\22/rwthfs/rz/cluster/work/rwth1282/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:0:0)\0A#loc3 = loc(unknown)\0A#loc4 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:16:13)\0A#loc5 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:17:15)\0A#loc6 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:19:17)\0A#loc7 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:22:5)\0A#loc8 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:24:15)\0A#loc9 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:25:9)\0A#loc10 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:26:5)\0A#loc11 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:28:5)\0A#loc12 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:30:15)\0A#loc13 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:31:19)\0A#loc14 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:32:5)\0A#loc15 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:35:5)\0A#loc16 = loc(\22cq-results-20250731-154348/RRB/NVSHMEM-gpuInitiated/SPMDIR/static/040-nvshmem-static-mv-local-no.cu\22:36:1)\0A#loc18 = loc(fused<#di_subprogram>[#loc4])\0A#loc19 = loc(fused<#di_subprogram>[#loc5])\0A#loc20 = loc(fused<#di_subprogram>[#loc6])\0A#loc21 = loc(fused<#di_subprogram>[#loc7])\0A#loc22 = loc(fused<#di_subprogram>[#loc8])\0A#loc23 = loc(fused<#di_subprogram>[#loc9])\0A#loc24 = loc(fused<#di_subprogram>[#loc10])\0A#loc25 = loc(fused<#di_subprogram>[#loc11])\0A#loc26 = loc(fused<#di_subprogram>[#loc12])\0A#loc27 = loc(fused<#di_subprogram>[#loc13])\0A#loc28 = loc(fused<#di_subprogram>[#loc14])\0A#loc29 = loc(fused<#di_subprogram>[#loc15])\0A#loc30 = loc(fused<#di_subprogram>[#loc16])\0A\00") {addr_space = 0 : i32, alignment = 8 : i64, dso_local, section = ".nv_fatbin", spmd.executionKind = "All"}
  ...
  llvm.func local_unnamed_addr @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readnone}) -> (i32 {llvm.noundef}) attributes {no_unwind, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], spmd.executionKind = "All", target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %19 = llvm.alloca %c1_i32 x !llvm.struct<"printf_args", (i32)> {alignment = 8 : i64, spmd.executionKind = "All"} : (i32) -> !llvm.ptr
    ...
    llvm.store %rank_6, %19 {alignment = 8 : i64, spmd.executionKind = "All"} : i32, !llvm.ptr
    %22 = llvm.call @vprintf(%5, %19) {no_unwind, spmd.executionKind = "All"} : (!llvm.ptr, !llvm.ptr) -> i32
    %23 = arith.cmpi eq, %rank_6, %c1_i32 {spmd.executionKind = "All"} : i32
    scf.if %23 {
      llvm.store %c2_i32, %address_4 {alignment = 4 : i64, spmd.executedBy = array<i32: 1>, spmd.executionKind = "Static", tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    } {spmd.executionKind = "All", spmd.isMultiValued = true}
