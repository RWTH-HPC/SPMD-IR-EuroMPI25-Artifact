; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c"
...
@0 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
@17 = private unnamed_addr constant [99 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c\00", align 1
...
44:                                               ; preds = %39
  %45 = call i32 @MPI_Isend(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %16), !dbg !123
  %46 = call i32 @MPI_Wait(ptr noundef %16, ptr noundef null), !dbg !125
  call void @parcoach_rma_load(ptr %8, i64 64, i32 41, ptr @3), !dbg !126
  %47 = load ptr, ptr %8, align 8, !dbg !126
  %48 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %47, i32 41, ptr @4), !dbg !127
  br label %49, !dbg !128

49:                                               ; preds = %44, %39
  call void @parcoach_rma_load(ptr %6, i64 32, i32 43, ptr @5), !dbg !129
  %50 = load i32, ptr %6, align 4, !dbg !129
  %51 = icmp eq i32 %50, 1, !dbg !131
  br i1 %51, label %52, label %54, !dbg !132

52:                                               ; preds = %49
  %53 = call i32 @MPI_Recv(ptr noundef %11, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef -1, ptr noundef @ompi_mpi_comm_world, ptr noundef null), !dbg !133
  br label %54, !dbg !135

54:                                               ; preds = %52, %49
  call void @parcoach_rma_load(ptr %8, i64 64, i32 46, ptr @6), !dbg !136
  %55 = load ptr, ptr %8, align 8, !dbg !136
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %55, i32 46, ptr @7), !dbg !137
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 48, ptr @8), !dbg !138
  call void @parcoach_rma_load(ptr %6, i64 32, i32 51, ptr @9), !dbg !139
  %58 = load i32, ptr %6, align 4, !dbg !139
  call void @parcoach_rma_load(ptr %12, i64 64, i32 52, ptr @10), !dbg !140
  %59 = load ptr, ptr %12, align 8, !dbg !140
  call void @parcoach_rma_load(ptr %59, i64 32, i32 52, ptr @11), !dbg !141
  %60 = load i32, ptr %59, align 4, !dbg !141
  call void @parcoach_rma_load(ptr %11, i64 32, i32 53, ptr @12), !dbg !142
  %61 = load i32, ptr %11, align 4, !dbg !142
  call void @parcoach_rma_load(ptr %9, i64 64, i32 54, ptr @13), !dbg !143
  %62 = load ptr, ptr %9, align 8, !dbg !143
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !143
  call void @parcoach_rma_load(ptr %63, i64 32, i32 54, ptr @14), !dbg !143
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 56, ptr @15), !dbg !145
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "22d2e3c71c35aaae03bcce96a9badb15")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/rma+nonrma/004-MPI-p2p-get-isend-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "22d2e3c71c35aaae03bcce96a9badb15")
!14 = !{!15, !19, !20, !23, !26}
...
!126 = !DILocation(line: 41, column: 55, scope: !124)
!127 = !DILocation(line: 41, column: 9, scope: !124)
!128 = !DILocation(line: 42, column: 5, scope: !124)
!129 = !DILocation(line: 43, column: 9, scope: !130)
!130 = distinct !DILexicalBlock(scope: !49, file: !2, line: 43, column: 9)
!131 = !DILocation(line: 43, column: 14, scope: !130)
!132 = !DILocation(line: 43, column: 9, scope: !49)
!133 = !DILocation(line: 44, column: 9, scope: !134)
!134 = distinct !DILexicalBlock(scope: !130, file: !2, line: 43, column: 20)
!135 = !DILocation(line: 45, column: 5, scope: !134)
!136 = !DILocation(line: 46, column: 22, scope: !49)
!137 = !DILocation(line: 46, column: 5, scope: !49)
!138 = !DILocation(line: 48, column: 5, scope: !49)
!139 = !DILocation(line: 51, column: 9, scope: !49)
!140 = !DILocation(line: 52, column: 10, scope: !49)
!141 = !DILocation(line: 52, column: 9, scope: !49)
!142 = !DILocation(line: 53, column: 9, scope: !49)
!143 = !DILocation(line: 54, column: 9, scope: !49)
!144 = !DILocation(line: 49, column: 5, scope: !49)
!145 = !DILocation(line: 56, column: 5, scope: !49)
!146 = !DILocation(line: 57, column: 5, scope: !49)
!147 = !DILocation(line: 59, column: 5, scope: !49)
