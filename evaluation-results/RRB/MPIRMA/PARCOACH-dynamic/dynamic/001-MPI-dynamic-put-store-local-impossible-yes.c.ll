; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/dynamic/001-MPI-dynamic-put-store-local-impossible-yes.c'
...
55:                                               ; preds = %52
  ...
  %57 = call i32 @MPI_Put(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %56), !dbg !122
  store i32 42, ptr %10, align 4, !dbg !123
  br label %58, !dbg !124

58:                                               ; preds = %55, %52, %47
  %59 = load ptr, ptr %8, align 8, !dbg !125
  %60 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %59), !dbg !126
  %61 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !127
  ...
  %70 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !134
