; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/dynamic/006-MPI-dynamic-get-loop-local-no.c'
...
35:                                               ; preds = %31, %25
  %36 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !92
...
48:                                               ; preds = %37
  ...
  %50 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %49), !dbg !112
...
58:                                               ; preds = %54
  ...
  %60 = call i32 @MPI_Get(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef %59), !dbg !129
  %61 = load ptr, ptr %8, align 8, !dbg !130
  %62 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %61), !dbg !131
  br label %63, !dbg !132
...
67:                                               ; preds = %66, %48
  ...
  %69 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %68), !dbg !139
  %70 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !140
  ...
  %79 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !147
