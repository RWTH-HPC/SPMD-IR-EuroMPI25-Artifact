; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c"
...
@0 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@1 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@2 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@3 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@4 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@5 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@6 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@7 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@8 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@9 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@10 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@11 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@12 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@13 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@14 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@15 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@16 = private unnamed_addr constant [96 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
...
42:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 42, ptr @3), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 42, ptr @4), !dbg !114
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %49, i32 45, ptr @5), !dbg !118
  %51 = load ptr, ptr %8, align 8, !dbg !119
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %51, i32 46, ptr @6), !dbg !120
  br label %53, !dbg !121

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 49, ptr @7), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 52, ptr @8), !dbg !123
  %55 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 53, ptr @9), !dbg !124
  %56 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %56, i64 32, i32 53, ptr @10), !dbg !125
  %57 = load i32, ptr %56, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 54, ptr @11), !dbg !126
  %58 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 55, ptr @12), !dbg !127
  %59 = load ptr, ptr %9, align 8, !dbg !127
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %60, i64 32, i32 55, ptr @13), !dbg !127
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 57, ptr @14), !dbg !129
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38678298a1fc0716206d647d32365721")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "38678298a1fc0716206d647d32365721")
!19 = !{!20, !24, !25, !28}
...
!113 = !DILocation(line: 42, column: 55, scope: !111)
!114 = !DILocation(line: 42, column: 9, scope: !111)
!115 = !DILocation(line: 44, column: 33, scope: !111)
!116 = !DILocation(line: 44, column: 9, scope: !111)
!117 = !DILocation(line: 45, column: 26, scope: !111)
!118 = !DILocation(line: 45, column: 9, scope: !111)
!119 = !DILocation(line: 46, column: 27, scope: !111)
!120 = !DILocation(line: 46, column: 9, scope: !111)
!121 = !DILocation(line: 47, column: 5, scope: !111)
!122 = !DILocation(line: 49, column: 5, scope: !41)
!123 = !DILocation(line: 52, column: 9, scope: !41)
!124 = !DILocation(line: 53, column: 10, scope: !41)
!125 = !DILocation(line: 53, column: 9, scope: !41)
!126 = !DILocation(line: 54, column: 9, scope: !41)
!127 = !DILocation(line: 55, column: 9, scope: !41)
!128 = !DILocation(line: 50, column: 5, scope: !41)
!129 = !DILocation(line: 57, column: 5, scope: !41)
!130 = !DILocation(line: 58, column: 5, scope: !41)
!131 = !DILocation(line: 60, column: 5, scope: !41)
