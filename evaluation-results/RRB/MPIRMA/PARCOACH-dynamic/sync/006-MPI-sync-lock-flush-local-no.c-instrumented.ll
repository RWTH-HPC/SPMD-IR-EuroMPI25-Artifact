; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@11 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@12 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@13 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@14 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@15 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@16 = private unnamed_addr constant [95 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @15), !dbg !100
  %36 = load i32, ptr %15, align 4, !dbg !100
  %37 = add nsw i32 %36, 1, !dbg !100
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @16), !dbg !100
...
38:                                               ; preds = %27
  ...
  br i1 %41, label %42, label %53, !dbg !109

42:                                               ; preds = %38
  %43 = load ptr, ptr %8, align 8, !dbg !110
  %44 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %43, i32 39, ptr @2), !dbg !112
  call void @parcoach_rma_load(ptr %8, i64 64, i32 40, ptr @3), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 40, ptr @4), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !115
  %48 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %47, i32 41, ptr @5), !dbg !116
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %51, i32 43, ptr @6), !dbg !120
  br label %53, !dbg !121

53:                                               ; preds = %42, %38
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 46, ptr @7), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 49, ptr @8), !dbg !123
  %55 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @9), !dbg !124
  %56 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %56, i64 32, i32 50, ptr @10), !dbg !125
  %57 = load i32, ptr %56, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 51, ptr @11), !dbg !126
  %58 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 52, ptr @12), !dbg !127
  %59 = load ptr, ptr %9, align 8, !dbg !127
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %60, i64 32, i32 52, ptr @13), !dbg !127
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 54, ptr @14), !dbg !129
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7a3b2d74cc10a888fe909a1d3e94ed85")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "7a3b2d74cc10a888fe909a1d3e94ed85")
!19 = !{!20, !24, !25, !28}
...
!107 = distinct !DILexicalBlock(scope: !41, file: !2, line: 38, column: 9)
!108 = !DILocation(line: 38, column: 14, scope: !107)
!109 = !DILocation(line: 38, column: 9, scope: !41)
!110 = !DILocation(line: 39, column: 45, scope: !111)
!111 = distinct !DILexicalBlock(scope: !107, file: !2, line: 38, column: 20)
!112 = !DILocation(line: 39, column: 9, scope: !111)
!113 = !DILocation(line: 40, column: 55, scope: !111)
!114 = !DILocation(line: 40, column: 9, scope: !111)
!115 = !DILocation(line: 41, column: 26, scope: !111)
!116 = !DILocation(line: 41, column: 9, scope: !111)
!117 = !DILocation(line: 42, column: 33, scope: !111)
!118 = !DILocation(line: 42, column: 9, scope: !111)
!119 = !DILocation(line: 43, column: 27, scope: !111)
!120 = !DILocation(line: 43, column: 9, scope: !111)
!121 = !DILocation(line: 44, column: 5, scope: !111)
!122 = !DILocation(line: 46, column: 5, scope: !41)
!123 = !DILocation(line: 49, column: 9, scope: !41)
!124 = !DILocation(line: 50, column: 10, scope: !41)
!125 = !DILocation(line: 50, column: 9, scope: !41)
!126 = !DILocation(line: 51, column: 9, scope: !41)
!127 = !DILocation(line: 52, column: 9, scope: !41)
!128 = !DILocation(line: 47, column: 5, scope: !41)
!129 = !DILocation(line: 54, column: 5, scope: !41)
!130 = !DILocation(line: 55, column: 5, scope: !41)
!131 = !DILocation(line: 57, column: 5, scope: !41)
