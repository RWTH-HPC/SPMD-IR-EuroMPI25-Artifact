; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c"
...
@0 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@1 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@2 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@3 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@4 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@5 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@6 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@7 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@8 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@9 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@10 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@11 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@12 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@13 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@14 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@15 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@16 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@17 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@18 = private unnamed_addr constant [91 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @17), !dbg !95
  %36 = load i32, ptr %15, align 4, !dbg !95
  %37 = add nsw i32 %36, 1, !dbg !95
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @18), !dbg !95
  store i32 %37, ptr %15, align 4, !dbg !95
  br label %27, !dbg !96, !llvm.loop !97

38:                                               ; preds = %27
  %39 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 36, ptr @1), !dbg !100
  %40 = load ptr, ptr %8, align 8, !dbg !101
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %40, i32 38, ptr @2), !dbg !102
  call void @parcoach_rma_load(ptr %6, i64 32, i32 39, ptr @3), !dbg !103
  %42 = load i32, ptr %6, align 4, !dbg !103
  %43 = icmp eq i32 %42, 0, !dbg !105
  br i1 %43, label %44, label %47, !dbg !106

44:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 42, ptr @4), !dbg !107
  %45 = load ptr, ptr %8, align 8, !dbg !107
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 42, ptr @5), !dbg !109
  call void @parcoach_rma_store(ptr %10, i64 32, i32 44, ptr @6), !dbg !110
  store i32 42, ptr %10, align 4, !dbg !110
  br label %47, !dbg !111

47:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 46, ptr @7), !dbg !112
  %48 = load ptr, ptr %8, align 8, !dbg !112
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 46, ptr @8), !dbg !113
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 48, ptr @9), !dbg !114
  call void @parcoach_rma_load(ptr %6, i64 32, i32 51, ptr @10), !dbg !115
  %51 = load i32, ptr %6, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 52, ptr @11), !dbg !116
  %52 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %52, i64 32, i32 52, ptr @12), !dbg !117
  %53 = load i32, ptr %52, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %11, i64 32, i32 53, ptr @13), !dbg !118
  %54 = load i32, ptr %11, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 54, ptr @14), !dbg !119
  %55 = load ptr, ptr %9, align 8, !dbg !119
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %56, i64 32, i32 54, ptr @15), !dbg !119
  %57 = load i32, ptr %56, align 4, !dbg !119
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51, i32 noundef %53, i32 noundef %54, i32 noundef %57), !dbg !120
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 56, ptr @16), !dbg !121
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1e8c98e4f7e6094192fe7c3df97c659f")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1e8c98e4f7e6094192fe7c3df97c659f")
!14 = !{!15, !19, !20, !23}
...
!100 = !DILocation(line: 36, column: 5, scope: !36)
!101 = !DILocation(line: 38, column: 22, scope: !36)
!102 = !DILocation(line: 38, column: 5, scope: !36)
!103 = !DILocation(line: 39, column: 9, scope: !104)
!104 = distinct !DILexicalBlock(scope: !36, file: !2, line: 39, column: 9)
!105 = !DILocation(line: 39, column: 14, scope: !104)
!106 = !DILocation(line: 39, column: 9, scope: !36)
!107 = !DILocation(line: 42, column: 55, scope: !108)
!108 = distinct !DILexicalBlock(scope: !104, file: !2, line: 39, column: 20)
!109 = !DILocation(line: 42, column: 9, scope: !108)
!110 = !DILocation(line: 44, column: 15, scope: !108)
!111 = !DILocation(line: 45, column: 5, scope: !108)
!112 = !DILocation(line: 46, column: 22, scope: !36)
!113 = !DILocation(line: 46, column: 5, scope: !36)
!114 = !DILocation(line: 48, column: 5, scope: !36)
!115 = !DILocation(line: 51, column: 9, scope: !36)
!116 = !DILocation(line: 52, column: 10, scope: !36)
!117 = !DILocation(line: 52, column: 9, scope: !36)
!118 = !DILocation(line: 53, column: 9, scope: !36)
!119 = !DILocation(line: 54, column: 9, scope: !36)
!120 = !DILocation(line: 49, column: 5, scope: !36)
!121 = !DILocation(line: 56, column: 5, scope: !36)
!122 = !DILocation(line: 57, column: 5, scope: !36)
!123 = !DILocation(line: 59, column: 5, scope: !36)
