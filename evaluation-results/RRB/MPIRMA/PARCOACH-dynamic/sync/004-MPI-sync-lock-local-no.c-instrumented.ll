; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c"
...
@0 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %47, i32 41, ptr @5), !dbg !116
  call void @parcoach_rma_load(ptr %10, i64 32, i32 42, ptr @6), !dbg !117
  %49 = load i32, ptr %10, align 4, !dbg !117
  %50 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %49), !dbg !118
  br label %51, !dbg !119

51:                                               ; preds = %42, %38
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 45, ptr @7), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @8), !dbg !121
  %53 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @9), !dbg !122
  %54 = load ptr, ptr %12, align 8, !dbg !122
  call void @parcoach_rma_load(ptr %54, i64 32, i32 49, ptr @10), !dbg !123
  %55 = load i32, ptr %54, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @11), !dbg !124
  %56 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @12), !dbg !125
  %57 = load ptr, ptr %9, align 8, !dbg !125
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %58, i64 32, i32 51, ptr @13), !dbg !125
  %59 = load i32, ptr %58, align 4, !dbg !125
  %60 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %53, i32 noundef %55, i32 noundef %56, i32 noundef %59), !dbg !126
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @14), !dbg !127
  %62 = call i32 @MPI_Finalize(), !dbg !128
  ret i32 0, !dbg !129
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d6acdb719af73d0d1288fab96e5d03bf")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d6acdb719af73d0d1288fab96e5d03bf")
!19 = !{!20, !24, !25, !28}
...
!115 = !DILocation(line: 41, column: 27, scope: !111)
...
!119 = !DILocation(line: 43, column: 5, scope: !111)
!120 = !DILocation(line: 45, column: 5, scope: !41)
!121 = !DILocation(line: 48, column: 9, scope: !41)
!122 = !DILocation(line: 49, column: 10, scope: !41)
!123 = !DILocation(line: 49, column: 9, scope: !41)
!124 = !DILocation(line: 50, column: 9, scope: !41)
!125 = !DILocation(line: 51, column: 9, scope: !41)
!126 = !DILocation(line: 46, column: 5, scope: !41)
!127 = !DILocation(line: 53, column: 5, scope: !41)
!128 = !DILocation(line: 54, column: 5, scope: !41)
