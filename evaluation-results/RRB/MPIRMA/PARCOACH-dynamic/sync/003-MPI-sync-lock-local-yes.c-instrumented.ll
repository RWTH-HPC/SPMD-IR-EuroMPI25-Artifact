; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @14), !dbg !100
  %36 = load i32, ptr %15, align 4, !dbg !100
  %37 = add nsw i32 %36, 1, !dbg !100
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @15), !dbg !100
...
42:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 41, ptr @3), !dbg !113
  %45 = load ptr, ptr %8, align 8, !dbg !113
  %46 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %45, i32 41, ptr @4), !dbg !114
  ...
  %50 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %49, i32 44, ptr @5), !dbg !118
  br label %51, !dbg !119

51:                                               ; preds = %42, %38
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 47, ptr @6), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 50, ptr @7), !dbg !121
  %53 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %12, i64 64, i32 51, ptr @8), !dbg !122
  %54 = load ptr, ptr %12, align 8, !dbg !122
  call void @parcoach_rma_load(ptr %54, i64 32, i32 51, ptr @9), !dbg !123
  %55 = load i32, ptr %54, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 52, ptr @10), !dbg !124
  %56 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 53, ptr @11), !dbg !125
  %57 = load ptr, ptr %9, align 8, !dbg !125
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %58, i64 32, i32 53, ptr @12), !dbg !125
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 55, ptr @13), !dbg !127
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f911fb9e2f31f61af60ed29dd2bfb057")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f911fb9e2f31f61af60ed29dd2bfb057")
!19 = !{!20, !24, !25, !28}
...
!113 = !DILocation(line: 41, column: 55, scope: !111)
!114 = !DILocation(line: 41, column: 9, scope: !111)
!115 = !DILocation(line: 43, column: 33, scope: !111)
!116 = !DILocation(line: 43, column: 9, scope: !111)
!117 = !DILocation(line: 44, column: 27, scope: !111)
!118 = !DILocation(line: 44, column: 9, scope: !111)
!119 = !DILocation(line: 45, column: 5, scope: !111)
!120 = !DILocation(line: 47, column: 5, scope: !41)
!121 = !DILocation(line: 50, column: 9, scope: !41)
!122 = !DILocation(line: 51, column: 10, scope: !41)
!123 = !DILocation(line: 51, column: 9, scope: !41)
!124 = !DILocation(line: 52, column: 9, scope: !41)
!125 = !DILocation(line: 53, column: 9, scope: !41)
!126 = !DILocation(line: 48, column: 5, scope: !41)
!127 = !DILocation(line: 55, column: 5, scope: !41)
!128 = !DILocation(line: 56, column: 5, scope: !41)
!129 = !DILocation(line: 58, column: 5, scope: !41)
