; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c"
...
@0 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@1 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@2 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@3 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@4 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@5 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@6 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@7 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@8 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@9 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@10 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@11 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@12 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@13 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@14 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@15 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@16 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
@17 = private unnamed_addr constant [101 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c\00", align 1
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %15, i64 32, i32 32, ptr @16), !dbg !103
  %36 = load i32, ptr %15, align 4, !dbg !103
  %37 = add nsw i32 %36, 1, !dbg !103
  call void @parcoach_rma_store(ptr %15, i64 32, i32 32, ptr @17), !dbg !103
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 38, ptr @3), !dbg !114
  %44 = load ptr, ptr %8, align 8, !dbg !114
  %45 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %44, i32 38, ptr @4), !dbg !116
  call void @parcoach_rma_load(ptr %10, i64 32, i32 39, ptr @5), !dbg !117
  %46 = load i32, ptr %10, align 4, !dbg !117
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !118
  br label %48, !dbg !119

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 41, ptr @6), !dbg !120
  %49 = load ptr, ptr %8, align 8, !dbg !120
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %49, i32 41, ptr @7), !dbg !121
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 43, ptr @8), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 46, ptr @9), !dbg !123
  %52 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %12, i64 64, i32 47, ptr @10), !dbg !124
  %53 = load ptr, ptr %12, align 8, !dbg !124
  call void @parcoach_rma_load(ptr %53, i64 32, i32 47, ptr @11), !dbg !125
  %54 = load i32, ptr %53, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %11, i64 32, i32 48, ptr @12), !dbg !126
  %55 = load i32, ptr %11, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %9, i64 64, i32 49, ptr @13), !dbg !127
  %56 = load ptr, ptr %9, align 8, !dbg !127
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !127
  call void @parcoach_rma_load(ptr %57, i64 32, i32 49, ptr @14), !dbg !127
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 51, ptr @15), !dbg !129
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f86e7acfa4f860876fab1e4d2db46f88")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f86e7acfa4f860876fab1e4d2db46f88")
!19 = !{!20, !24, !25, !28, !31}
...
!114 = !DILocation(line: 38, column: 71, scope: !115)
!115 = distinct !DILexicalBlock(scope: !111, file: !2, line: 37, column: 20)
!116 = !DILocation(line: 38, column: 9, scope: !115)
!117 = !DILocation(line: 39, column: 33, scope: !115)
!118 = !DILocation(line: 39, column: 9, scope: !115)
!119 = !DILocation(line: 40, column: 5, scope: !115)
!120 = !DILocation(line: 41, column: 22, scope: !44)
!121 = !DILocation(line: 41, column: 5, scope: !44)
!122 = !DILocation(line: 43, column: 5, scope: !44)
!123 = !DILocation(line: 46, column: 9, scope: !44)
!124 = !DILocation(line: 47, column: 10, scope: !44)
!125 = !DILocation(line: 47, column: 9, scope: !44)
!126 = !DILocation(line: 48, column: 9, scope: !44)
!127 = !DILocation(line: 49, column: 9, scope: !44)
!128 = !DILocation(line: 44, column: 5, scope: !44)
!129 = !DILocation(line: 51, column: 5, scope: !44)
!130 = !DILocation(line: 52, column: 5, scope: !44)
!131 = !DILocation(line: 54, column: 5, scope: !44)
