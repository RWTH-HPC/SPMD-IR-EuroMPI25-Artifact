; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/009-MPI-conflict-acc-load-local-no.c'
...
25:                                               ; preds = %21, %2
  %26 = call i32 @MPI_Win_allocate(i64 noundef 40, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9, ptr noundef %8), !dbg !89
...
38:                                               ; preds = %27
  ...
  %40 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %39), !dbg !109
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @MPI_Accumulate(ptr noundef %10, i32 noundef 1, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 1, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %44), !dbg !116
...
48:                                               ; preds = %43, %38
  ...
  %50 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %49), !dbg !121
  %51 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !122
  ...
  %60 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !129
