; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@17 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
...
43:                                               ; preds = %38
  call void @parcoach_rma_load(ptr %9, i64 64, i32 39, ptr @3), !dbg !106
  %44 = load ptr, ptr %9, align 8, !dbg !106
  %45 = getelementptr inbounds i32, ptr %44, i64 0, !dbg !106
  call void @parcoach_rma_load(ptr %8, i64 64, i32 39, ptr @4), !dbg !108
  %46 = load ptr, ptr %8, align 8, !dbg !108
  %47 = call i32 @MPI_Compare_and_swap(ptr noundef %10, ptr noundef %45, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef %46), !dbg !109
  call void @parcoach_rma_store(ptr %10, i64 32, i32 41, ptr @5), !dbg !110
  store i32 42, ptr %10, align 4, !dbg !110
  br label %48, !dbg !111

48:                                               ; preds = %43, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 43, ptr @6), !dbg !112
  %49 = load ptr, ptr %8, align 8, !dbg !112
  %50 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %49, i32 43, ptr @7), !dbg !113
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 45, ptr @8), !dbg !114
  call void @parcoach_rma_load(ptr %6, i64 32, i32 48, ptr @9), !dbg !115
  %52 = load i32, ptr %6, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @10), !dbg !116
  %53 = load ptr, ptr %12, align 8, !dbg !116
  call void @parcoach_rma_load(ptr %53, i64 32, i32 49, ptr @11), !dbg !117
  %54 = load i32, ptr %53, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %11, i64 32, i32 50, ptr @12), !dbg !118
  %55 = load i32, ptr %11, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @13), !dbg !119
  %56 = load ptr, ptr %9, align 8, !dbg !119
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %57, i64 32, i32 51, ptr @14), !dbg !119
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 53, ptr @15), !dbg !121
...
!2 = !DIFile(filename: "cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f9c263544448793021c599a7beb1e016")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/MPIRMA/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f9c263544448793021c599a7beb1e016")
!14 = !{!15, !19, !20, !23}
...
!106 = !DILocation(line: 39, column: 39, scope: !107)
!107 = distinct !DILexicalBlock(scope: !103, file: !2, line: 37, column: 20)
!108 = !DILocation(line: 39, column: 76, scope: !107)
!109 = !DILocation(line: 39, column: 9, scope: !107)
!110 = !DILocation(line: 41, column: 15, scope: !107)
!111 = !DILocation(line: 42, column: 5, scope: !107)
!112 = !DILocation(line: 43, column: 22, scope: !36)
!113 = !DILocation(line: 43, column: 5, scope: !36)
!114 = !DILocation(line: 45, column: 5, scope: !36)
!115 = !DILocation(line: 48, column: 9, scope: !36)
!116 = !DILocation(line: 49, column: 10, scope: !36)
!117 = !DILocation(line: 49, column: 9, scope: !36)
!118 = !DILocation(line: 50, column: 9, scope: !36)
!119 = !DILocation(line: 51, column: 9, scope: !36)
!120 = !DILocation(line: 46, column: 5, scope: !36)
!121 = !DILocation(line: 53, column: 5, scope: !36)
!122 = !DILocation(line: 54, column: 5, scope: !36)
!123 = !DILocation(line: 56, column: 5, scope: !36)
