...
#di_file = #llvm.di_file<"/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/SHMEM/SPMDIR/static/003-shmem-static-putnbi-load-aliasing-local-no.c" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
#di_file1 = #llvm.di_file<"cq-results-20250604-173113/RRB/SHMEM/SPMDIR/static/003-shmem-static-putnbi-load-aliasing-local-no.c" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
#di_composite_type1 = #llvm.di_composite_type<tag = DW_TAG_array_type, baseType = #di_basic_type1, sizeInBits = 184, elements = #llvm.di_subrange<count = 23 : i64>>
...
#di_local_variable2 = #llvm.di_local_variable<scope = #di_subprogram, name = "num_pe", file = #di_file1, line = 20, type = #di_basic_type>
#di_local_variable3 = #llvm.di_local_variable<scope = #di_subprogram, name = "my_pe", file = #di_file1, line = 21, type = #di_basic_type>
...
#di_global_variable1 = #llvm.di_global_variable<file = #di_file1, line = 40, type = #di_composite_type1, isLocalToUnit = true, isDefined = true>
#di_global_variable2 = #llvm.di_global_variable<file = #di_file1, line = 44, type = #di_composite_type2, isLocalToUnit = true, isDefined = true>
#di_local_variable4 = #llvm.di_local_variable<scope = #di_subprogram, name = "rem_ptr", file = #di_file1, line = 30, type = #di_derived_type1>
#di_local_variable5 = #llvm.di_local_variable<scope = #di_subprogram, name = "lbuf_ptr", file = #di_file1, line = 31, type = #di_derived_type1>
#di_local_variable6 = #llvm.di_local_variable<scope = #di_subprogram, name = "rem_ptr_alias", file = #di_file1, line = 32, type = #di_derived_type1>
#di_local_variable7 = #llvm.di_local_variable<scope = #di_subprogram, name = "lbuf_ptr_alias", file = #di_file1, line = 33, type = #di_derived_type1>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (https://github.com/burakSemih/llvm-project.git a5b8f53f3db10b0ff5451335362b36a25139a3f8)", llvm.target_triple = "x86_64-unknown-linux-gnu", spmd.executionKind = "All"} {
  ...
  llvm.mlir.global private unnamed_addr constant @".str.1"("*lbuf_ptr_alias is %d\0A\00") {addr_space = 0 : i32, alignment = 1 : i64, dbg_exprs = [#di_global_variable_expression1], dso_local, spmd.executionKind = "All"}
