...
#di_file = #llvm.di_file<"/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/RRB/SHMEM/SPMDIR/dynamic/003-shmem-dynamic-while-local-no.c" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
#di_file1 = #llvm.di_file<"cq-results-20250604-173113/RRB/SHMEM/SPMDIR/dynamic/003-shmem-dynamic-while-local-no.c" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
    ...
    scf.if %10 {
      ...
      scf.if %13 {
        ...
        ^bb0(%arg2: i32):
          ...
          %21 = "spmd.fence"(%c0_i32) <{usedModel = 1 : i32}> {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : (i32) -> !spmd.error
