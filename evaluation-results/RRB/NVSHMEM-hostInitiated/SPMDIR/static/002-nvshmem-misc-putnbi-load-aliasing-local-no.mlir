...
#di_file = #llvm.di_file<"cq-results-20250604-173113/RRB/NVSHMEM-hostInitiated/SPMDIR/static/002-nvshmem-misc-putnbi-load-aliasing-local-no.cpp" in "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite">
...
#di_global_variable2 = #llvm.di_global_variable<file = #di_file, line = 66, type = #di_composite_type2, isLocalToUnit = true, isDefined = true>
#di_global_variable3 = #llvm.di_global_variable<file = #di_file, line = 71, type = #di_composite_type3, isLocalToUnit = true, isDefined = true>
