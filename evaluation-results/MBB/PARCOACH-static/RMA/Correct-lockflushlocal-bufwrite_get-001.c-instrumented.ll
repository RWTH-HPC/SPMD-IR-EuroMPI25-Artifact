; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c"
...
@0 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c\00", align 1
...
18:                                               ; preds = %16, %2
  ...
  %22 = load i32, ptr %7, align 4, !dbg !70
  %23 = icmp eq i32 %22, 0, !dbg !72
  br i1 %23, label %24, label %35, !dbg !73

24:                                               ; preds = %18
  %25 = load ptr, ptr %8, align 8, !dbg !74
  %26 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %25, i32 40, ptr @1), !dbg !76
  ...
  call void @parcoach_rma_store(ptr %10, i64 64, i32 42, ptr @2), !dbg !78
  store ptr %27, ptr %10, align 8, !dbg !78
  call void @parcoach_rma_load(ptr %10, i64 64, i32 44, ptr @3), !dbg !80
  %28 = load ptr, ptr %10, align 8, !dbg !80
  %29 = getelementptr inbounds i32, ptr %28, i64 0, !dbg !80
  call void @parcoach_rma_store(ptr %29, i64 32, i32 44, ptr @4), !dbg !81
  store i32 42, ptr %29, align 4, !dbg !81
  call void @parcoach_rma_load(ptr %10, i64 64, i32 45, ptr @5), !dbg !82
  %30 = load ptr, ptr %10, align 8, !dbg !82
  call void @parcoach_rma_load(ptr %8, i64 64, i32 45, ptr @6), !dbg !83
  %31 = load ptr, ptr %8, align 8, !dbg !83
  %32 = call i32 @parcoach_rma_MPI_Get(ptr %30, i32 10, ptr @ompi_mpi_int, i32 1, i64 10, i32 10, ptr @ompi_mpi_int, ptr %31, i32 45, ptr @7), !dbg !84
  %33 = load ptr, ptr %8, align 8, !dbg !85
  %34 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %33, i32 46, ptr @8), !dbg !86
  br label %35, !dbg !87

35:                                               ; preds = %24, %18
  %36 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 48, ptr @9), !dbg !88
  %37 = call i32 @MPI_Finalize(), !dbg !89
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @10), !dbg !90
  %38 = load i32, ptr %7, align 4, !dbg !90
  %39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %38), !dbg !91
  ret i32 0, !dbg !92
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufwrite_get-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "1bafa67187f1e6b246e801500e27b3de")
...
!71 = distinct !DILexicalBlock(scope: !38, file: !2, line: 39, column: 7)
!72 = !DILocation(line: 39, column: 12, scope: !71)
!73 = !DILocation(line: 39, column: 7, scope: !38)
!74 = !DILocation(line: 40, column: 44, scope: !75)
!75 = distinct !DILexicalBlock(scope: !71, file: !2, line: 39, column: 18)
!76 = !DILocation(line: 40, column: 5, scope: !75)
!77 = !DILocalVariable(name: "buf", scope: !75, file: !2, line: 42, type: !20)
!78 = !DILocation(line: 42, column: 10, scope: !75)
!79 = !DILocation(line: 42, column: 23, scope: !75)
!80 = !DILocation(line: 44, column: 5, scope: !75)
!81 = !DILocation(line: 44, column: 12, scope: !75)
!82 = !DILocation(line: 45, column: 13, scope: !75)
!83 = !DILocation(line: 45, column: 51, scope: !75)
!84 = !DILocation(line: 45, column: 5, scope: !75)
!85 = !DILocation(line: 46, column: 23, scope: !75)
!86 = !DILocation(line: 46, column: 5, scope: !75)
!87 = !DILocation(line: 47, column: 3, scope: !75)
!88 = !DILocation(line: 48, column: 3, scope: !38)
!89 = !DILocation(line: 50, column: 3, scope: !38)
!90 = !DILocation(line: 51, column: 41, scope: !38)
!91 = !DILocation(line: 51, column: 3, scope: !38)
!92 = !DILocation(line: 52, column: 3, scope: !38)
