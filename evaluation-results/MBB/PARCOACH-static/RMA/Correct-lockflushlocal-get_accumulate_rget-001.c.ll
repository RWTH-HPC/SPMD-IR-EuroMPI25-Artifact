; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-get_accumulate_rget-001.c'
...
27:                                               ; preds = %21
  ...
  %29 = call i32 @MPI_Win_lock(i32 noundef 1, i32 noundef 1, i32 noundef 0, ptr noundef %28), !dbg !98
  ...
  %42 = call i32 @MPI_Win_unlock(i32 noundef 1, ptr noundef %41), !dbg !115
  %43 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !116
  br label %44, !dbg !117

44:                                               ; preds = %27, %21
  %45 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !118
