; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c"
...
@0 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [103 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c\00", align 1
...
26:                                               ; preds = %20
  ...
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !90
  %30 = load ptr, ptr %11, align 8, !dbg !90
  %31 = getelementptr inbounds i32, ptr %30, i64 0, !dbg !90
  call void @parcoach_rma_load(ptr %31, i64 32, i32 45, ptr @4), !dbg !90
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 47, ptr @5), !dbg !93
  store ptr %34, ptr %12, align 8, !dbg !93
  call void @parcoach_rma_load(ptr %11, i64 64, i32 49, ptr @6), !dbg !95
  %35 = load ptr, ptr %11, align 8, !dbg !95
  call void @parcoach_rma_load(ptr %12, i64 64, i32 49, ptr @7), !dbg !96
  %36 = load ptr, ptr %12, align 8, !dbg !96
  call void @parcoach_rma_load(ptr %9, i64 64, i32 50, ptr @8), !dbg !97
  %37 = load ptr, ptr %9, align 8, !dbg !97
  %38 = call i32 @MPI_Get_accumulate(ptr noundef %35, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %36, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %37), !dbg !98
  call void @parcoach_rma_load(ptr %9, i64 64, i32 51, ptr @9), !dbg !99
  %39 = load ptr, ptr %9, align 8, !dbg !99
  %40 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %39, i32 51, ptr @10), !dbg !100
  br label %41, !dbg !101

41:                                               ; preds = %26, %20
  %42 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !102
  %43 = call i32 @MPI_Finalize(), !dbg !103
  call void @parcoach_rma_load(ptr %7, i64 32, i32 56, ptr @12), !dbg !104
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-static/RMA/Correct-lockflushlocal-bufread_get_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "90467f4e46a39d95e9517c5837360c87")
...
!90 = !DILocation(line: 45, column: 27, scope: !85)
!91 = !DILocation(line: 45, column: 5, scope: !85)
!92 = !DILocalVariable(name: "int_0", scope: !85, file: !2, line: 47, type: !25)
!93 = !DILocation(line: 47, column: 10, scope: !85)
!94 = !DILocation(line: 47, column: 25, scope: !85)
!95 = !DILocation(line: 49, column: 24, scope: !85)
!96 = !DILocation(line: 49, column: 42, scope: !85)
!97 = !DILocation(line: 50, column: 33, scope: !85)
!98 = !DILocation(line: 49, column: 5, scope: !85)
!99 = !DILocation(line: 51, column: 23, scope: !85)
!100 = !DILocation(line: 51, column: 5, scope: !85)
!101 = !DILocation(line: 52, column: 3, scope: !85)
