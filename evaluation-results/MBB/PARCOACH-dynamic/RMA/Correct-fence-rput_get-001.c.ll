; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-rput_get-001.c'
...
19:                                               ; preds = %17, %2
  ...
  %24 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %23), !dbg !88
...
27:                                               ; preds = %19
  ...
  %33 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %32), !dbg !101
  %34 = load ptr, ptr %11, align 8, !dbg !102
  %35 = load ptr, ptr %9, align 8, !dbg !103
  %36 = call i32 @MPI_Get(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %35), !dbg !104
  br label %37, !dbg !105
...
40:                                               ; preds = %37
  ...
  %42 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %41), !dbg !112
  br label %43, !dbg !113

43:                                               ; preds = %40, %37
  %44 = load ptr, ptr %9, align 8, !dbg !114
  %45 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %44), !dbg !115
...
50:                                               ; preds = %48, %43
  %51 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !123
