; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-compare_and_swap_rget-001.c'
...
23:                                               ; preds = %21, %2
  ...
  %26 = call i32 @MPI_Win_create(ptr noundef %25, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %11), !dbg !90
  %27 = load ptr, ptr %11, align 8, !dbg !91
  %28 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %27), !dbg !92
...
31:                                               ; preds = %23
  ...
  %41 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %40), !dbg !113
...
48:                                               ; preds = %45
  ...
  %50 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %49), !dbg !124
  br label %51, !dbg !125

51:                                               ; preds = %48, %45
  %52 = load ptr, ptr %11, align 8, !dbg !126
  %53 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %52), !dbg !127
...
58:                                               ; preds = %56, %51
  %59 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !135
