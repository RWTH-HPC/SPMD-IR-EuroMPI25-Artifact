; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_raccumulate-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %25 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %24), !dbg !93
...
37:                                               ; preds = %28, %20
  ...
  %39 = call i32 @MPI_Win_unlock_all(ptr noundef %38), !dbg !111
...
45:                                               ; preds = %42, %37
  %46 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !120
