; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c"
...
@0 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c\00", align 1
...
26:                                               ; preds = %18
  ...
  %32 = call i32 @MPI_Win_flush_local_all(ptr noundef %31), !dbg !84
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @8), !dbg !85
  %33 = load ptr, ptr %10, align 8, !dbg !85
  call void @parcoach_rma_load(ptr %8, i64 64, i32 46, ptr @9), !dbg !86
  %34 = load ptr, ptr %8, align 8, !dbg !86
  %35 = call i32 @parcoach_rma_MPI_Put(ptr %33, i32 10, ptr @ompi_mpi_int, i32 0, i64 0, i32 10, ptr @ompi_mpi_int, ptr %34, i32 46, ptr @10), !dbg !87
  br label %36, !dbg !88

36:                                               ; preds = %26, %18
  call void @parcoach_rma_load(ptr %8, i64 64, i32 48, ptr @11), !dbg !89
  %37 = load ptr, ptr %8, align 8, !dbg !89
  %38 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %37, i32 48, ptr @12), !dbg !90
  %39 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 49, ptr @13), !dbg !91
  %40 = call i32 @MPI_Finalize(), !dbg !92
  call void @parcoach_rma_load(ptr %7, i64 32, i32 52, ptr @14), !dbg !93
  %41 = load i32, ptr %7, align 4, !dbg !93
  %42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %41), !dbg !94
  ret i32 0, !dbg !95
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f5989f3631abb1084e0a15fcba8cc51e")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_put-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "f5989f3631abb1084e0a15fcba8cc51e")
!14 = !{!15, !19, !20, !22, !25}
...
!83 = !DILocation(line: 45, column: 29, scope: !77)
...
!89 = !DILocation(line: 48, column: 22, scope: !38)
!90 = !DILocation(line: 48, column: 3, scope: !38)
!91 = !DILocation(line: 49, column: 3, scope: !38)
!92 = !DILocation(line: 51, column: 3, scope: !38)
!93 = !DILocation(line: 52, column: 41, scope: !38)
!94 = !DILocation(line: 52, column: 3, scope: !38)
!95 = !DILocation(line: 53, column: 3, scope: !38)
