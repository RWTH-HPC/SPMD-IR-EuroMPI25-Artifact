; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c"
...
@0 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@1 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@2 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@3 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@4 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@5 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@6 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@7 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@8 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@9 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@10 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
@11 = private unnamed_addr constant [104 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  %24 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %23, i32 40, ptr @1), !dbg !96
  call void @parcoach_rma_load(ptr %7, i64 32, i32 41, ptr @2), !dbg !97
...
27:                                               ; preds = %19
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @3), !dbg !103
  store ptr %28, ptr %11, align 8, !dbg !103
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @4), !dbg !105
  %29 = load ptr, ptr %11, align 8, !dbg !105
  %30 = getelementptr inbounds i32, ptr %29, i64 0, !dbg !105
  call void @parcoach_rma_load(ptr %30, i64 32, i32 45, ptr @5), !dbg !105
  %31 = load i32, ptr %30, align 4, !dbg !105
  %32 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %31), !dbg !106
  call void @parcoach_rma_load(ptr %11, i64 64, i32 46, ptr @6), !dbg !107
  %33 = load ptr, ptr %11, align 8, !dbg !107
  call void @parcoach_rma_load(ptr %9, i64 64, i32 46, ptr @7), !dbg !108
  %34 = load ptr, ptr %9, align 8, !dbg !108
  %35 = call i32 @MPI_Raccumulate(ptr noundef %33, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %34, ptr noundef %8), !dbg !109
  br label %36, !dbg !110

36:                                               ; preds = %27, %19
  call void @parcoach_rma_load(ptr %9, i64 64, i32 49, ptr @8), !dbg !111
  %37 = load ptr, ptr %9, align 8, !dbg !111
  %38 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %37, i32 49, ptr @9), !dbg !112
  call void @parcoach_rma_load(ptr %7, i64 32, i32 50, ptr @10), !dbg !113
...
43:                                               ; preds = %41, %36
  %44 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 53, ptr @11), !dbg !120
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e7054c9f39e204355b6be2abd062fd36")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e7054c9f39e204355b6be2abd062fd36")
...
!105 = !DILocation(line: 45, column: 27, scope: !102)
!106 = !DILocation(line: 45, column: 5, scope: !102)
!107 = !DILocation(line: 46, column: 21, scope: !102)
!108 = !DILocation(line: 46, column: 67, scope: !102)
!109 = !DILocation(line: 46, column: 5, scope: !102)
