; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c"
...
@0 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@1 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@2 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@3 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@4 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@5 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@6 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@7 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@8 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@9 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@10 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@11 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
@12 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c\00", align 1
...
27:                                               ; preds = %21
  ...
  call void @parcoach_rma_load(ptr %12, i64 64, i32 46, ptr @3), !dbg !107
  %31 = load ptr, ptr %12, align 8, !dbg !107
  %32 = getelementptr inbounds i32, ptr %31, i64 0, !dbg !107
  call void @parcoach_rma_load(ptr %32, i64 32, i32 46, ptr @4), !dbg !107
  ...
  call void @parcoach_rma_store(ptr %13, i64 64, i32 48, ptr @5), !dbg !110
  store ptr %35, ptr %13, align 8, !dbg !110
  call void @parcoach_rma_load(ptr %12, i64 64, i32 50, ptr @6), !dbg !112
  %36 = load ptr, ptr %12, align 8, !dbg !112
  call void @parcoach_rma_load(ptr %13, i64 64, i32 50, ptr @7), !dbg !113
  %37 = load ptr, ptr %13, align 8, !dbg !113
  call void @parcoach_rma_load(ptr %10, i64 64, i32 51, ptr @8), !dbg !114
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 52, ptr @9), !dbg !116
  %40 = load ptr, ptr %10, align 8, !dbg !116
  %41 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %40, i32 52, ptr @10), !dbg !117
  %42 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !118
  br label %43, !dbg !119

43:                                               ; preds = %27, %21
  %44 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 55, ptr @11), !dbg !120
  %45 = call i32 @MPI_Finalize(), !dbg !121
  call void @parcoach_rma_load(ptr %7, i64 32, i32 58, ptr @12), !dbg !122
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d35eb99d367dd5d8e65a524369874339")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockflush-bufread_rget_accumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "d35eb99d367dd5d8e65a524369874339")
