; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-get_get_accumulate-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %25 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %24), !dbg !76
...
40:                                               ; preds = %28, %20
  ...
  %42 = call i32 @MPI_Win_unlock_all(ptr noundef %41), !dbg !99
  %43 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !100
