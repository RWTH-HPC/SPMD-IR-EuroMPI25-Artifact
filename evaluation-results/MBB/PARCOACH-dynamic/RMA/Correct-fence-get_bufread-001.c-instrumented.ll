; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c"
...
@0 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@13 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@14 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
@15 = private unnamed_addr constant [84 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c\00", align 1
...
18:                                               ; preds = %16, %2
  ...
  br i1 %25, label %26, label %37, !dbg !80
...
26:                                               ; preds = %18
  ...
  %30 = call i32 @parcoach_rma_MPI_Get(ptr %28, i32 10, ptr @ompi_mpi_int, i32 1, i64 0, i32 10, ptr @ompi_mpi_int, ptr %29, i32 44, ptr @6), !dbg !87
  call void @parcoach_rma_load(ptr %8, i64 64, i32 45, ptr @7), !dbg !88
  %31 = load ptr, ptr %8, align 8, !dbg !88
  %32 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %31, i32 45, ptr @8), !dbg !89
  call void @parcoach_rma_load(ptr %10, i64 64, i32 46, ptr @9), !dbg !90
  %33 = load ptr, ptr %10, align 8, !dbg !90
  %34 = getelementptr inbounds i32, ptr %33, i64 0, !dbg !90
  call void @parcoach_rma_load(ptr %34, i64 32, i32 46, ptr @10), !dbg !90
...
40:                                               ; preds = %37
  ...
  %42 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %41, i32 49, ptr @11), !dbg !99
  br label %43, !dbg !100

43:                                               ; preds = %40, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 51, ptr @12), !dbg !101
  %44 = load ptr, ptr %8, align 8, !dbg !101
  %45 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %44, i32 51, ptr @13), !dbg !102
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 52, ptr @14), !dbg !103
  %47 = call i32 @MPI_Finalize(), !dbg !104
  call void @parcoach_rma_load(ptr %7, i64 32, i32 55, ptr @15), !dbg !105
  %48 = load i32, ptr %7, align 4, !dbg !105
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %48), !dbg !106
  ret i32 0, !dbg !107
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "15bd91a6641271fdd2e593b125789e18")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "15bd91a6641271fdd2e593b125789e18")
!19 = !{!20, !24, !25, !27, !30}
...
!88 = !DILocation(line: 45, column: 22, scope: !82)
!89 = !DILocation(line: 45, column: 5, scope: !82)
!90 = !DILocation(line: 46, column: 27, scope: !82)
!91 = !DILocation(line: 46, column: 5, scope: !82)
!92 = !DILocation(line: 47, column: 3, scope: !82)
!93 = !DILocation(line: 48, column: 7, scope: !94)
!94 = distinct !DILexicalBlock(scope: !43, file: !2, line: 48, column: 7)
!95 = !DILocation(line: 48, column: 12, scope: !94)
!96 = !DILocation(line: 48, column: 7, scope: !43)
!97 = !DILocation(line: 49, column: 22, scope: !98)
!98 = distinct !DILexicalBlock(scope: !94, file: !2, line: 48, column: 18)
!99 = !DILocation(line: 49, column: 5, scope: !98)
!100 = !DILocation(line: 50, column: 3, scope: !98)
!101 = !DILocation(line: 51, column: 20, scope: !43)
!102 = !DILocation(line: 51, column: 3, scope: !43)
!103 = !DILocation(line: 52, column: 3, scope: !43)
!104 = !DILocation(line: 54, column: 3, scope: !43)
!105 = !DILocation(line: 55, column: 41, scope: !43)
!106 = !DILocation(line: 55, column: 3, scope: !43)
!107 = !DILocation(line: 56, column: 3, scope: !43)
