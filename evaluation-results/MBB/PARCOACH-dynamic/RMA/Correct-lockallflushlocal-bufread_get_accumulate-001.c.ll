; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-bufread_get_accumulate-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %23 = call i32 @MPI_Win_create(ptr noundef %22, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9), !dbg !79
  %24 = load ptr, ptr %9, align 8, !dbg !80
  %25 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %24), !dbg !81
...
39:                                               ; preds = %28, %20
  ...
  %41 = call i32 @MPI_Win_unlock_all(ptr noundef %40), !dbg !101
  %42 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !102
