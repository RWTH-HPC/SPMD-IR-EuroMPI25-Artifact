; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c"
...
@0 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@1 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@2 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@3 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@4 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@5 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@6 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@7 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@8 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@9 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
@10 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %24, label %25, label %37, !dbg !90

25:                                               ; preds = %19
  %26 = load ptr, ptr %9, align 8, !dbg !91
  %27 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %26, i32 41, ptr @1), !dbg !93
  ...
  call void @parcoach_rma_store(ptr %11, i64 64, i32 43, ptr @2), !dbg !95
  store ptr %28, ptr %11, align 8, !dbg !95
  call void @parcoach_rma_load(ptr %11, i64 64, i32 45, ptr @3), !dbg !97
  %29 = load ptr, ptr %11, align 8, !dbg !97
  call void @parcoach_rma_load(ptr %9, i64 64, i32 45, ptr @4), !dbg !98
  ...
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @5), !dbg !100
  %32 = load ptr, ptr %11, align 8, !dbg !100
  %33 = getelementptr inbounds i32, ptr %32, i64 0, !dbg !100
  call void @parcoach_rma_store(ptr %33, i64 32, i32 47, ptr @6), !dbg !101
  store i32 42, ptr %33, align 4, !dbg !101
  call void @parcoach_rma_load(ptr %9, i64 64, i32 48, ptr @7), !dbg !102
  %34 = load ptr, ptr %9, align 8, !dbg !102
  %35 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %34, i32 48, ptr @8), !dbg !103
  %36 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !104
  br label %37, !dbg !105

37:                                               ; preds = %25, %19
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @9), !dbg !106
  %39 = call i32 @MPI_Finalize(), !dbg !107
  call void @parcoach_rma_load(ptr %7, i64 32, i32 54, ptr @10), !dbg !108
  %40 = load i32, ptr %7, align 4, !dbg !108
  %41 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40), !dbg !109
  ret i32 0, !dbg !110
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockunlock-rput_bufwrite-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2961cc825ef6f520794b720bd3aa4dbb")
...
!97 = !DILocation(line: 45, column: 33, scope: !92)
!98 = !DILocation(line: 45, column: 70, scope: !92)
!99 = !DILocation(line: 45, column: 24, scope: !92)
!100 = !DILocation(line: 47, column: 24, scope: !92)
!101 = !DILocation(line: 47, column: 31, scope: !92)
!102 = !DILocation(line: 48, column: 23, scope: !92)
!103 = !DILocation(line: 48, column: 5, scope: !92)
!104 = !DILocation(line: 49, column: 5, scope: !92)
!105 = !DILocation(line: 50, column: 3, scope: !92)
!106 = !DILocation(line: 51, column: 3, scope: !53)
!107 = !DILocation(line: 53, column: 3, scope: !53)
!108 = !DILocation(line: 54, column: 41, scope: !53)
!109 = !DILocation(line: 54, column: 3, scope: !53)
!110 = !DILocation(line: 55, column: 3, scope: !53)
