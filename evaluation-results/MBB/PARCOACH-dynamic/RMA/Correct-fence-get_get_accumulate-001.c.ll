; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_get_accumulate-001.c'
...
20:                                               ; preds = %18, %2
  ...
  %23 = call i32 @MPI_Win_create(ptr noundef %22, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %9), !dbg !74
  %24 = load ptr, ptr %9, align 8, !dbg !75
  %25 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %24), !dbg !76
...
28:                                               ; preds = %20
  ...
  %32 = call i32 @MPI_Get(ptr noundef %30, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %31), !dbg !87
...
43:                                               ; preds = %40
  ...
  %45 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %44), !dbg !104
  br label %46, !dbg !105

46:                                               ; preds = %43, %40
  %47 = load ptr, ptr %9, align 8, !dbg !106
  %48 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %47), !dbg !107
  %49 = call i32 @MPI_Win_free(ptr noundef %9), !dbg !108
