; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_rget_accumulate-001.c'
...
21:                                               ; preds = %19, %2
  ...
  %24 = call i32 @MPI_Win_create(ptr noundef %23, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %10), !dbg !91
  %25 = load ptr, ptr %10, align 8, !dbg !92
  %26 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %25), !dbg !93
...
29:                                               ; preds = %21
  ...
  %33 = call i32 @MPI_Get(ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %32), !dbg !104
  %34 = load ptr, ptr %10, align 8, !dbg !105
  %35 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %34), !dbg !106
...
44:                                               ; preds = %41
  ...
  %46 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %45), !dbg !121
  br label %47, !dbg !122

47:                                               ; preds = %44, %41
  %48 = load ptr, ptr %10, align 8, !dbg !123
  %49 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %48), !dbg !124
...
54:                                               ; preds = %52, %47
  %55 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !132
