; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflushlocal-raccumulate_compare_and_swap-001.c'
...
23:                                               ; preds = %21, %2
  ...
  %28 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %27), !dbg !95
...
43:                                               ; preds = %31, %23
  ...
  %45 = call i32 @MPI_Win_unlock_all(ptr noundef %44), !dbg !120
...
50:                                               ; preds = %48, %43
  %51 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !128
