; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_compare_and_swap-001.c'
...
22:                                               ; preds = %20, %2
  ...
  %25 = call i32 @MPI_Win_create(ptr noundef %24, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %10), !dbg !73
  %26 = load ptr, ptr %10, align 8, !dbg !74
  %27 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %26), !dbg !75
...
30:                                               ; preds = %22
  ...
  %34 = call i32 @MPI_Get(ptr noundef %32, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %33), !dbg !86
  %35 = load ptr, ptr %10, align 8, !dbg !87
  %36 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %35), !dbg !88
...
47:                                               ; preds = %44
  ...
  %49 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %48), !dbg !107
  br label %50, !dbg !108

50:                                               ; preds = %47, %44
  %51 = load ptr, ptr %10, align 8, !dbg !109
  %52 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %51), !dbg !110
  %53 = call i32 @MPI_Win_free(ptr noundef %10), !dbg !111
