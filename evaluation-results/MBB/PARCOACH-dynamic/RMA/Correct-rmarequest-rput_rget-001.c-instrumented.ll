; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c"
...
@0 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c\00", align 1
...
20:                                               ; preds = %18, %2
  ...
  br i1 %27, label %28, label %37, !dbg !94
...
28:                                               ; preds = %20
  ...
  %33 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !102
  call void @parcoach_rma_load(ptr %12, i64 64, i32 48, ptr @6), !dbg !103
  %34 = load ptr, ptr %12, align 8, !dbg !103
  call void @parcoach_rma_load(ptr %10, i64 64, i32 48, ptr @7), !dbg !104
  %35 = load ptr, ptr %10, align 8, !dbg !104
  %36 = call i32 @MPI_Rget(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %35, ptr noundef %9), !dbg !105
  br label %37, !dbg !106

37:                                               ; preds = %28, %20
  call void @parcoach_rma_load(ptr %10, i64 64, i32 50, ptr @8), !dbg !107
  %38 = load ptr, ptr %10, align 8, !dbg !107
  %39 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %38, i32 50, ptr @9), !dbg !108
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @10), !dbg !109
  %40 = load i32, ptr %7, align 4, !dbg !109
  %41 = icmp eq i32 %40, 0, !dbg !111
  br i1 %41, label %42, label %45, !dbg !112

42:                                               ; preds = %37
  %43 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !113
  %44 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !115
  br label %45, !dbg !116

45:                                               ; preds = %42, %37
  %46 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 55, ptr @11), !dbg !117
  %47 = call i32 @MPI_Finalize(), !dbg !118
  %48 = load i32, ptr %7, align 4, !dbg !119
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !120
  ret i32 0, !dbg !121
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2766954f75ccd83bfecf92bd2bee84a9")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rput_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "2766954f75ccd83bfecf92bd2bee84a9")
...
!102 = !DILocation(line: 47, column: 5, scope: !96)
!103 = !DILocation(line: 48, column: 14, scope: !96)
!104 = !DILocation(line: 48, column: 51, scope: !96)
!105 = !DILocation(line: 48, column: 5, scope: !96)
!106 = !DILocation(line: 49, column: 3, scope: !96)
!107 = !DILocation(line: 50, column: 22, scope: !53)
!108 = !DILocation(line: 50, column: 3, scope: !53)
!109 = !DILocation(line: 51, column: 7, scope: !110)
!110 = distinct !DILexicalBlock(scope: !53, file: !2, line: 51, column: 7)
!111 = !DILocation(line: 51, column: 12, scope: !110)
!112 = !DILocation(line: 51, column: 7, scope: !53)
...
!116 = !DILocation(line: 54, column: 3, scope: !114)
!117 = !DILocation(line: 55, column: 3, scope: !53)
!118 = !DILocation(line: 57, column: 3, scope: !53)
!119 = !DILocation(line: 58, column: 41, scope: !53)
!120 = !DILocation(line: 58, column: 3, scope: !53)
!121 = !DILocation(line: 59, column: 3, scope: !53)
