; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c"
...
@0 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
@13 = private unnamed_addr constant [100 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c\00", align 1
...
28:                                               ; preds = %20
  ...
  call void @parcoach_rma_store(ptr %12, i64 64, i32 45, ptr @4), !dbg !91
  store ptr %30, ptr %12, align 8, !dbg !91
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @5), !dbg !93
  %31 = load ptr, ptr %11, align 8, !dbg !93
  call void @parcoach_rma_load(ptr %12, i64 64, i32 47, ptr @6), !dbg !94
  %32 = load ptr, ptr %12, align 8, !dbg !94
  call void @parcoach_rma_load(ptr %9, i64 64, i32 47, ptr @7), !dbg !95
  %33 = load ptr, ptr %9, align 8, !dbg !95
  %34 = call i32 @MPI_Fetch_and_op(ptr noundef %31, ptr noundef %32, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef @ompi_mpi_op_sum, ptr noundef %33), !dbg !96
  call void @parcoach_rma_load(ptr %11, i64 64, i32 48, ptr @8), !dbg !97
  %35 = load ptr, ptr %11, align 8, !dbg !97
  %36 = getelementptr inbounds i32, ptr %35, i64 0, !dbg !97
  call void @parcoach_rma_load(ptr %36, i64 32, i32 48, ptr @9), !dbg !97
  %37 = load i32, ptr %36, align 4, !dbg !97
  %38 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %37), !dbg !98
  br label %39, !dbg !99

39:                                               ; preds = %28, %20
  call void @parcoach_rma_load(ptr %9, i64 64, i32 50, ptr @10), !dbg !100
  %40 = load ptr, ptr %9, align 8, !dbg !100
  %41 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %40, i32 50, ptr @11), !dbg !101
  %42 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 51, ptr @12), !dbg !102
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5dc55cb14aedcb4d90ae28fa84f37110")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-lockallflush-fetch_and_op_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5dc55cb14aedcb4d90ae28fa84f37110")
...
!90 = !DILocalVariable(name: "int_0", scope: !87, file: !2, line: 45, type: !25)
!91 = !DILocation(line: 45, column: 10, scope: !87)
!92 = !DILocation(line: 45, column: 25, scope: !87)
!93 = !DILocation(line: 47, column: 22, scope: !87)
!94 = !DILocation(line: 47, column: 27, scope: !87)
!95 = !DILocation(line: 47, column: 58, scope: !87)
!96 = !DILocation(line: 47, column: 5, scope: !87)
!97 = !DILocation(line: 48, column: 27, scope: !87)
!98 = !DILocation(line: 48, column: 5, scope: !87)
!99 = !DILocation(line: 49, column: 3, scope: !87)
!100 = !DILocation(line: 50, column: 22, scope: !46)
!101 = !DILocation(line: 50, column: 3, scope: !46)
!102 = !DILocation(line: 51, column: 3, scope: !46)
!103 = !DILocation(line: 53, column: 3, scope: !46)
!104 = !DILocation(line: 54, column: 41, scope: !46)
!105 = !DILocation(line: 54, column: 3, scope: !46)
