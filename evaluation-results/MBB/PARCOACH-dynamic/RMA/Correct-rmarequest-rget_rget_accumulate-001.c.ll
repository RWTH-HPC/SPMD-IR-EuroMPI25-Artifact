; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-rmarequest-rget_rget_accumulate-001.c'
...
22:                                               ; preds = %20, %2
  ...
  %25 = call i32 @MPI_Win_create(ptr noundef %24, i64 noundef 80, i32 noundef 4, ptr noundef @ompi_mpi_info_null, ptr noundef @ompi_mpi_comm_world, ptr noundef %11), !dbg !93
  %26 = load ptr, ptr %11, align 8, !dbg !94
  %27 = call i32 @MPI_Win_lock_all(i32 noundef 0, ptr noundef %26), !dbg !95
...
41:                                               ; preds = %30, %22
  ...
  %43 = call i32 @MPI_Win_unlock_all(ptr noundef %42), !dbg !117
...
49:                                               ; preds = %46, %41
  %50 = call i32 @MPI_Win_free(ptr noundef %11), !dbg !126
