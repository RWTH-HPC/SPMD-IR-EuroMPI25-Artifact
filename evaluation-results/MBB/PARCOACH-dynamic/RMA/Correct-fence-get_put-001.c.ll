; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/Correct-fence-get_put-001.c'
...
18:                                               ; preds = %16, %2
  ...
  %23 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %22), !dbg !71
...
26:                                               ; preds = %18
  ...
  %32 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %31), !dbg !84
  %33 = load ptr, ptr %10, align 8, !dbg !85
  %34 = load ptr, ptr %8, align 8, !dbg !86
  %35 = call i32 @MPI_Put(ptr noundef %33, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %34), !dbg !87
  br label %36, !dbg !88
...
39:                                               ; preds = %36
  ...
  %41 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %40), !dbg !95
  br label %42, !dbg !96

42:                                               ; preds = %39, %36
  %43 = load ptr, ptr %8, align 8, !dbg !97
  %44 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %43), !dbg !98
  %45 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !99
