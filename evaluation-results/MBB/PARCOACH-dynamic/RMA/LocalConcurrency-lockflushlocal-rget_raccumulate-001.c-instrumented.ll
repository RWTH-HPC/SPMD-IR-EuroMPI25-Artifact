; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c"
...
@0 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@1 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@2 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@3 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@4 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@5 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@6 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@7 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@8 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@9 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
@10 = private unnamed_addr constant [107 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c\00", align 1
...
20:                                               ; preds = %18, %2
  ...
  br i1 %25, label %26, label %40, !dbg !95

26:                                               ; preds = %20
  %27 = load ptr, ptr %10, align 8, !dbg !96
  %28 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %27, i32 42, ptr @1), !dbg !98
  ...
  call void @parcoach_rma_load(ptr %10, i64 64, i32 49, ptr @6), !dbg !106
  %34 = load ptr, ptr %10, align 8, !dbg !106
  %35 = call i32 @MPI_Raccumulate(ptr noundef %33, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 10, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef %34, ptr noundef %9), !dbg !107
  call void @parcoach_rma_load(ptr %10, i64 64, i32 51, ptr @7), !dbg !108
  %36 = load ptr, ptr %10, align 8, !dbg !108
  %37 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %36, i32 51, ptr @8), !dbg !109
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !110
  %39 = call i32 @MPI_Wait(ptr noundef %9, ptr noundef null), !dbg !111
  br label %40, !dbg !112

40:                                               ; preds = %26, %20
  %41 = call i32 @parcoach_rma_MPI_Win_free(ptr %10, i32 55, ptr @9), !dbg !113
  %42 = call i32 @MPI_Finalize(), !dbg !114
  call void @parcoach_rma_load(ptr %7, i64 32, i32 58, ptr @10), !dbg !115
  %43 = load i32, ptr %7, align 4, !dbg !115
  %44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %43), !dbg !116
  ret i32 0, !dbg !117
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "713280f9c55e8bf5ff996e9af9a0a50f")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockflushlocal-rget_raccumulate-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "713280f9c55e8bf5ff996e9af9a0a50f")
...
!105 = !DILocation(line: 48, column: 40, scope: !97)
!106 = !DILocation(line: 49, column: 49, scope: !97)
!107 = !DILocation(line: 48, column: 24, scope: !97)
!108 = !DILocation(line: 51, column: 23, scope: !97)
!109 = !DILocation(line: 51, column: 5, scope: !97)
!110 = !DILocation(line: 52, column: 5, scope: !97)
!111 = !DILocation(line: 53, column: 5, scope: !97)
!112 = !DILocation(line: 54, column: 3, scope: !97)
!113 = !DILocation(line: 55, column: 3, scope: !56)
!114 = !DILocation(line: 57, column: 3, scope: !56)
!115 = !DILocation(line: 58, column: 41, scope: !56)
!116 = !DILocation(line: 58, column: 3, scope: !56)
