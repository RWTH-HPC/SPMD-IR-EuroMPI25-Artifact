; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c"
...
@0 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@1 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@2 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@3 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@4 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@5 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@6 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@7 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@8 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@9 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@10 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@11 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
@12 = private unnamed_addr constant [102 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c\00", align 1
...
19:                                               ; preds = %17, %2
  ...
  br i1 %26, label %27, label %35, !dbg !92
...
27:                                               ; preds = %19
  ...
  call void @parcoach_rma_load(ptr %9, i64 64, i32 46, ptr @5), !dbg !98
  ...
  call void @parcoach_rma_load(ptr %11, i64 64, i32 47, ptr @7), !dbg !100
  %32 = load ptr, ptr %11, align 8, !dbg !100
  call void @parcoach_rma_load(ptr %9, i64 64, i32 47, ptr @8), !dbg !101
  %33 = load ptr, ptr %9, align 8, !dbg !101
  %34 = call i32 @MPI_Rget(ptr noundef %32, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i64 noundef 0, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %33, ptr noundef %8), !dbg !102
  br label %35, !dbg !103

35:                                               ; preds = %27, %19
  call void @parcoach_rma_load(ptr %9, i64 64, i32 50, ptr @9), !dbg !104
  %36 = load ptr, ptr %9, align 8, !dbg !104
  %37 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %36, i32 50, ptr @10), !dbg !105
  call void @parcoach_rma_load(ptr %7, i64 32, i32 51, ptr @11), !dbg !106
  %38 = load i32, ptr %7, align 4, !dbg !106
  %39 = icmp eq i32 %38, 0, !dbg !108
  br i1 %39, label %40, label %42, !dbg !109

40:                                               ; preds = %35
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !110
  br label %42, !dbg !112

42:                                               ; preds = %40, %35
  %43 = call i32 @parcoach_rma_MPI_Win_free(ptr %9, i32 54, ptr @12), !dbg !113
  %44 = call i32 @MPI_Finalize(), !dbg !114
  %45 = load i32, ptr %7, align 4, !dbg !115
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !116
  ret i32 0, !dbg !117
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "6974210f3fcae2d3a10e94eab95447a6")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-put_rget-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "6974210f3fcae2d3a10e94eab95447a6")
...
!97 = !DILocation(line: 45, column: 32, scope: !94)
!98 = !DILocation(line: 46, column: 32, scope: !94)
!99 = !DILocation(line: 45, column: 24, scope: !94)
!100 = !DILocation(line: 47, column: 33, scope: !94)
!101 = !DILocation(line: 47, column: 70, scope: !94)
!102 = !DILocation(line: 47, column: 24, scope: !94)
!103 = !DILocation(line: 49, column: 3, scope: !94)
!104 = !DILocation(line: 50, column: 22, scope: !53)
!105 = !DILocation(line: 50, column: 3, scope: !53)
!106 = !DILocation(line: 51, column: 7, scope: !107)
!107 = distinct !DILexicalBlock(scope: !53, file: !2, line: 51, column: 7)
!108 = !DILocation(line: 51, column: 12, scope: !107)
!109 = !DILocation(line: 51, column: 7, scope: !53)
!110 = !DILocation(line: 52, column: 5, scope: !111)
!111 = distinct !DILexicalBlock(scope: !107, file: !2, line: 51, column: 18)
!112 = !DILocation(line: 53, column: 3, scope: !111)
!113 = !DILocation(line: 54, column: 3, scope: !53)
!114 = !DILocation(line: 56, column: 3, scope: !53)
!115 = !DILocation(line: 57, column: 41, scope: !53)
!116 = !DILocation(line: 57, column: 3, scope: !53)
!117 = !DILocation(line: 58, column: 3, scope: !53)
