; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c"
...
@0 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@1 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@2 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@3 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@4 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@5 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@6 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@7 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@8 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@9 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@10 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@11 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
@12 = private unnamed_addr constant [105 x i8] c"cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c\00", align 1
...
26:                                               ; preds = %18
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 45, ptr @5), !dbg !86
  ...
  call void @parcoach_rma_load(ptr %32, i64 32, i32 46, ptr @8), !dbg !88
  %33 = load i32, ptr %32, align 4, !dbg !88
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !89
  br label %35, !dbg !90

35:                                               ; preds = %26, %18
  call void @parcoach_rma_load(ptr %8, i64 64, i32 48, ptr @9), !dbg !91
  %36 = load ptr, ptr %8, align 8, !dbg !91
  %37 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %36, i32 48, ptr @10), !dbg !92
  %38 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 49, ptr @11), !dbg !93
  %39 = call i32 @MPI_Finalize(), !dbg !94
  call void @parcoach_rma_load(ptr %7, i64 32, i32 52, ptr @12), !dbg !95
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "895773984a923a02d61ebc046fdaa8c9")
...
!18 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/RMA/LocalConcurrency-lockallflushlocal-get_bufread-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "895773984a923a02d61ebc046fdaa8c9")
!19 = !{!20, !24, !25, !27, !30}
...
!85 = !DILocation(line: 44, column: 32, scope: !82)
!86 = !DILocation(line: 45, column: 32, scope: !82)
!87 = !DILocation(line: 44, column: 24, scope: !82)
!88 = !DILocation(line: 46, column: 46, scope: !82)
!89 = !DILocation(line: 46, column: 24, scope: !82)
!90 = !DILocation(line: 47, column: 3, scope: !82)
!91 = !DILocation(line: 48, column: 22, scope: !43)
!92 = !DILocation(line: 48, column: 3, scope: !43)
!93 = !DILocation(line: 49, column: 3, scope: !43)
!94 = !DILocation(line: 51, column: 3, scope: !43)
!95 = !DILocation(line: 52, column: 41, scope: !43)
!96 = !DILocation(line: 52, column: 3, scope: !43)
!97 = !DILocation(line: 53, column: 3, scope: !43)
