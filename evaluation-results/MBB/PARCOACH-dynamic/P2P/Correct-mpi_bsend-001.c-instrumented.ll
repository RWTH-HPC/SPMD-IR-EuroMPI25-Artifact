; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend-001.c"
...
30:                                               ; preds = %26, %19
  ...
  br i1 %32, label %33, label %36, !dbg !94

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !95
  %35 = call i32 @MPI_Bsend(ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !97
  br label %36, !dbg !98

36:                                               ; preds = %33, %30
  call void @llvm.dbg.declare(metadata ptr %11, metadata !99, metadata !DIExpression()), !dbg !100
  %37 = load ptr, ptr %10, align 8, !dbg !101
  %38 = call i32 @MPI_Buffer_detach(ptr noundef %37, ptr noundef %11), !dbg !102
  %39 = load ptr, ptr %10, align 8, !dbg !103
  call void @free(ptr noundef %39) #6, !dbg !104
  %40 = load ptr, ptr %9, align 8, !dbg !105
  call void @free(ptr noundef %40) #6, !dbg !106
  %41 = call i32 @MPI_Finalize(), !dbg !107
  %42 = load i32, ptr %7, align 4, !dbg !108
  %43 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %42), !dbg !109
  ret i32 0, !dbg !110
}
...
declare i32 @MPI_Bsend(ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e409ac4a40405b5c38588e61f0f087ca")
...
!95 = !DILocation(line: 45, column: 15, scope: !96)
!96 = distinct !DILexicalBlock(scope: !92, file: !2, line: 44, column: 18)
!97 = !DILocation(line: 45, column: 5, scope: !96)
!98 = !DILocation(line: 46, column: 3, scope: !96)
!99 = !DILocalVariable(name: "freed_size", scope: !51, file: !2, line: 47, type: !24)
!100 = !DILocation(line: 47, column: 7, scope: !51)
!101 = !DILocation(line: 48, column: 21, scope: !51)
!102 = !DILocation(line: 48, column: 3, scope: !51)
!103 = !DILocation(line: 49, column: 8, scope: !51)
!104 = !DILocation(line: 49, column: 3, scope: !51)
!105 = !DILocation(line: 50, column: 8, scope: !51)
!106 = !DILocation(line: 50, column: 3, scope: !51)
!107 = !DILocation(line: 52, column: 3, scope: !51)
!108 = !DILocation(line: 53, column: 41, scope: !51)
