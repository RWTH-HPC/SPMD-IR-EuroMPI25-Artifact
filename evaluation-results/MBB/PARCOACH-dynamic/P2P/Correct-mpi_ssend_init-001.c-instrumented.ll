; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend_init-001.c"
...
25:                                               ; preds = %21, %17
  ...
  br i1 %27, label %28, label %33, !dbg !89
...
28:                                               ; preds = %25
  ...
  %32 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !94
  br label %33, !dbg !95

33:                                               ; preds = %28, %25
  %34 = load ptr, ptr %9, align 8, !dbg !96
  call void @free(ptr noundef %34) #6, !dbg !97
  %35 = load i32, ptr %7, align 4, !dbg !98
  %36 = icmp eq i32 %35, 1, !dbg !100
  br i1 %36, label %37, label %39, !dbg !101

37:                                               ; preds = %33
  %38 = call i32 @MPI_Request_free(ptr noundef %8), !dbg !102
  br label %39, !dbg !104

39:                                               ; preds = %37, %33
  %40 = call i32 @MPI_Finalize(), !dbg !105
  %41 = load i32, ptr %7, align 4, !dbg !106
  %42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %41), !dbg !107
  ret i32 0, !dbg !108
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_ssend_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "c71b924b82969288894f882432fcc9d2")
...
!90 = !DILocation(line: 41, column: 20, scope: !91)
!91 = distinct !DILexicalBlock(scope: !87, file: !2, line: 40, column: 18)
!92 = !DILocation(line: 41, column: 5, scope: !91)
!93 = !DILocation(line: 42, column: 5, scope: !91)
!94 = !DILocation(line: 43, column: 5, scope: !91)
!95 = !DILocation(line: 44, column: 3, scope: !91)
!96 = !DILocation(line: 45, column: 8, scope: !50)
!97 = !DILocation(line: 45, column: 3, scope: !50)
!98 = !DILocation(line: 46, column: 7, scope: !99)
!99 = distinct !DILexicalBlock(scope: !50, file: !2, line: 46, column: 7)
!100 = !DILocation(line: 46, column: 12, scope: !99)
!101 = !DILocation(line: 46, column: 7, scope: !50)
!102 = !DILocation(line: 47, column: 5, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !2, line: 46, column: 18)
!104 = !DILocation(line: 48, column: 3, scope: !103)
!105 = !DILocation(line: 50, column: 3, scope: !50)
!106 = !DILocation(line: 51, column: 41, scope: !50)
!107 = !DILocation(line: 51, column: 3, scope: !50)
!108 = !DILocation(line: 52, column: 3, scope: !50)
