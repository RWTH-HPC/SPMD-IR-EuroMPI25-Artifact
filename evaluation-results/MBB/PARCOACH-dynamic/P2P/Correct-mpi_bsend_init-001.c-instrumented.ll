; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend_init-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend_init-001.c"
...
30:                                               ; preds = %26, %19
  ...
  br i1 %32, label %33, label %38, !dbg !94
...
33:                                               ; preds = %30
  ...
  %37 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !99
  br label %38, !dbg !100

38:                                               ; preds = %33, %30
  call void @llvm.dbg.declare(metadata ptr %11, metadata !101, metadata !DIExpression()), !dbg !102
  %39 = load ptr, ptr %10, align 8, !dbg !103
  %40 = call i32 @MPI_Buffer_detach(ptr noundef %39, ptr noundef %11), !dbg !104
  %41 = load ptr, ptr %10, align 8, !dbg !105
  call void @free(ptr noundef %41) #6, !dbg !106
  %42 = load ptr, ptr %9, align 8, !dbg !107
  call void @free(ptr noundef %42) #6, !dbg !108
  %43 = load i32, ptr %7, align 4, !dbg !109
  %44 = icmp eq i32 %43, 1, !dbg !111
  br i1 %44, label %45, label %47, !dbg !112

45:                                               ; preds = %38
  %46 = call i32 @MPI_Request_free(ptr noundef %8), !dbg !113
  br label %47, !dbg !115

47:                                               ; preds = %45, %38
  %48 = call i32 @MPI_Finalize(), !dbg !116
  %49 = load i32, ptr %7, align 4, !dbg !117
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/P2P/Correct-mpi_bsend_init-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "e6da15d808e727629aa040e4a7c49620")
...
!95 = !DILocation(line: 45, column: 20, scope: !96)
...
!100 = !DILocation(line: 48, column: 3, scope: !96)
!101 = !DILocalVariable(name: "freed_size", scope: !51, file: !2, line: 49, type: !24)
!102 = !DILocation(line: 49, column: 7, scope: !51)
!103 = !DILocation(line: 50, column: 21, scope: !51)
!104 = !DILocation(line: 50, column: 3, scope: !51)
!105 = !DILocation(line: 51, column: 8, scope: !51)
!106 = !DILocation(line: 51, column: 3, scope: !51)
!107 = !DILocation(line: 52, column: 8, scope: !51)
!108 = !DILocation(line: 52, column: 3, scope: !51)
!109 = !DILocation(line: 53, column: 7, scope: !110)
!110 = distinct !DILexicalBlock(scope: !51, file: !2, line: 53, column: 7)
!111 = !DILocation(line: 53, column: 12, scope: !110)
!112 = !DILocation(line: 53, column: 7, scope: !51)
!113 = !DILocation(line: 54, column: 5, scope: !114)
!114 = distinct !DILexicalBlock(scope: !110, file: !2, line: 53, column: 18)
!115 = !DILocation(line: 55, column: 3, scope: !114)
!116 = !DILocation(line: 57, column: 3, scope: !51)
!117 = !DILocation(line: 58, column: 41, scope: !51)
