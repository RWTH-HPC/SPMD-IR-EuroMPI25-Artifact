; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscan-mpi_iscan-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscan-mpi_iscan-001.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !53 {
  ...
  %11 = call i32 @MPI_Init(ptr noundef %4, ptr noundef %5), !dbg !69
  %12 = call i32 @MPI_Comm_size(ptr noundef @ompi_mpi_comm_world, ptr noundef %6), !dbg !70
  %13 = call i32 @MPI_Comm_rank(ptr noundef @ompi_mpi_comm_world, ptr noundef %7), !dbg !71
  %14 = load i32, ptr %6, align 4, !dbg !72
  %15 = icmp slt i32 %14, 2, !dbg !74
  br i1 %15, label %16, label %18, !dbg !75

16:                                               ; preds = %2
  %17 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !76
  br label %18, !dbg !76

18:                                               ; preds = %16, %2
  call void @llvm.dbg.declare(metadata ptr %9, metadata !77, metadata !DIExpression()), !dbg !78
  %19 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #5, !dbg !79
  store ptr %19, ptr %9, align 8, !dbg !78
  call void @llvm.dbg.declare(metadata ptr %10, metadata !80, metadata !DIExpression()), !dbg !81
  %20 = load i32, ptr %6, align 4, !dbg !82
  %21 = mul nsw i32 10, %20, !dbg !83
  %22 = sext i32 %21 to i64, !dbg !84
  %23 = call noalias ptr @calloc(i64 noundef %22, i64 noundef 4) #5, !dbg !85
  store ptr %23, ptr %10, align 8, !dbg !81
  %24 = load i32, ptr %7, align 4, !dbg !86
  %25 = icmp eq i32 %24, 0, !dbg !88
  br i1 %25, label %26, label %30, !dbg !89

26:                                               ; preds = %18
  %27 = load ptr, ptr %9, align 8, !dbg !90
  %28 = load ptr, ptr %10, align 8, !dbg !92
  %29 = call i32 @MPI_Iscan(ptr noundef %27, ptr noundef %28, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !93
  br label %30, !dbg !94

30:                                               ; preds = %26, %18
  %31 = load i32, ptr %7, align 4, !dbg !95
  %32 = icmp ne i32 %31, 0, !dbg !97
  br i1 %32, label %33, label %37, !dbg !98

33:                                               ; preds = %30
  %34 = load ptr, ptr %9, align 8, !dbg !99
  %35 = load ptr, ptr %10, align 8, !dbg !101
  %36 = call i32 @MPI_Iscan(ptr noundef %34, ptr noundef %35, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !102
  br label %37, !dbg !103

37:                                               ; preds = %33, %30
  %38 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !104
  %39 = load ptr, ptr %9, align 8, !dbg !105
  call void @free(ptr noundef %39) #6, !dbg !106
  %40 = load ptr, ptr %10, align 8, !dbg !107
  call void @free(ptr noundef %40) #6, !dbg !108
...
declare i32 @MPI_Iscan(ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscan-mpi_iscan-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "31ed982831c3c5309328838762158bca")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscan-mpi_iscan-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "31ed982831c3c5309328838762158bca")
...
!80 = !DILocalVariable(name: "recv_buf", scope: !53, file: !2, line: 36, type: !23)
!81 = !DILocation(line: 36, column: 8, scope: !53)
!82 = !DILocation(line: 36, column: 38, scope: !53)
!83 = !DILocation(line: 36, column: 36, scope: !53)
!84 = !DILocation(line: 36, column: 33, scope: !53)
!85 = !DILocation(line: 36, column: 26, scope: !53)
!86 = !DILocation(line: 38, column: 7, scope: !87)
!87 = distinct !DILexicalBlock(scope: !53, file: !2, line: 38, column: 7)
!88 = !DILocation(line: 38, column: 12, scope: !87)
!89 = !DILocation(line: 38, column: 7, scope: !53)
!90 = !DILocation(line: 39, column: 15, scope: !91)
!91 = distinct !DILexicalBlock(scope: !87, file: !2, line: 38, column: 18)
!92 = !DILocation(line: 39, column: 20, scope: !91)
!93 = !DILocation(line: 39, column: 5, scope: !91)
!94 = !DILocation(line: 41, column: 3, scope: !91)
!95 = !DILocation(line: 42, column: 7, scope: !96)
!96 = distinct !DILexicalBlock(scope: !53, file: !2, line: 42, column: 7)
!97 = !DILocation(line: 42, column: 12, scope: !96)
!98 = !DILocation(line: 42, column: 7, scope: !53)
!99 = !DILocation(line: 43, column: 15, scope: !100)
!100 = distinct !DILexicalBlock(scope: !96, file: !2, line: 42, column: 18)
!101 = !DILocation(line: 43, column: 20, scope: !100)
!102 = !DILocation(line: 43, column: 5, scope: !100)
!103 = !DILocation(line: 45, column: 3, scope: !100)
!104 = !DILocation(line: 46, column: 3, scope: !53)
!105 = !DILocation(line: 47, column: 8, scope: !53)
!106 = !DILocation(line: 47, column: 3, scope: !53)
!107 = !DILocation(line: 48, column: 8, scope: !53)
!108 = !DILocation(line: 48, column: 3, scope: !53)
!109 = !DILocation(line: 50, column: 3, scope: !53)
!110 = !DILocation(line: 51, column: 41, scope: !53)
!111 = !DILocation(line: 51, column: 3, scope: !53)
