; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_igather-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_igather-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %24 = load ptr, ptr %9, align 8, !dbg !83
  %25 = load ptr, ptr %10, align 8, !dbg !84
  %26 = call i32 @MPI_Igather(ptr noundef %24, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %25, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !85
  %27 = load ptr, ptr %9, align 8, !dbg !86
  %28 = getelementptr inbounds i32, ptr %27, i64 2, !dbg !86
  store i32 1, ptr %28, align 4, !dbg !87
  %29 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !88
  %30 = load ptr, ptr %9, align 8, !dbg !89
  call void @free(ptr noundef %30) #6, !dbg !90
  %31 = load ptr, ptr %10, align 8, !dbg !91
  call void @free(ptr noundef %31) #6, !dbg !92
  %32 = call i32 @MPI_Finalize(), !dbg !93
  %33 = load i32, ptr %7, align 4, !dbg !94
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !95
  ret i32 0, !dbg !96
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "8c002badbad30f55bdcbdfb436e53aa9")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_igather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "8c002badbad30f55bdcbdfb436e53aa9")
...
!83 = !DILocation(line: 38, column: 35, scope: !50)
!84 = !DILocation(line: 38, column: 53, scope: !50)
!85 = !DILocation(line: 38, column: 23, scope: !50)
!86 = !DILocation(line: 40, column: 22, scope: !50)
!87 = !DILocation(line: 40, column: 29, scope: !50)
!88 = !DILocation(line: 41, column: 3, scope: !50)
!89 = !DILocation(line: 42, column: 8, scope: !50)
!90 = !DILocation(line: 42, column: 3, scope: !50)
!91 = !DILocation(line: 43, column: 8, scope: !50)
!92 = !DILocation(line: 43, column: 3, scope: !50)
!93 = !DILocation(line: 45, column: 3, scope: !50)
!94 = !DILocation(line: 46, column: 41, scope: !50)
!95 = !DILocation(line: 46, column: 3, scope: !50)
!96 = !DILocation(line: 47, column: 3, scope: !50)
