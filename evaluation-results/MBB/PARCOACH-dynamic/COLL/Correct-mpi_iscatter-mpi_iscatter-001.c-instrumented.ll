; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !50 {
  ...
  %11 = call i32 @MPI_Init(ptr noundef %4, ptr noundef %5), !dbg !66
  %12 = call i32 @MPI_Comm_size(ptr noundef @ompi_mpi_comm_world, ptr noundef %6), !dbg !67
  %13 = call i32 @MPI_Comm_rank(ptr noundef @ompi_mpi_comm_world, ptr noundef %7), !dbg !68
  %14 = load i32, ptr %6, align 4, !dbg !69
  %15 = icmp slt i32 %14, 2, !dbg !71
  br i1 %15, label %16, label %18, !dbg !72

16:                                               ; preds = %2
  %17 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !73
  br label %18, !dbg !73

18:                                               ; preds = %16, %2
  call void @llvm.dbg.declare(metadata ptr %9, metadata !74, metadata !DIExpression()), !dbg !75
  %19 = load i32, ptr %6, align 4, !dbg !76
  %20 = mul nsw i32 %19, 10, !dbg !77
  %21 = sext i32 %20 to i64, !dbg !76
  %22 = call noalias ptr @calloc(i64 noundef %21, i64 noundef 4) #5, !dbg !78
  store ptr %22, ptr %9, align 8, !dbg !75
  call void @llvm.dbg.declare(metadata ptr %10, metadata !79, metadata !DIExpression()), !dbg !80
  %23 = load i32, ptr %6, align 4, !dbg !81
  %24 = mul nsw i32 10, %23, !dbg !82
  %25 = sext i32 %24 to i64, !dbg !83
  %26 = call noalias ptr @calloc(i64 noundef %25, i64 noundef 4) #5, !dbg !84
  store ptr %26, ptr %10, align 8, !dbg !80
  %27 = load i32, ptr %7, align 4, !dbg !85
  %28 = icmp eq i32 %27, 0, !dbg !87
  br i1 %28, label %29, label %33, !dbg !88

29:                                               ; preds = %18
  %30 = load ptr, ptr %9, align 8, !dbg !89
  %31 = load ptr, ptr %10, align 8, !dbg !91
  %32 = call i32 @MPI_Iscatter(ptr noundef %30, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %31, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !92
  br label %33, !dbg !93

33:                                               ; preds = %29, %18
  %34 = load i32, ptr %7, align 4, !dbg !94
  %35 = icmp ne i32 %34, 0, !dbg !96
  br i1 %35, label %36, label %40, !dbg !97

36:                                               ; preds = %33
  %37 = load ptr, ptr %9, align 8, !dbg !98
  %38 = load ptr, ptr %10, align 8, !dbg !100
  %39 = call i32 @MPI_Iscatter(ptr noundef %37, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %38, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !101
  br label %40, !dbg !102

40:                                               ; preds = %36, %33
  %41 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !103
  %42 = load ptr, ptr %9, align 8, !dbg !104
  call void @free(ptr noundef %42) #6, !dbg !105
  %43 = load ptr, ptr %10, align 8, !dbg !106
  call void @free(ptr noundef %43) #6, !dbg !107
  %44 = call i32 @MPI_Finalize(), !dbg !108
  %45 = load i32, ptr %7, align 4, !dbg !109
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !110
  ret i32 0, !dbg !111
}
...
declare i32 @MPI_Iscatter(ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef) #2
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "248b305e53aecb1b6d6013c5a9161f70")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_iscatter-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "248b305e53aecb1b6d6013c5a9161f70")
...
!76 = !DILocation(line: 34, column: 28, scope: !50)
!77 = !DILocation(line: 34, column: 35, scope: !50)
!78 = !DILocation(line: 34, column: 21, scope: !50)
!79 = !DILocalVariable(name: "recv_buf", scope: !50, file: !2, line: 36, type: !23)
!80 = !DILocation(line: 36, column: 8, scope: !50)
!81 = !DILocation(line: 36, column: 38, scope: !50)
!82 = !DILocation(line: 36, column: 36, scope: !50)
!83 = !DILocation(line: 36, column: 33, scope: !50)
!84 = !DILocation(line: 36, column: 26, scope: !50)
!85 = !DILocation(line: 38, column: 7, scope: !86)
!86 = distinct !DILexicalBlock(scope: !50, file: !2, line: 38, column: 7)
!87 = !DILocation(line: 38, column: 12, scope: !86)
!88 = !DILocation(line: 38, column: 7, scope: !50)
!89 = !DILocation(line: 39, column: 18, scope: !90)
!90 = distinct !DILexicalBlock(scope: !86, file: !2, line: 38, column: 18)
!91 = !DILocation(line: 39, column: 36, scope: !90)
!92 = !DILocation(line: 39, column: 5, scope: !90)
!93 = !DILocation(line: 41, column: 3, scope: !90)
!94 = !DILocation(line: 42, column: 7, scope: !95)
!95 = distinct !DILexicalBlock(scope: !50, file: !2, line: 42, column: 7)
!96 = !DILocation(line: 42, column: 12, scope: !95)
!97 = !DILocation(line: 42, column: 7, scope: !50)
...
!101 = !DILocation(line: 43, column: 5, scope: !99)
!102 = !DILocation(line: 45, column: 3, scope: !99)
!103 = !DILocation(line: 46, column: 3, scope: !50)
!104 = !DILocation(line: 47, column: 8, scope: !50)
!105 = !DILocation(line: 47, column: 3, scope: !50)
!106 = !DILocation(line: 48, column: 8, scope: !50)
!107 = !DILocation(line: 48, column: 3, scope: !50)
!108 = !DILocation(line: 50, column: 3, scope: !50)
!109 = !DILocation(line: 51, column: 41, scope: !50)
!110 = !DILocation(line: 51, column: 3, scope: !50)
!111 = !DILocation(line: 52, column: 3, scope: !50)
