; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ireduce-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ireduce-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %24 = load ptr, ptr %9, align 8, !dbg !86
  %25 = load ptr, ptr %10, align 8, !dbg !87
  %26 = call i32 @MPI_Ireduce(ptr noundef %24, ptr noundef %25, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef @ompi_mpi_op_sum, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !88
  %27 = load ptr, ptr %9, align 8, !dbg !89
  %28 = getelementptr inbounds i32, ptr %27, i64 2, !dbg !89
  store i32 1, ptr %28, align 4, !dbg !90
  %29 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !91
  %30 = load ptr, ptr %9, align 8, !dbg !92
  call void @free(ptr noundef %30) #6, !dbg !93
  %31 = load ptr, ptr %10, align 8, !dbg !94
  call void @free(ptr noundef %31) #6, !dbg !95
  %32 = call i32 @MPI_Finalize(), !dbg !96
  %33 = load i32, ptr %7, align 4, !dbg !97
  %34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33), !dbg !98
  ret i32 0, !dbg !99
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ireduce-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "abd6a32c16c473d3d0c4949ab86a05a7")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_ireduce-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "abd6a32c16c473d3d0c4949ab86a05a7")
...
!86 = !DILocation(line: 38, column: 34, scope: !53)
!87 = !DILocation(line: 38, column: 39, scope: !53)
!88 = !DILocation(line: 38, column: 22, scope: !53)
!89 = !DILocation(line: 40, column: 22, scope: !53)
!90 = !DILocation(line: 40, column: 29, scope: !53)
!91 = !DILocation(line: 41, column: 3, scope: !53)
!92 = !DILocation(line: 42, column: 8, scope: !53)
!93 = !DILocation(line: 42, column: 3, scope: !53)
!94 = !DILocation(line: 43, column: 8, scope: !53)
!95 = !DILocation(line: 43, column: 3, scope: !53)
!96 = !DILocation(line: 45, column: 3, scope: !53)
!97 = !DILocation(line: 46, column: 41, scope: !53)
!98 = !DILocation(line: 46, column: 3, scope: !53)
!99 = !DILocation(line: 47, column: 3, scope: !53)
