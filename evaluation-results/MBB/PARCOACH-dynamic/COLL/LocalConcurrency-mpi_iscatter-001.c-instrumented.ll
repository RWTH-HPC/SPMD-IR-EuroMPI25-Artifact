; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c"
...
18:                                               ; preds = %16, %2
  ...
  %27 = load ptr, ptr %9, align 8, !dbg !85
  %28 = load ptr, ptr %10, align 8, !dbg !86
  %29 = call i32 @MPI_Iscatter(ptr noundef %27, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %28, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world, ptr noundef %8), !dbg !87
  %30 = load ptr, ptr %9, align 8, !dbg !88
  %31 = getelementptr inbounds i32, ptr %30, i64 2, !dbg !88
  store i32 1, ptr %31, align 4, !dbg !89
  %32 = call i32 @MPI_Wait(ptr noundef %8, ptr noundef null), !dbg !90
  %33 = load ptr, ptr %9, align 8, !dbg !91
  call void @free(ptr noundef %33) #6, !dbg !92
  %34 = load ptr, ptr %10, align 8, !dbg !93
  call void @free(ptr noundef %34) #6, !dbg !94
  %35 = call i32 @MPI_Finalize(), !dbg !95
  %36 = load i32, ptr %7, align 4, !dbg !96
  %37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %36), !dbg !97
  ret i32 0, !dbg !98
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5ffc36739aadad1d6a61be7271f6dd26")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/LocalConcurrency-mpi_iscatter-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "5ffc36739aadad1d6a61be7271f6dd26")
...
!85 = !DILocation(line: 38, column: 35, scope: !50)
!86 = !DILocation(line: 38, column: 53, scope: !50)
!87 = !DILocation(line: 38, column: 22, scope: !50)
!88 = !DILocation(line: 40, column: 22, scope: !50)
!89 = !DILocation(line: 40, column: 29, scope: !50)
!90 = !DILocation(line: 41, column: 3, scope: !50)
!91 = !DILocation(line: 42, column: 8, scope: !50)
!92 = !DILocation(line: 42, column: 3, scope: !50)
!93 = !DILocation(line: 43, column: 8, scope: !50)
!94 = !DILocation(line: 43, column: 3, scope: !50)
!95 = !DILocation(line: 45, column: 3, scope: !50)
!96 = !DILocation(line: 46, column: 41, scope: !50)
!97 = !DILocation(line: 46, column: 3, scope: !50)
!98 = !DILocation(line: 47, column: 3, scope: !50)
