; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_gather-mpi_gather-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_gather-mpi_gather-001.c"
...
17:                                               ; preds = %15, %2
  ...
  %18 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #5, !dbg !59
  store ptr %18, ptr %8, align 8, !dbg !58
  call void @llvm.dbg.declare(metadata ptr %9, metadata !60, metadata !DIExpression()), !dbg !61
  %19 = load i32, ptr %6, align 4, !dbg !62
  %20 = mul nsw i32 10, %19, !dbg !63
  %21 = sext i32 %20 to i64, !dbg !64
  %22 = call noalias ptr @calloc(i64 noundef %21, i64 noundef 4) #5, !dbg !65
  store ptr %22, ptr %9, align 8, !dbg !61
  %23 = load i32, ptr %7, align 4, !dbg !66
  %24 = icmp eq i32 %23, 0, !dbg !68
  br i1 %24, label %25, label %29, !dbg !69

25:                                               ; preds = %17
  %26 = load ptr, ptr %8, align 8, !dbg !70
  %27 = load ptr, ptr %9, align 8, !dbg !72
  %28 = call i32 @MPI_Gather(ptr noundef %26, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %27, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !73
  br label %29, !dbg !74

29:                                               ; preds = %25, %17
  %30 = load i32, ptr %7, align 4, !dbg !75
  %31 = icmp ne i32 %30, 0, !dbg !77
  br i1 %31, label %32, label %36, !dbg !78

32:                                               ; preds = %29
  %33 = load ptr, ptr %8, align 8, !dbg !79
  %34 = load ptr, ptr %9, align 8, !dbg !81
  %35 = call i32 @MPI_Gather(ptr noundef %33, i32 noundef 10, ptr noundef @ompi_mpi_int, ptr noundef %34, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !82
  br label %36, !dbg !83

36:                                               ; preds = %32, %29
  %37 = load ptr, ptr %8, align 8, !dbg !84
  call void @free(ptr noundef %37) #6, !dbg !85
  %38 = load ptr, ptr %9, align 8, !dbg !86
  call void @free(ptr noundef %38) #6, !dbg !87
  %39 = call i32 @MPI_Finalize(), !dbg !88
  %40 = load i32, ptr %7, align 4, !dbg !89
  %41 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40), !dbg !90
  ret i32 0, !dbg !91
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_gather-mpi_gather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "3769e511c6edfa551cd9427bf64605cc")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_gather-mpi_gather-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "3769e511c6edfa551cd9427bf64605cc")
!14 = !{!15, !19, !20, !22}
...
!59 = !DILocation(line: 33, column: 21, scope: !35)
!60 = !DILocalVariable(name: "recv_buf", scope: !35, file: !2, line: 35, type: !20)
!61 = !DILocation(line: 35, column: 8, scope: !35)
!62 = !DILocation(line: 35, column: 38, scope: !35)
!63 = !DILocation(line: 35, column: 36, scope: !35)
!64 = !DILocation(line: 35, column: 33, scope: !35)
!65 = !DILocation(line: 35, column: 26, scope: !35)
!66 = !DILocation(line: 37, column: 7, scope: !67)
!67 = distinct !DILexicalBlock(scope: !35, file: !2, line: 37, column: 7)
!68 = !DILocation(line: 37, column: 12, scope: !67)
!69 = !DILocation(line: 37, column: 7, scope: !35)
!70 = !DILocation(line: 38, column: 16, scope: !71)
!71 = distinct !DILexicalBlock(scope: !67, file: !2, line: 37, column: 18)
!72 = !DILocation(line: 38, column: 34, scope: !71)
!73 = !DILocation(line: 38, column: 5, scope: !71)
!74 = !DILocation(line: 39, column: 3, scope: !71)
!75 = !DILocation(line: 40, column: 7, scope: !76)
!76 = distinct !DILexicalBlock(scope: !35, file: !2, line: 40, column: 7)
!77 = !DILocation(line: 40, column: 12, scope: !76)
!78 = !DILocation(line: 40, column: 7, scope: !35)
!79 = !DILocation(line: 41, column: 16, scope: !80)
!80 = distinct !DILexicalBlock(scope: !76, file: !2, line: 40, column: 18)
!81 = !DILocation(line: 41, column: 34, scope: !80)
!82 = !DILocation(line: 41, column: 5, scope: !80)
!83 = !DILocation(line: 42, column: 3, scope: !80)
!84 = !DILocation(line: 43, column: 8, scope: !35)
!85 = !DILocation(line: 43, column: 3, scope: !35)
!86 = !DILocation(line: 44, column: 8, scope: !35)
!87 = !DILocation(line: 44, column: 3, scope: !35)
!88 = !DILocation(line: 46, column: 3, scope: !35)
!89 = !DILocation(line: 47, column: 41, scope: !35)
!90 = !DILocation(line: 47, column: 3, scope: !35)
!91 = !DILocation(line: 48, column: 3, scope: !35)
