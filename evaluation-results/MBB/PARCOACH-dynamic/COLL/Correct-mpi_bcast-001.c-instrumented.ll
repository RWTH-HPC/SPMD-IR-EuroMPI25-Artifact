; ModuleID = '/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_bcast-001.c.ll'
source_filename = "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_bcast-001.c"
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !35 {
  ...
  %9 = call i32 @MPI_Init(ptr noundef %4, ptr noundef %5), !dbg !49
  %10 = call i32 @MPI_Comm_size(ptr noundef @ompi_mpi_comm_world, ptr noundef %6), !dbg !50
  %11 = call i32 @MPI_Comm_rank(ptr noundef @ompi_mpi_comm_world, ptr noundef %7), !dbg !51
  %12 = load i32, ptr %6, align 4, !dbg !52
  %13 = icmp slt i32 %12, 2, !dbg !54
  br i1 %13, label %14, label %16, !dbg !55

14:                                               ; preds = %2
  %15 = call i32 (ptr, ...) @printf(ptr noundef @.str), !dbg !56
  br label %16, !dbg !56

16:                                               ; preds = %14, %2
  call void @llvm.dbg.declare(metadata ptr %8, metadata !57, metadata !DIExpression()), !dbg !58
  %17 = call noalias ptr @calloc(i64 noundef 10, i64 noundef 4) #5, !dbg !59
  store ptr %17, ptr %8, align 8, !dbg !58
  %18 = load ptr, ptr %8, align 8, !dbg !60
  %19 = call i32 @MPI_Bcast(ptr noundef %18, i32 noundef 10, ptr noundef @ompi_mpi_int, i32 noundef 0, ptr noundef @ompi_mpi_comm_world), !dbg !61
  %20 = load ptr, ptr %8, align 8, !dbg !62
  call void @free(ptr noundef %20) #6, !dbg !63
  %21 = call i32 @MPI_Finalize(), !dbg !64
  %22 = load i32, ptr %7, align 4, !dbg !65
  %23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %22), !dbg !66
  ret i32 0, !dbg !67
}
...
!2 = !DIFile(filename: "cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_bcast-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "3d33eecb17cac2ca1e8f1978c4000a6d")
...
!13 = !DIFile(filename: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite/cq-results-20250604-173113/MBB/PARCOACH-dynamic/COLL/Correct-mpi_bcast-001.c", directory: "/rwthfs/rz/cluster/home/ss540294/spmdir/spmd/externals/data-race-detection-benchmark-suite", checksumkind: CSK_MD5, checksum: "3d33eecb17cac2ca1e8f1978c4000a6d")
!14 = !{!15, !19, !20, !22}
...
!60 = !DILocation(line: 35, column: 13, scope: !35)
!61 = !DILocation(line: 35, column: 3, scope: !35)
!62 = !DILocation(line: 36, column: 8, scope: !35)
!63 = !DILocation(line: 36, column: 3, scope: !35)
!64 = !DILocation(line: 38, column: 3, scope: !35)
!65 = !DILocation(line: 39, column: 41, scope: !35)
!66 = !DILocation(line: 39, column: 3, scope: !35)
!67 = !DILocation(line: 40, column: 3, scope: !35)
