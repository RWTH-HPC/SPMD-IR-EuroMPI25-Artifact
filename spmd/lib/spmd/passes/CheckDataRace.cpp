...
struct ErrorInfo {
  ...
  // Equality comparison for using it in sets
  // bool operator==(const ErrorInfo &other) const {
  //   return prevOpr == other.prevOpr &&
  //          causingOpr == other.causingOpr &&
  //          aliasPrev == other.aliasPrev &&
  //          aliasCausing == other.aliasCausing &&
  //          origAddr == other.origAddr &&
  //          execKindPrev == other.execKindPrev &&
  //          execKindCausing == other.execKindCausing &&
  //          overlapRanks == other.overlapRanks;
  // }
...
//     return llvm::hash_combine(
//         std::hash<Operation *>()(errorInfo.prevOpr),
//         hash_value(errorInfo.aliasPrev), hash_value(errorInfo.aliasCausing), 
//         hash_value(errorInfo.origAddr), errorInfo.execKindPrev, errorInfo.execKindCausing,
//         my_hash_value(errorInfo.overlapRanks)
//     );
//   }
// };
struct ErrorInfoHash {
...
int printErrorInfos(std::unordered_set<ErrorInfo, ErrorInfoHash> &errorInfos){
  fprintf(stderr, "\n\n--------------------------------------------------------------------------------------------------------------\n");
