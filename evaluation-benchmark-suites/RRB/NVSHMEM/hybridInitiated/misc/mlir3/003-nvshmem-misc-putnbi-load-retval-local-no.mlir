module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f16 = dense<16> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %29 = llvm.alloca %c1_i32 x !llvm.array<2 x ptr> {alignment = 16 : i64} : (i32) -> !llvm.ptr
    ...
    %32 = llvm.call @nvshmem_team_my_pe(%c2_i32) : (i32) -> i32
    %33 = llvm.call @cudaSetDevice(%32) : (i32) -> i32
    %34 = llvm.call @nvshmem_my_pe() : () -> i32
    %35 = llvm.call @nvshmem_n_pes() : () -> i32
    %36 = arith.cmpi ne, %35, %c2_i32 : i32
    scf.if %36 {
      %59 = llvm.call @printf(%8, %35, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      llvm.call @nvshmem_global_exit(%c1_i32) : (i32) -> ()
    }
    %37 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %38 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %39 = llvm.getelementptr inbounds %25[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %39 {alignment = 4 : i64} : i32, !llvm.ptr
    %40 = llvm.getelementptr inbounds %25[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %40 {alignment = 4 : i64} : i32, !llvm.ptr
    %41 = llvm.getelementptr inbounds %25[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %41 {alignment = 4 : i64} : i32, !llvm.ptr
    %42 = llvm.getelementptr inbounds %26[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %42 {alignment = 4 : i64} : i32, !llvm.ptr
    %43 = llvm.getelementptr inbounds %26[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %43 {alignment = 4 : i64} : i32, !llvm.ptr
    %44 = llvm.getelementptr inbounds %26[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %44 {alignment = 4 : i64} : i32, !llvm.ptr
    %45 = llvm.call @cudaMemset(%37, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %46 = llvm.call @cudaMemset(%38, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %47 = llvm.load %25 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %48 = llvm.load %26 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %47, %27 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %48, %28 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    llvm.store %37, %29 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %49 = llvm.getelementptr inbounds %29[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
    llvm.store %38, %49 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %50 = arith.cmpi eq, %34, %c0_i32 : i32
    scf.if %50 {
      llvm.call @nvshmem_int_put_nbi(%37, %38, %c1_i64, %c1_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
      %59 = llvm.load %25 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %60 = llvm.load %26 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %61 = llvm.getelementptr inbounds %29[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x ptr>
      llvm.store %59, %30 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %60, %31 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      %62 = llvm.load %61 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
      %63 = llvm.getelementptr %61[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
      ...
      llvm.store %62, %16 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      llvm.store %64, %17 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      llvm.store %16, %20 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      %65 = llvm.getelementptr %20[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
      llvm.store %17, %65 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      llvm.store %0, %18 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %0, %19 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      %66 = llvm.load %64 {alignment = 4 : i64} : !llvm.ptr -> i32
      llvm.call @nvshmem_barrier_all() {convergent, no_unwind} : () -> ()
      %67 = llvm.load %62 {alignment = 4 : i64} : !llvm.ptr -> i32
      %68 = arith.addi %67, %66 : i32
      llvm.store %68, %62 {alignment = 4 : i64} : i32, !llvm.ptr
    ...
    llvm.call @nvshmem_barrier_all() : () -> ()
    %51 = llvm.call @cudaMemcpy(%23, %37, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %52 = llvm.call @cudaMemcpy(%24, %38, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %53 = llvm.load %24 {alignment = 4 : i64} : !llvm.ptr -> i32
    %54 = llvm.load %23 {alignment = 4 : i64} : !llvm.ptr -> i32
    %55 = llvm.call @printf(%10, %34, %53, %54) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %56 = llvm.load %23 {alignment = 4 : i64} : !llvm.ptr -> i32
    %57 = llvm.load %24 {alignment = 4 : i64} : !llvm.ptr -> i32
    %58 = llvm.call @printf(%11, %34, %56, %57) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_free(%37) : (!llvm.ptr) -> ()
    llvm.call @nvshmem_free(%38) : (!llvm.ptr) -> ()
