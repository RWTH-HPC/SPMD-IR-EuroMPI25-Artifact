module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "clang version 20.0.0git (git@github.com:ivanradanov/llvm-project.git 872c28cfdf6140fafac11eddbb5895f11bc6f295)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @main(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}) -> (i32 {llvm.noundef}) attributes {frame_pointer = #llvm.framePointerKind<all>, no_inline, no_unwind, optimize_none, passthrough = ["mustprogress", "norecurse", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    ...
    %4 = llvm.mlir.addressof @_Z20__device_stub__rank0PiS_ : !llvm.ptr
    ...
    %12 = llvm.mlir.addressof @".str.3" : !llvm.ptr
    %13 = llvm.call @__cudaRegisterFatBinary(%3) : (!llvm.ptr) -> !llvm.ptr
    llvm.store %13, %2 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    %14 = llvm.call @__cudaRegisterFunction(%13, %4, %5, %5, %c-1_i32, %9, %9, %9, %9, %9) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    %15 = llvm.call @__cudaRegisterFunction(%13, %6, %7, %7, %c-1_i32, %9, %9, %9, %9, %9) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
    llvm.call @__cudaRegisterFatBinaryEnd(%13) : (!llvm.ptr) -> ()
    %16 = llvm.call @atexit(%1) : (!llvm.ptr) -> i32
    ...
    %21 = llvm.alloca %c2_i64 x !llvm.ptr {alignment = 16 : i64} : (i64) -> !llvm.ptr
    ...
    %27 = llvm.alloca %c1_i32 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %28 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64} : (i32) -> !llvm.ptr
    %29 = llvm.alloca %c1_i32 x !llvm.struct<"struct.dim3", (i32, i32, i32)> {alignment = 4 : i64} : (i32) -> !llvm.ptr
    ...
    %36 = llvm.call @nvshmem_team_my_pe(%c2_i32) : (i32) -> i32
    %37 = llvm.call @cudaSetDevice(%36) : (i32) -> i32
    %38 = llvm.call @nvshmem_my_pe() : () -> i32
    %39 = llvm.call @nvshmem_n_pes() : () -> i32
    %40 = arith.cmpi ne, %39, %c2_i32 : i32
    scf.if %40 {
      %64 = llvm.call @printf(%8, %39, %c2_i32) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
      llvm.call @nvshmem_global_exit(%c1_i32) : (i32) -> ()
    }
    %41 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %42 = llvm.call @nvshmem_malloc(%c4_i64) : (i64) -> !llvm.ptr
    %43 = llvm.getelementptr inbounds %28[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %43 {alignment = 4 : i64} : i32, !llvm.ptr
    %44 = llvm.getelementptr inbounds %28[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %44 {alignment = 4 : i64} : i32, !llvm.ptr
    %45 = llvm.getelementptr inbounds %28[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %45 {alignment = 4 : i64} : i32, !llvm.ptr
    %46 = llvm.getelementptr inbounds %29[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %46 {alignment = 4 : i64} : i32, !llvm.ptr
    %47 = llvm.getelementptr inbounds %29[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %47 {alignment = 4 : i64} : i32, !llvm.ptr
    %48 = llvm.getelementptr inbounds %29[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %c1_i32, %48 {alignment = 4 : i64} : i32, !llvm.ptr
    %49 = llvm.call @cudaMemset(%41, %c0_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    %50 = llvm.call @cudaMemset(%42, %c1_i32, %c4_i64) : (!llvm.ptr, i32, i64) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %51 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %52 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    ...
    llvm.intr.lifetime.start 16, %25 : !llvm.ptr
    llvm.store %0, %24 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %0, %25 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.call @nvshmem_barrier_all() {convergent, no_unwind} : () -> ()
    llvm.intr.lifetime.end 16, %24 : !llvm.ptr
    llvm.intr.lifetime.end 16, %25 : !llvm.ptr
    %53 = arith.cmpi eq, %38, %c0_i32 : i32
    scf.if %53 {
      %64 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      %65 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
      llvm.store %64, %32 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %65, %33 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      ...
      llvm.store %42, %18 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      llvm.store %17, %21 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      %66 = llvm.getelementptr %21[1] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
      llvm.store %18, %66 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
      llvm.store %0, %19 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.store %0, %20 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
      llvm.call @nvshmem_int_get_nbi(%42, %41, %c1_i64, %c1_i32) {convergent, no_unwind} : (!llvm.ptr, !llvm.ptr, i64, i32) -> ()
      ...
      %67 = llvm.call @cudaMemcpy(%27, %42, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
      %68 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
      %69 = llvm.call @printf(%10, %68) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32) -> i32
    }
    llvm.call @nvshmem_barrier_all() : () -> ()
    %54 = llvm.load %28 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    %55 = llvm.load %29 : !llvm.ptr -> !llvm.struct<"struct.dim3", (i32, i32, i32)>
    llvm.store %54, %34 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    llvm.store %55, %35 : !llvm.struct<"struct.dim3", (i32, i32, i32)>, !llvm.ptr
    ...
    %56 = llvm.call @cudaMemcpy(%26, %41, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %57 = llvm.call @cudaMemcpy(%27, %42, %c4_i64, %c2_i32) : (!llvm.ptr, !llvm.ptr, i64, i32) -> i32
    %58 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
    %59 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %60 = llvm.call @printf(%11, %38, %58, %59) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_barrier_all() : () -> ()
    %61 = llvm.load %26 {alignment = 4 : i64} : !llvm.ptr -> i32
    %62 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
    %63 = llvm.call @printf(%12, %38, %61, %62) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, i32) -> i32
    llvm.call @nvshmem_free(%41) : (!llvm.ptr) -> ()
    llvm.call @nvshmem_free(%42) : (!llvm.ptr) -> ()
